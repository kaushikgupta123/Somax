...
{
    public class ViewProjectCostingModelDynamic
    {
        #region UDF columns
        ...
        public string AssignedGroup1_ClientLookupId { get; set; }
        public string AssignedGroup2_ClientLookupId { get; set; }
        public string AssignedGroup3_ClientLookupId { get; set; }
    }
}