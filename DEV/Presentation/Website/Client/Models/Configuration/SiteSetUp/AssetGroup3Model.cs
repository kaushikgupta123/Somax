...
{
    public class AssetGroup3Model
    {
        public long AssetGroup3Id { get; set; }
        public string AssetGroupLabel { get; set; }
        [Required(ErrorMessage = "ValidationAssetGroup3ID|" + LocalizeResourceSetConstants.SetUpDetails)]
        [RegularExpression("^[A-Z0-9\\%\\-\\:\\/\\$\\*\\+\\.]+$", ErrorMessage = "AssetGroup3IDRegErrMsg|" + LocalizeResourceSetConstants.SetUpDetails)]
