...
{
    public class LessThanForPartAutoPurchasingConfigurationAttribute : ValidationAttribute, IClientValidatable
    {
        private string PropertyName { get; set; }
        public LessThanForPartAutoPurchasingConfigurationAttribute(string propertyName)
        {
        ...
        public IEnumerable<ModelClientValidationRule> GetClientValidationRules(ModelMetadata metadata, ControllerContext context)
        {
            var rule = new ModelClientValidationRule
            {
                ...
                ValidationType = "lessthanforpartautopurchasingconfiguration",
            };
