...
var mLayout = function() {
    ...
    var initHorMenu = function() {
        ...
        horMenuOffcanvas = $('#m_header_menu, #m_header_menu1, #m_header_menu2').mOffcanvas({
            class: 'm-aside-header-menu-mobile',
            overlay: true,
            close: '#m_aside_header_menu_mobile_close_btn, #m_aside_header_menu_mobile_close_btn1, #m_aside_header_menu_mobile_close_btn2',
            toggle: {
        ...
        horMenu = $('#m_header_menu, #m_header_menu1, #m_header_menu2').mMenu({
            // submenu modes
            submenu: {
                desktop: 'dropdown',
                tablet: 'accordion',
