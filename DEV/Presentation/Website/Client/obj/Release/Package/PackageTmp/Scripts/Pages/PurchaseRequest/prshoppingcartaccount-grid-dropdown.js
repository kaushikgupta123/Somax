...
$(document).on('click', '.openaccountlookupgrid', function () {
    $(document).find('.accountlookup').removeClass('account-ele-lookup');
    $(document).find('.accountlookupval').removeClass('account-ele-lookup-hidden');
    $(this).siblings('.accountlookup').addClass('account-ele-lookup');
    $(this).siblings('.accountlookupval').addClass('account-ele-lookup-hidden');
...
$(document).on('click', '.link_PRAccount', function (e) {
    ...
    $(document).find('.account-ele-lookup').val(data.ClientLookupId);
    $(document).find('.account-ele-lookup-hidden').val(data.AccountId); //---change ID   
