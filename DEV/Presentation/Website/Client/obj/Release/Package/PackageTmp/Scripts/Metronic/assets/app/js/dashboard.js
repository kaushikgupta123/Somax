...
var Dashboard = function () {
    ...
    var bandwidthChart2_tst = function () {
        $.ajax({
            type: "GET",
            url: "/DashBoard/WOCompleteVsSchedule",
            dataType: "JSON",
            success: function (compvsScheresultData) {
                //alert(compvsScheresultData);
               // var bandwidthChart1 = function () {
                    if ($('#m_chart_bandwidth2').length == 0) {
                        return;
                    }
                      ...
                      var ctx = document.getElementById("m_chart_bandwidth2").getContext("2d");
                    //var ctx = $("#m_chart_bandwidth2").getContext("2d");
                    ...
                    //var chart3data = [];
                    //var a = 0;
                    //$.each(compvsScheresultData,function(element,i){
                    ////compvsScheresultData.each(function (element, i) {
                    //    alert(i);
                    //    a = i;
                    //    if (i > 3)
                    //        a = i % 4;
                    //    //chart3data.push({ Key: element.Key, Value: element.Value, color: chartcolor[a] });
                    //    chart3data.push({ Key: element.Key, Value: element.Value,color:'#ffb822'});
                    //});
                //alert(chart3data);

                    var chartKey = [], chartVal = [];
                    $.each(compvsScheresultData.compvsScheresultData, function (i, ele) {
                        chartKey.push(ele.Key);
                        chartVal.push(ele.Value);
                    });
                    //--------------------end of data binding------------
