...
function getPersonnelDataTable() {
    ...
    dtPersonnelTable = $("#tblPersonnelModalPopup").DataTable({
        ...
        "orderMulti": true,
        "ajax": {
            "url": "/Base/GetActiveAdminOrFullPersonnelLookupListGridData",
            data: function (d) {
...
$(document).on('click', '.link_Personnel_detail', function (e) {
    ...
    $(document).find('#' + ValueField).parent().find('div > button.ClearPersonnelModalPopupGridData').css('display', 'block');
