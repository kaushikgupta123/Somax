...
function generatePunchOutVendorDataTableForPlusMenu() {
    var rCount = 0;
    var visibility;
        ...
        [
            {
                ...
                "mRender": function (data, type, row) {
                    return '<a class=link_prpunchoutvendor_addmenu href="javascript:void(0)">' + data + '</a>'
                }
            },
            {
...
$(document).on('click', '.link_prpunchoutvendor_addmenu', function (e) {
        ...
        success: function (data) {
            ...
            if (json_obj.Result == "success") {
                ...
                swal(SuccessAlertSetting, function () {                    
                    window.location.href = "../PurchaseRequest/DetailFromPlusMenu?PurchaseRequestId=" + json_obj.purchaserequestid;
                });
            }
            else {
