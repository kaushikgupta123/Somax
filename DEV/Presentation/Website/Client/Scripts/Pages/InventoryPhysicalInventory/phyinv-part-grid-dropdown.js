...
function generatePartsXrefDataTable() {
    ...
    dtXrefPartsTable = $("#XrefPartsTable").DataTable({
        ...
        initComplete: function () {
            ...
            SetPageLengthMenu();
            if (!$(document).find('#partPhyInvModal').hasClass('show')) {
                $(document).find('#partPhyInvModal').modal("show");
            }
