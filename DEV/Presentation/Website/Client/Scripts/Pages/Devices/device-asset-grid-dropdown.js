    ...
    equipTable = $("#tblAssetLookup").DataTable({
        ...
        initComplete: function () {
            ...
            $('#tblAssetLookup tfoot th').each(function (i, v) {
                ...
                if (SerialNumber) { $('#equipmentcolindex_4').val(SerialNumber); }
            });
            ...
            $('#tblAssetLookup tfoot th').find('.woequipment').on("keyup", function (e) {
                if (e.keyCode == 13) {
                    ...
                    SerialNumber = $('#equipmentcolindex_4').val();
...
$(document).on('click', '.link_woeqp_detail_common', function (e) {
    ...
    $(document).find('#' + TextField).val(data.ClientLookupId).removeClass('input-validation-error').css("display", "block");
