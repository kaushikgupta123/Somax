        ...
        initComplete: function () {
            ...
            $('#LocationTable tfoot th').each(function (i, v) {
                ...
                if (colIndex !== 2 && colIndex !== 3) {
                    ...
                    if (LocName) { $('#chkwolocationcolindex_1').val(LocName); }
                    if (LocSerialNumber) { $('#chkwolocationcolindex_4').val(LocSerialNumber); }
                }
            });
            ...
            $('#LocationTable tfoot th').find('.chkwolocation').on("keyup", function (e) {
                if (e.keyCode == 13) {
                    ...
                    LocName = $('#chkwolocationcolindex_1').val();                   
                    LocSerialNumber = $('#chkwolocationcolindex_4').val();
