...
{
    public interface IVendorCatalogImportWrapper : ICommonWrapper
    {
        ProcessLogModel CreateVCImport(List<VendorCatalogImportJSONModel> vcImportModelList);
        ProcessLogModel ProcessVCImport();
