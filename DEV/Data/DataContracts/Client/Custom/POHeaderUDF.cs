...
{
    public partial class POHeaderUDF : DataContractBase
    {
        #region Variables
        ...
        public string Date4String { get; set; }
        ...
        public POHeaderUDF RetrieveByPurchaseOrderId(DatabaseKey dbKey)
        {
            POHeaderUDF_RetrieveByPurchaseOrderId trans = new POHeaderUDF_RetrieveByPurchaseOrderId()
            {
                CallerUserInfoId = dbKey.User.UserInfoId,
                CallerUserName = dbKey.UserName,

            };
            trans.POHeaderUDF = this.ToDatabaseObject();
            trans.dbKey = dbKey.ToTransDbKey();
            trans.Execute();
            POHeaderUDF objPOHeaderUDF = new POHeaderUDF();
            objPOHeaderUDF.UpdateFromDatabaseObjectExtended(trans.POHeaderUDF);
            return objPOHeaderUDF;
        }
        public void UpdateFromDatabaseObjectExtended(b_POHeaderUDF dbObj)
        {
            this.ClientId = dbObj.ClientId;
            this.POHeaderUDFId = dbObj.POHeaderUDFId;
        ...
        public void UpdateFromDatabaseObjectPOHeaderUDFPrintExtended(b_POHeaderUDF dbObj, string Timezone)
