...
{
    public partial class POLineUDF : DataContractBase
    {
        #region Variables
        ...
        #endregion
        #endregion
        public POLineUDF RetrieveByPurchaseOrderLineItemId(DatabaseKey dbKey)
        {
            POLine_RetrieveByPurchaseOrderLineItemId trans = new POLine_RetrieveByPurchaseOrderLineItemId()
            {
                CallerUserInfoId = dbKey.User.UserInfoId,
                CallerUserName = dbKey.UserName,

            };
            trans.POLineUDF = this.ToDatabaseObject();
            trans.dbKey = dbKey.ToTransDbKey();
            trans.Execute();
            POLineUDF objPOLineUDF = new POLineUDF();
            objPOLineUDF.UpdateFromDatabaseObjectExtended(trans.POLineUDF);
            return objPOLineUDF;
        }
        public void UpdateFromDatabaseObjectExtended(b_POLineUDF dbObj)
        {
            this.ClientId = dbObj.ClientId;
            this.POLineUDFId = dbObj.POLineUDFId;
        ...
        public void DeleteByPurchaseOrderLineItemId(DatabaseKey dbKey)
        {

            POLineUDF_DeleteByPurchaseOrderLineItemId trans = new POLineUDF_DeleteByPurchaseOrderLineItemId()
            {
                CallerUserInfoId = dbKey.User.UserInfoId,
                CallerUserName = dbKey.UserName,
            };
        ...
        public void UpdateFromDatabaseObjectPOLineUDFPrintExtended(b_POLineUDF dbObj, string Timezone)
