...
{
    public partial class ProjectUDF : DataContractBase
    {
        #region Variables
        ...
        public ProjectUDF RetrieveByProjectId(DatabaseKey dbKey)
        {
            ProjectUDF_RetrieveByProjectId trans = new ProjectUDF_RetrieveByProjectId()
            {
                CallerUserInfoId = dbKey.User.UserInfoId,
                CallerUserName = dbKey.UserName,

            };
            trans.ProjectUDF = this.ToDatabaseObject();
            trans.dbKey = dbKey.ToTransDbKey();
            trans.Execute();
            ProjectUDF objProjectUDF = new ProjectUDF();
            objProjectUDF.UpdateFromDatabaseObjectExtended(trans.ProjectUDF);
            return objProjectUDF;
        }
        public void UpdateFromDatabaseObjectExtended(b_ProjectUDF dbObj)
        {
            this.ClientId = dbObj.ClientId;
            this.ProjectUDFId = dbObj.ProjectUDFId;
