...
{
    /// <summary>
    /// Business object that stores a record from the VendorEventLog table.
    /// </summary>
    [Serializable()]
    [DataContract(Namespace = "http://schemas.datacontract.org/2004/07/SOMAX.DataContracts")]
    public partial class VendorEventLog : DataContractBase 
    {
        #region Constructors
        /// <summary>
        /// Default constructor.
        /// </summary>
        public VendorEventLog()
        {
            Initialize();
        }
        ...
        public void UpdateFromDatabaseObject(b_VendorEventLog dbObj)
        {
		            this.ClientId = dbObj.ClientId;
            this.VendorEventLogId = dbObj.VendorEventLogId;
        ...
        {
            b_VendorEventLog dbObj = new b_VendorEventLog();
        ...
        public b_VendorEventLog ToDatabaseObject()
        {
            b_VendorEventLog dbObj = new b_VendorEventLog();
            dbObj.ClientId = this.ClientId;
            dbObj.VendorEventLogId = this.VendorEventLogId;
        ...
        {
            VendorEventLog_Create trans = new VendorEventLog_Create();
            trans.VendorEventLog = this.ToDatabaseObject();
            trans.dbKey = dbKey.ToTransDbKey();
            trans.Execute();
            
            // The create procedure may have populated an auto-incremented key. 
            UpdateFromDatabaseObject(trans.VendorEventLog);
        }

        public void Retrieve(DatabaseKey dbKey) 
        {
            VendorEventLog_Retrieve trans = new VendorEventLog_Retrieve();
            trans.VendorEventLog = this.ToDatabaseObject();
            trans.dbKey = dbKey.ToTransDbKey();
            trans.Execute();
            UpdateFromDatabaseObject(trans.VendorEventLog);
        ...
        {
            VendorEventLog_Update trans = new VendorEventLog_Update();
            trans.VendorEventLog = this.ToDatabaseObject();
        ...
        {
            VendorEventLog_Delete trans = new VendorEventLog_Delete();
            trans.VendorEventLog = this.ToDatabaseObject();
            trans.dbKey = dbKey.ToTransDbKey();
            trans.Execute();
        }
        ...
        {
            AuditTargetObjectId = this.VendorEventLogId;
        ...
        private long _VendorEventLogId;
        ...
        /// </summary>
        [DataMember]
        public long VendorEventLogId
        {
            get { return _VendorEventLogId; }
            set { Set<long>(MethodBase.GetCurrentMethod().Name, value, ref _VendorEventLogId); }
        }
