...
{
    /// <summary>
    /// Business object that stores a record from the POImpLine table.
    /// </summary>
    [Serializable()]
    [DataContract(Namespace = "http://schemas.datacontract.org/2004/07/SOMAX.DataContracts")]
    public partial class POImpLine : DataContractBase 
    {
        #region Constructors
        /// <summary>
        /// Default constructor.
        ...
        public void UpdateFromDatabaseObject(b_POImpLine dbObj)
        {
        ...
        {
            b_POImpLine dbObj = new b_POImpLine();
        ...
        public b_POImpLine ToDatabaseObject()
        {
            b_POImpLine dbObj = new b_POImpLine();
        ...
        {
            POImpLine_Create trans = new POImpLine_Create();
        ...
        {
            POImpLine_Retrieve trans = new POImpLine_Retrieve();
            trans.POImpLine = this.ToDatabaseObject();
            trans.dbKey = dbKey.ToTransDbKey();
            trans.Execute();
            UpdateFromDatabaseObject(trans.POImpLine);
        ...
        {
            POImpLine_Update trans = new POImpLine_Update();
            trans.POImpLine = this.ToDatabaseObject();
        ...
        {
            POImpLine_Delete trans = new POImpLine_Delete();
            trans.POImpLine = this.ToDatabaseObject();
            trans.dbKey = dbKey.ToTransDbKey();
            trans.Execute();
        }
        ...
        {
            AuditTargetObjectId = this.POImpLineId;
        ...
        /// </summary>
        [DataMember]
        public long SOMAXPRLineId
        {
            get { return _SOMAXPRLineId; }
            set { Set<long>(MethodBase.GetCurrentMethod().Name, value, ref _SOMAXPRLineId); }
        }
