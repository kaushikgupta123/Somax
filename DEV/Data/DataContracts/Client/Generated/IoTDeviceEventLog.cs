...
{
    /// <summary>
    /// Business object that stores a record from the IoTDeviceEventLog table.
    /// </summary>
    [Serializable()]
    [DataContract(Namespace = "http://schemas.datacontract.org/2004/07/SOMAX.DataContracts")]
    public partial class IoTDeviceEventLog : DataContractBase 
    {
        #region Constructors
        /// <summary>
        /// Default constructor.
        /// </summary>
        public IoTDeviceEventLog()
        {
            Initialize();
        }
        ...
        public void UpdateFromDatabaseObject(b_IoTDeviceEventLog dbObj)
        {
        ...
        {
            b_IoTDeviceEventLog dbObj = new b_IoTDeviceEventLog();
        ...
        public b_IoTDeviceEventLog ToDatabaseObject()
        {
            b_IoTDeviceEventLog dbObj = new b_IoTDeviceEventLog();
        ...
        {
            IoTDeviceEventLog_Create trans = new IoTDeviceEventLog_Create();
            trans.IoTDeviceEventLog = this.ToDatabaseObject();
            trans.dbKey = dbKey.ToTransDbKey();
            trans.Execute();
            
            // The create procedure may have populated an auto-incremented key. 
            UpdateFromDatabaseObject(trans.IoTDeviceEventLog);
        }

        public void Retrieve(DatabaseKey dbKey) 
        {
            IoTDeviceEventLog_Retrieve trans = new IoTDeviceEventLog_Retrieve();
            trans.IoTDeviceEventLog = this.ToDatabaseObject();
            trans.dbKey = dbKey.ToTransDbKey();
            trans.Execute();
            UpdateFromDatabaseObject(trans.IoTDeviceEventLog);
        ...
        {
            IoTDeviceEventLog_Update trans = new IoTDeviceEventLog_Update();
            trans.IoTDeviceEventLog = this.ToDatabaseObject();
        ...
        {
            IoTDeviceEventLog_Delete trans = new IoTDeviceEventLog_Delete();
            trans.IoTDeviceEventLog = this.ToDatabaseObject();
            trans.dbKey = dbKey.ToTransDbKey();
            trans.Execute();
        }
