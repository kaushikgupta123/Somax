...
{
    /// <summary>
    /// Business object that stores a record from the AssetGroup2 table.
    /// </summary>
    [Serializable()]
    [DataContract(Namespace = "http://schemas.datacontract.org/2004/07/SOMAX.DataContracts")]
    public partial class AssetGroup2 : DataContractBase 
    {
        #region Constructors
        /// <summary>
        /// Default constructor.
        ...
        public void UpdateFromDatabaseObject(b_AssetGroup2 dbObj)
        {
        ...
        {
            b_AssetGroup2 dbObj = new b_AssetGroup2();
        ...
        public b_AssetGroup2 ToDatabaseObject()
        {
            b_AssetGroup2 dbObj = new b_AssetGroup2();
        ...
        {
            AssetGroup2_Create trans = new AssetGroup2_Create();
        ...
        {
            AssetGroup2_Retrieve trans = new AssetGroup2_Retrieve();
            trans.AssetGroup2 = this.ToDatabaseObject();
            trans.dbKey = dbKey.ToTransDbKey();
            trans.Execute();
            UpdateFromDatabaseObject(trans.AssetGroup2);
        ...
        {
            AssetGroup2_Update trans = new AssetGroup2_Update();
            trans.AssetGroup2 = this.ToDatabaseObject();
        ...
        {
            AssetGroup2_Delete trans = new AssetGroup2_Delete();
            trans.AssetGroup2 = this.ToDatabaseObject();
            trans.dbKey = dbKey.ToTransDbKey();
            trans.Execute();
        }
        ...
        {
            AuditTargetObjectId = this.AssetGroup2Id;
        ...
        /// </summary>
        [DataMember]
        public long AssetGroup2Id
        {
            get { return _AssetGroup2Id; }
            set { Set<long>(MethodBase.GetCurrentMethod().Name, value, ref _AssetGroup2Id); }
        }
