...
{
    /// <summary>
    /// Business object that stores a record from the SanitationEventLog table.
    /// </summary>
    [Serializable()]
    ...
    public partial class SanitationEventLog : DataContractBase 
    {
        ...
        public void UpdateFromDatabaseObject(b_SanitationEventLog dbObj)
        {
        ...
        {
            b_SanitationEventLog dbObj = new b_SanitationEventLog();
        ...
        public b_SanitationEventLog ToDatabaseObject()
        {
            b_SanitationEventLog dbObj = new b_SanitationEventLog();
        ...
        {
            SanitationEventLog_Create trans = new SanitationEventLog_Create();
            trans.SanitationEventLog = this.ToDatabaseObject();
            trans.dbKey = dbKey.ToTransDbKey();
            trans.Execute();
            
            // The create procedure may have populated an auto-incremented key. 
            UpdateFromDatabaseObject(trans.SanitationEventLog);
        }

        public void Retrieve(DatabaseKey dbKey) 
        {
            SanitationEventLog_Retrieve trans = new SanitationEventLog_Retrieve();
            trans.SanitationEventLog = this.ToDatabaseObject();
            trans.dbKey = dbKey.ToTransDbKey();
            trans.Execute();
            UpdateFromDatabaseObject(trans.SanitationEventLog);
        ...
        {
            SanitationEventLog_Update trans = new SanitationEventLog_Update();
            trans.SanitationEventLog = this.ToDatabaseObject();
        ...
        {
            SanitationEventLog_Delete trans = new SanitationEventLog_Delete();
            trans.SanitationEventLog = this.ToDatabaseObject();
            trans.dbKey = dbKey.ToTransDbKey();
            trans.Execute();
        }
