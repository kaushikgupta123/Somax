...
{
    /// <summary>
    /// Access the usp_AdminLoginData_RetrieveByUserName_V2 stored procedure.
    /// </summary>
    public class usp_AdminLoginData_RetrieveByUserName_V2
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_AdminLoginData_RetrieveByUserName_V2";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_AdminLoginData_RetrieveByUserName_V2()
        {
        }
        ...
        )
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    tempRecord = b_Client.ProcessRowForAdmin(reader);
                }
