...
namespace Database.StoredProcedure
{
    ...
    public class usp_ClientMessage_RetrieveChunkSearch_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_ClientMessage_RetrieveChunkSearch_V2";
        public usp_ClientMessage_RetrieveChunkSearch_V2()
        {

        }
        /// <summary>
        /// Static method to call the usp_ClientMessage_RetrieveChunkSearch_V2 stored procedure using SqlClient.
        /// </summary>
        ...
        )
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    records.Add(b_ClientMessage.ProcessRowForRetrieveChunkSearchFromDetails(reader));
                }
            }
            finally
            {
