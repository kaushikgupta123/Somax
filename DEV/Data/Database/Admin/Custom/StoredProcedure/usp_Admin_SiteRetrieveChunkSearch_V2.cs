...
{
   public class usp_Admin_SiteRetrieveChunkSearch_V2
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_Admin_SiteRetrieveChunkSearch_V2";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_Admin_SiteRetrieveChunkSearch_V2()
        {
        }
        ...
        )
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    b_Site tmpSite = b_Site.ProcessRetrieveForSiteChunkV2(reader);
