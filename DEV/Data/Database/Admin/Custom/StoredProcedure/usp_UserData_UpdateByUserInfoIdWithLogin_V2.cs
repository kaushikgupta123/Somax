...
{
    public class usp_UserData_UpdateByUserInfoIdWithLogin_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_UserData_UpdateByUserInfoIdWithLogin_V2";

        public usp_UserData_UpdateByUserInfoIdWithLogin_V2()
        {
        }
...

        {
            ...
            command.SetStringInputParameter(SqlDbType.VarChar, "EmployeeId", obj.EmployeeId, 62); //V2-877
