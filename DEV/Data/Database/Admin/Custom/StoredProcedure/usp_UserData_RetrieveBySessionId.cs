...
* a Trade Secret. 
**************************************************************************************************
* Copyright (c) 2014-2020 by SOMAX Inc.. All rights reserved. 
**************************************************************************************************
* Date        JIRA Item Person        Description
* =========== ========= ============= ============================================================
* 2020-Nov-03 V2-418    Roger Lawton  Retrieving V2SecurityProfileId instead of SecurityProfileId
**************************************************************************************************
*/
using System;
using System.Data;
...
namespace Database.StoredProcedure
{
    ...
    /// </summary>
    public class usp_UserData_RetrieveBySessionId
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_UserData_RetrieveBySessionId_V2";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_UserData_RetrieveBySessionId()
        {
        }
        ...
        )
        {
            ...
            try
            {
                ...
                //V2-730 ApprovalGroupSettings Start
                ...
                {
                    // Add the record to the list.
                    tempRecord = b_ApprovalGroupSettings.ProcessRowForLogin(reader);
                }
                
                records.Add(tempRecord);
                //V2-730 ApprovalGroupSettings End
            }
            finally
            {
                if (null != reader)
