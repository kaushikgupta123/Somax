...
{
    /// <summary>
    /// Access the usp_LoginInfo_RetrieveAll stored procedure.
    /// </summary>
    public class usp_LoginInfo_RetrieveBySearchCriteria
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_LoginInfo_RetrieveBySearchCriteria";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_LoginInfo_RetrieveBySearchCriteria()
        {
        }

        /// <summary>
        /// Static method to call the usp_LoginInfo_RetrieveBySearchCriteria stored procedure using SqlClient.
        /// </summary>
        ...
        )
        {
            ...
            try
            {
                ...
                if (0 != retCode)
                {
                    string message = "usp_LoginInfo_RetrieveByClientId stored procedure returned invalid return code: " + retCode.ToString();
