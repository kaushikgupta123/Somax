...
namespace Database.StoredProcedure
{
    ...
    /// </summary>
    public class usp_LoginData_RetrieveBySSO
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_LoginData_RetrieveBySSO";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_LoginData_RetrieveBySSO()
        {
        }
        ...
        )
        {
            ...
            command.SetInputParameter(SqlDbType.BigInt, "UserInfoId", obj.UserInfoIdSSO);
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    tempRecord = b_Client.ProcessRowForAdminSSO(reader);
                }
