...
{
    public class usp_UserData_ValidateNewUserAdd_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_UserData_ValidateNewUserAdd_V2";

        public usp_UserData_ValidateNewUserAdd_V2()
        {
        }
