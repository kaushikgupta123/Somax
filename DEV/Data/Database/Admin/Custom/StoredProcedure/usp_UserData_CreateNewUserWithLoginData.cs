...
{
   public class usp_UserData_CreateNewUserWithLoginData
    {
       private static string STOREDPROCEDURE_NAME = "usp_UserData_CreateNewUserWithLoginData";

       public usp_UserData_CreateNewUserWithLoginData()
        {
