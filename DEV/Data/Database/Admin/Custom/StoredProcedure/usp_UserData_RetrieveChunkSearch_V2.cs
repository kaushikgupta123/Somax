...
{
    class usp_UserData_RetrieveChunkSearch_V2
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_UserData_RetrieveChunkSearch_V2";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_UserData_RetrieveChunkSearch_V2()
        {
        }
        ...
        )
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    records.Add(b_UserSearch.ProcessRowForUserSearchList(reader));
                }
            }
            finally
            {
