...
{
    public class usp_Client_RetrieveByPKBySomaxAdmin_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_Client_RetrieveByPKBySomaxAdmin_V2";

        public usp_Client_RetrieveByPKBySomaxAdmin_V2()
        {
        }
