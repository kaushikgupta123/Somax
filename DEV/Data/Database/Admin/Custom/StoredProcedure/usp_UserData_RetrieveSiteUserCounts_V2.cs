...
{
    public class usp_UserData_RetrieveSiteUserCounts_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_UserData_RetrieveSiteUserCounts_V2";

        public usp_UserData_RetrieveSiteUserCounts_V2()
        {
        ...
        )
        {
            ...
            command.SetOutputParameter(SqlDbType.BigInt, "ProdUserOut");
            ...
            obj.CountProdUser = (long)command.Parameters["@ProdUserOut"].Value;
