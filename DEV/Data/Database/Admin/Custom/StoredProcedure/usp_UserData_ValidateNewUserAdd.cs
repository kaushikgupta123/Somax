...
{
   public class usp_UserData_ValidateNewUserAdd
    {
       private static string STOREDPROCEDURE_NAME = "usp_UserData_ValidateNewUserAdd";

       public usp_UserData_ValidateNewUserAdd()
        {
        }
