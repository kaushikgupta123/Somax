...
namespace Database.Business
{
    ...
    public partial class b_MasterSanLibrary
    {
     ...
     ref List<b_StoredProcValidationError> data
  )
        {
            ...
            try
            {
                ...
                results = Database.StoredProcedure.usp_MasterSanLibrary_ValidateByClientLookupId.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
    ...
    string callerUserName,
      ...
      )
        {
            ...
            try
            {
                ...
                // Call the stored procedure to retrieve the data
                processRow = new Database.SqlClient.ProcessRow<b_MasterSanLibrary>(reader => { b_MasterSanLibrary obj = new b_MasterSanLibrary(); obj.LoadFromDatabaseCustom(reader); return obj; });
                results = Database.StoredProcedure.usp_MasterSanLibrary_RetrieveAllCustom.CallStoredProcedure(command, processRow, callerUserInfoId, callerUserName, ClientId);
        ...
        public static b_MasterSanLibrary ProcessRowForSearch(SqlDataReader reader)
        {
