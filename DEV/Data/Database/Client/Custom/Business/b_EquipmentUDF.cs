...
{
    public partial class b_EquipmentUDF
    {
        #region Variables
        ...
        #region Retreieve by EquipmentId
        public static b_EquipmentUDF ProcessRowForRetrieveByEquipmentId(SqlDataReader reader)
        {
            // Create instance of object
            b_EquipmentUDF obj = new b_EquipmentUDF();

            // Load the object from the database
            obj.LoadFromDatabaseForRetrieveByEquipmentId(reader);
        ...
        public int LoadFromDatabaseForRetrieveByEquipmentId(SqlDataReader reader)
        {
            ...
            try
            {
                ...
                EquipmentUDFId = reader.GetInt64(i++);
            ...
            catch (Exception ex)
            {
                ...
                try { reader["EquipmentUDFId"].ToString(); }
                catch { missing.Append("EquipmentUDFId "); }
     ...
     ref b_EquipmentUDF results
     )
        {
            ...
            try
            {
                ...
                results = Database.StoredProcedure.usp_EquipmentUDF_RetrieveByEquipmetnId_V2.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
