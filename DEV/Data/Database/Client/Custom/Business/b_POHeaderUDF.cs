...
{
    public partial class b_POHeaderUDF
    {
        #region Variables
        ...
        #region Retreieve by PurchaseOrderId
        public static b_POHeaderUDF ProcessRowForRetrieveByPurchaseOrderId(SqlDataReader reader)
        {
            // Create instance of object
            b_POHeaderUDF obj = new b_POHeaderUDF();

            // Load the object from the database
            obj.LoadFromDatabaseForRetrieveByPurchaseOrderId(reader);

            // Return result
            return obj;
        }

        public int LoadFromDatabaseForRetrieveByPurchaseOrderId(SqlDataReader reader)
        {
            int i = 0;
            try
            {
                ...
                // POHeaderUDFId column, bigint, not null
                POHeaderUDFId = reader.GetInt64(i++);
            ...
            catch (Exception ex)
            {
                ...
                try { reader["POHeaderUDFId"].ToString(); }
                catch { missing.Append("POHeaderUDFId "); }
        ...
        public void RetrieveByPurchaseOrderId(
     SqlConnection connection,
     SqlTransaction transaction,
     long callerUserInfoId,
     string callerUserName,
     ref b_POHeaderUDF results
     )
        {
            ...
            try
            {
                ...
                results = Database.StoredProcedure.usp_POHeaderUDF_RetrieveByPurchaseOrderId_V2.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
        ...
        public static b_POHeaderUDF ProcessRowForPurchaseOrderUDFPrint(SqlDataReader reader)
        {
            // Create instance of object
            b_POHeaderUDF obj = new b_POHeaderUDF();

            // Load the object from the database
            obj.LoadFromDatabaseForPurchaseOrderUDFPrint(reader);

            // Return result
            return obj;
        }
        public void LoadFromDatabaseForPurchaseOrderUDFPrint(SqlDataReader reader)
        {
