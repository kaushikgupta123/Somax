...
namespace Database.Business
{
    ...
    /// </summary>
    public partial class b_SanitationEventLog
    {
        #region Property
        ...
        public static object ProcessRowBySanitationJobId(SqlDataReader reader)
        {
        ...
        public void RetrieveBySanitationJobIdFromDatabase(
            SqlConnection connection,
            SqlTransaction transaction,
            long callerUserInfoId,
            string callerUserName,
            ref List<b_SanitationEventLog> data
        )
        {

            SqlCommand command = null;
            string message = String.Empty;
            List<b_SanitationEventLog> results = null;
            data = new List<b_SanitationEventLog>();
            ...
            try
            {
                ...
                results = Database.StoredProcedure.usp_SanitationEventLog_RetrieveBySanitationJobId.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
