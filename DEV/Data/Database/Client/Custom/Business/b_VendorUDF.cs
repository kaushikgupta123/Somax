...
{
    public partial class b_VendorUDF
    {
        #region Variables
        ...
        #region Retreieve by VendorId
        public static b_VendorUDF ProcessRowForRetrieveByVendorId(SqlDataReader reader)
        {
            // Create instance of object
            b_VendorUDF obj = new b_VendorUDF();

            // Load the object from the database
            obj.LoadFromDatabaseForRetrieveByVendorId(reader);

            // Return result
            return obj;
        }

        public int LoadFromDatabaseForRetrieveByVendorId(SqlDataReader reader)
        {
            int i = 0;
            try
            {
                ...
                // EquipmentUDFId column, bigint, not null
                VendorUDFId = reader.GetInt64(i++);
            ...
            catch (Exception ex)
            {
                ...
                try { reader["VendorUDFId"].ToString(); }
        ...
        public void RetrieveByVendorId(
     SqlConnection connection,
     SqlTransaction transaction,
     long callerUserInfoId,
     string callerUserName,
     ref b_VendorUDF results
     )
        {
            ...
            try
            {
                ...
                results = Database.StoredProcedure.usp_VendorUDF_RetrieveByVendorId_V2.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
