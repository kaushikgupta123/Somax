...
namespace Database.Business
{
    ...
    /// </summary>
    public partial class b_PurchasingEventLog
    {
        #region Property
        ...
        public static object ProcessRowByObjectId(SqlDataReader reader)
        {
        ...
        public void RetrieveByObjectIdFromDatabase(
            ...
            ref List<b_PurchasingEventLog> data
        )
        {

            SqlCommand command = null;
            string message = String.Empty;
            List<b_PurchasingEventLog> results = null;
            data = new List<b_PurchasingEventLog>();
            ...
            try
            {
                ...
                results = Database.StoredProcedure.usp_PurchasingEventLog_RetrieveByObjectId.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
