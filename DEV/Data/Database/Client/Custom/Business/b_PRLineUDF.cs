...
{
    public partial class b_PRLineUDF
    {
        #region Variables
        ...
        #region Retreieve by PurchaseRequestLineItemId
        public static b_PRLineUDF ProcessRowForRetrieveByPurchaseRequestLineItemId(SqlDataReader reader)
        {
            // Create instance of object
            b_PRLineUDF obj = new b_PRLineUDF();

            // Load the object from the database
            obj.LoadFromDatabaseForRetrieveByPurchaseRequestLineItemId(reader);

            // Return result
            return obj;
        }

        public int LoadFromDatabaseForRetrieveByPurchaseRequestLineItemId(SqlDataReader reader)
        {
            int i = 0;
            try
            {
                ...
                // PRLineUDFId column, bigint, not null
                PRLineUDFId = reader.GetInt64(i++);
            ...
            catch (Exception ex)
            {
                ...
                try { reader["PRLineUDFId"].ToString(); }
                catch { missing.Append("PRLineUDFId "); }
        ...
        public void RetrieveByPurchaseRequestLineItemId(
     SqlConnection connection,
     SqlTransaction transaction,
     long callerUserInfoId,
     string callerUserName,
     ref b_PRLineUDF results
     )
        {
            ...
            try
            {
                ...
                results = Database.StoredProcedure.usp_PRLineUDF_RetrieveByPurchaseRequestLineItemId_V2.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
        ...
        public void DeleteByPurchaseRequestLineItemId(
   SqlConnection connection,
   SqlTransaction transaction,
   long callerUserInfoId,
   string callerUserName
)
        {
            ...
            try
            {
                ...
                Database.StoredProcedure.usp_PRLineUDF_DeleteByPurchaseRequestLineItemId_V2.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
        ...
        #region V2-945
        public static b_PRLineUDF ProcessRowForPRprLineUDFPrint(SqlDataReader reader)
        {
            b_PRLineUDF prLineUDF = new b_PRLineUDF();

            prLineUDF.LoadFromDatabaseForprLineUDFUDFPrint(reader);
            return prLineUDF;
        }

        public void LoadFromDatabaseForprLineUDFUDFPrint(SqlDataReader reader)
        {
            int i = 0;
            try
            {
