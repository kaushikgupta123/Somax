...
{
    public partial class b_PRHeaderUDF
    {
        #region Variables
        ...
        #region Retreieve by PurchaseRequestId
        public static b_PRHeaderUDF ProcessRowForRetrieveByPurchaseRequestId(SqlDataReader reader)
        {
            // Create instance of object
            b_PRHeaderUDF obj = new b_PRHeaderUDF();

            // Load the object from the database
            obj.LoadFromDatabaseForRetrieveByPurchaseRequestId(reader);

            // Return result
            return obj;
        }

        public int LoadFromDatabaseForRetrieveByPurchaseRequestId(SqlDataReader reader)
        {
            int i = 0;
            try
            {
                ...
                // PRHeaderUDFId column, bigint, not null
                PRHeaderUDFId = reader.GetInt64(i++);
            ...
            catch (Exception ex)
            {
                ...
                try { reader["PRHeaderUDFId"].ToString(); }
                catch { missing.Append("VendorUDFId "); }
        ...
        public void RetrieveByPurchaseRequestId(
     SqlConnection connection,
     SqlTransaction transaction,
     long callerUserInfoId,
     string callerUserName,
     ref b_PRHeaderUDF results
     )
        {
            ...
            try
            {
                ...
                results = Database.StoredProcedure.usp_PRHeaderUDF_RetrieveByPurchaseRequestId_V2.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
        ...
        #region V2-945
        public static b_PRHeaderUDF ProcessRowForPRHeaderUDFPrint(SqlDataReader reader)
        {
            b_PRHeaderUDF prHeaderUDF = new b_PRHeaderUDF();

            prHeaderUDF.LoadFromDatabaseForPRHeaderUDFPrint(reader);
            return prHeaderUDF;
        }

        public void LoadFromDatabaseForPRHeaderUDFPrint(SqlDataReader reader)
        {
            int i = 0;
            try
            {
