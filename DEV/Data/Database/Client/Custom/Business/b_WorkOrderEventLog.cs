...
namespace Database.Business
{
    ...
    /// </summary>
    public partial class b_WorkOrderEventLog
    {
        #region Property
        ...
        public void RetrieveByWorkOrderIdFromDatabase(
            ...
            ref List<b_WorkOrderEventLog> data
        )
        {

            SqlCommand command = null;
            string message = String.Empty;
            List<b_WorkOrderEventLog> results = null;
            data = new List<b_WorkOrderEventLog>();
            ...
            try
            {
                ...
                results = Database.StoredProcedure.usp_WorkOrderEventLog_RetrieveByWorkOrderId.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
