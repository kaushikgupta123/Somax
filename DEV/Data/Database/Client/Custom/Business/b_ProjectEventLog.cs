...
{
    public partial class b_ProjectEventLog
    {
        #region Property
        ...
        public static object ProcessRowByProjectId(SqlDataReader reader)
        {
            // Create instance of object
            b_ProjectEventLog obj = new b_ProjectEventLog();
        ...
        public void RetrieveByProjectIdFromDatabase(
            SqlConnection connection,
            SqlTransaction transaction,
            long callerUserInfoId,
            string callerUserName,
            ref List<b_ProjectEventLog> data
        )
        {

            SqlCommand command = null;
            string message = String.Empty;
            List<b_ProjectEventLog> results = null;
            data = new List<b_ProjectEventLog>();
            ...
            try
            {
                ...
                results = Database.StoredProcedure.usp_ProjectEventLog_RetrieveByProjectId_V2.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
