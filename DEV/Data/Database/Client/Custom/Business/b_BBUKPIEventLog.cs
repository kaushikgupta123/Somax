...
{
    public partial class b_BBUKPIEventLog
    {
        #region Property
        ...
        public static object ProcessRowByBBUKPIId(SqlDataReader reader)
        {
            // Create instance of object
            b_BBUKPIEventLog obj = new b_BBUKPIEventLog();
        ...
        public void RetrieveByBBUKPIIdFromDatabase(
            SqlConnection connection,
            SqlTransaction transaction,
            long callerUserInfoId,
            string callerUserName,
            ref List<b_BBUKPIEventLog> data
        )
        {

            SqlCommand command = null;
            string message = String.Empty;
            List<b_BBUKPIEventLog> results = null;
            data = new List<b_BBUKPIEventLog>();
            ...
            try
            {
                ...
                results = Database.StoredProcedure.usp_BBUKPIEventLog_RetrieveByBBUKPIId_V2.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
