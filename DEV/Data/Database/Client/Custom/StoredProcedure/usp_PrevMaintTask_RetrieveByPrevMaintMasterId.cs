...
{
    public class usp_PrevMaintTask_RetrieveByPrevMaintMasterId
    {
        private static string STOREDPROCEDURE_NAME = "usp_PrevMaintTask_RetrieveByPrevMaintMasterId";

        public usp_PrevMaintTask_RetrieveByPrevMaintMasterId()
        {
        }
        ...
        public static List<b_PrevMaintTask> CallStoredProcedure(
            SqlCommand command,
        ...
        {
            List<b_PrevMaintTask> records = new List<b_PrevMaintTask>();
            SqlDataReader reader = null;
            b_PrevMaintTask record = null;
