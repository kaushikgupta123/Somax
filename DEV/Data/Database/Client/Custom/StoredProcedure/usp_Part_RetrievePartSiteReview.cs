...
{
   public class usp_Part_RetrievePartSiteReview
    {

       private static string STOREDPROCEDURE_NAME = "usp_Part_RetrieveForSiteReview";

       public usp_Part_RetrievePartSiteReview()
        {
        }
     ...
     )
       {
           ...
           try
           {
               ...
               while (reader.Read())
               {
                   ...
                   b_Part tmpParts = b_Part.ProcessRowForPartSiteReview(reader);
