...
namespace Database.StoredProcedure
{
    ...
    /// </summary>
    public class usp_Prevmaintsched_OnDemandForecastFromPrevMaintLibrary_V2
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_Prevmaintsched_OnDemandForecastFromPrevMaintLibrary_V2";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_Prevmaintsched_OnDemandForecastFromPrevMaintLibrary_V2()
        {
        }
        ...
        )
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    records.Add((b_PrevMaintSched)b_PrevMaintSched.ProcessRowExtendedForOnDemandForecast_V2(reader));
                }
