...
{
    public class usp_ShipTo_RetrieveChunkSearch_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_ShipTo_RetrieveChunkSearch_V2";
        public usp_ShipTo_RetrieveChunkSearch_V2()
        {
                
        }
        public static List<b_ShipTo> CallStoredProcedure(
       SqlCommand command,
       ...
       b_ShipTo obj
        ...
        {
            List<b_ShipTo> records = new List<b_ShipTo>();
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    b_ShipTo tmp = b_ShipTo.ProcessRowForChunkSearch(reader);
                    records.Add(tmp);
                }
