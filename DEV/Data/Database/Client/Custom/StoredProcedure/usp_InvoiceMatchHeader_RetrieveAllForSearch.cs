...
{
   public class usp_InvoiceMatchHeader_RetrieveAllForSearch
    {
        private static string STOREDPROCEDURE_NAME = "usp_InvoiceMatchHeader_RetrieveAllForSearch";

        public usp_InvoiceMatchHeader_RetrieveAllForSearch()
        {
        }
       ...
       )
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    b_InvoiceMatchHeader tmpWorkOrders = b_InvoiceMatchHeader.ProcessRowForInvoiceMatchHeaderRetriveAllForSearch(reader);
