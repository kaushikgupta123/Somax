...
{
    public class usp_Part_SearchForCartWO_MultiStoreroom_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_Part_SearchForCartWO_MultiStoreroom_V2";

        public usp_Part_SearchForCartWO_MultiStoreroom_V2()
        {
        }
   ...
   )
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    records.Add(b_Part.ProcessRowSearchForCartWOMultiStoreroom(reader));
                }
            }
            finally
            {
