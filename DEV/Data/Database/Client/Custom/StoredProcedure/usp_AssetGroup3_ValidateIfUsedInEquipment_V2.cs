...
{
    public class usp_AssetGroup3_ValidateIfUsedInEquipment_V2

    {
        private static string STOREDPROCEDURE_NAME = "usp_AssetGroup3_ValidateIfUsedInEquipment_V2";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_AssetGroup3_ValidateIfUsedInEquipment_V2
()
        {
        }
        ...
        )
        {
            ...
            command.SetInputParameter(SqlDbType.BigInt, "AssetGroup3Id ", obj.AssetGroup3);
