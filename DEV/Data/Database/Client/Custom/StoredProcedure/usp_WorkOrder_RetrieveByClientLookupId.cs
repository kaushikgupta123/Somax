...
{
    public class usp_WorkOrder_RetrieveByClientLookupId
    {
        private static string STOREDPROCEDURE_NAME = "usp_WorkOrder_RetrieveByClientLookupId";

        public usp_WorkOrder_RetrieveByClientLookupId()
        {
        }
