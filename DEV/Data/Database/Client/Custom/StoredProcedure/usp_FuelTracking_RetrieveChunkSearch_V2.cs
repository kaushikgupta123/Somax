...
{
    public class usp_FuelTracking_RetrieveChunkSearch_V2
    {
        /// <summary>
        /// Constants.
        /// </summary>
       private static string STOREDPROCEDURE_NAME = "usp_FuelTracking_RetrieveChunkSearch_V2";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_FuelTracking_RetrieveChunkSearch_V2()
        {
        }
        ...
        )
        {
            ...
            command.SetStringInputParameter(SqlDbType.NVarChar, "ReadingStartDate", obj.ReadingStartDate, 60);
            command.SetStringInputParameter(SqlDbType.NVarChar, "ReadingEndDate", obj.ReadingEndDate, 60);
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    b_Equipment tmpEquipment = b_Equipment.ProcessRetrieveForFleetFuelChunkV2(reader);
