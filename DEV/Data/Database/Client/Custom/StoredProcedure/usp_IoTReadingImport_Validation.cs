...
{
    public class usp_IoTReadingImport_Validation
    {
        private static string STOREDPROCEDURE_NAME = "usp_IoTReadingImport_Validation";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_IoTReadingImport_Validation()
        {
        }
        ...
        )
        {
            ...
            command.SetInputParameter(SqlDbType.BigInt, "Reading", obj.Reading);
