...
{
   public class usp_Department_ValidateOldClientLookupId
    {
        private static string STOREDPROCEDURE_NAME = "usp_Department_ValidateOldClientLookupIdV2";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_Department_ValidateOldClientLookupId()
        {
        }
