...
{
    public class usp_PurchaserequestLineItem_RetrieveByPurchaseRequestLineItemId
    {
        private static string STOREDPROCEDURE_NAME = "usp_PurchaseRequestLineItem_RetrieveByPurchaseRequestLineItemId";

        public usp_PurchaserequestLineItem_RetrieveByPurchaseRequestLineItemId()
        {
        }
