...
{
    public class usp_WorkOrder_GetWorkOrderBySearchCriteriaForCalendar_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_WorkOrder_GetWorkOrderBySearchCriteriaForCalendar_V2";

        public usp_WorkOrder_GetWorkOrderBySearchCriteriaForCalendar_V2()
        {
        }
       ...
       b_WorkOrder obj
   )
        {
            ...
            command.SetInputParameter(SqlDbType.Int, "Flag", obj.ScheduleFlag);
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    b_WorkOrder = b_WorkOrder.ProcessRowForAvailableWorkLaborSchedulingSearchCalendar(reader);
