...
{
    public class usp_EstimatedCosts_RetrieveChunkSearchForMaterialRequest_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_EstimatedCosts_RetrieveChunkSearchForMaterialRequest_V2";

        public usp_EstimatedCosts_RetrieveChunkSearchForMaterialRequest_V2()
        {
        }
        ...
        )
        {
            ...
            command.SetStringInputParameter(SqlDbType.NVarChar, "WorkOrderClientLookupId", obj.WorkOrderClientLookupId, 70);
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    record.LoadFromDatabaseForMaterialRequest(reader);
                    records.Add(record);
                }
            }
            catch (Exception ex)
