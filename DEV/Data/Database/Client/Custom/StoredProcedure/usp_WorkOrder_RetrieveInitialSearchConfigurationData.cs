...
{
    /// <summary>
    /// Access the usp_WorkOrder_RetrieveInitialSearchConfigurationData stored procedure.
    /// </summary>
    public class usp_WorkOrder_RetrieveInitialSearchConfigurationData
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_WorkOrder_RetrieveInitialSearchConfigurationData";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_WorkOrder_RetrieveInitialSearchConfigurationData()
        {
        }
            ...
            )
        {
            ...
            try
            {
                string[] categories = new string[] { SearchCategoryConstants.P_QUERY, SearchCategoryConstants.P_SITE, SearchCategoryConstants.P_AREA, SearchCategoryConstants.P_DEPARTMENT, SearchCategoryConstants.P_SOURCE, SearchCategoryConstants.P_TYPE, 
                    SearchCategoryConstants.P_STATUS, SearchCategoryConstants.P_PRIORITY, SearchCategoryConstants.P_SHIFT };
