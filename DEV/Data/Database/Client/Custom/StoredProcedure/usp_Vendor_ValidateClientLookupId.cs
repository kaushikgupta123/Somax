...
{
    public class usp_Vendor_ValidateClientLookupId
    {
        private static string STOREDPROCEDURE_NAME = "usp_Vendor_ValidateClientLookupId";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_Vendor_ValidateClientLookupId()
        {
        }
