...
{
    public class usp_WorkOrder_WRDashboardRetrieveAllForSearch_V2
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_WorkOrder_WRDashboardRetrieveAllForSearch_V2";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_WorkOrder_WRDashboardRetrieveAllForSearch_V2()
        {
        }

        /// <summary>
        /// Static method to call the usp_WorkOrder_WRDashboardRetrieveAllForSearch_V2 stored procedure using SqlClient.
        /// </summary>
        ...
        )
        {
            ...
            command.SetStringInputParameter(SqlDbType.NVarChar, "Completed", obj.Completed, 500);
