...
{
    /// <summary>
    /// Access the usp_Part_Vendor_Xref_RetrieveByPartId stored procedure.
    /// </summary>
    public class usp_Part_Vendor_Xref_RetrieveByPartId
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_Part_Vendor_Xref_RetrieveByPartId";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_Part_Vendor_Xref_RetrieveByPartId()
        {
        }

        /// <summary>
        /// Static method to call the usp_Part_Vendor_Xref_RetrieveByPartId stored procedure using SqlClient.
        /// </summary>
          ...
          List<b_Part_Vendor_Xref> records = new List<b_Part_Vendor_Xref>();
            ...
            try
            {
                ...
                while (reader.Read())
                {
                  ...
                  records.Add((b_Part_Vendor_Xref)b_Part_Vendor_Xref.ProcessRowExtended(reader));
                }
