...
{
    /// <summary>
    /// Access the usp_FleetMeterandFuelTracking_ValidiationForUnvoid_V2 stored procedure.
    /// </summary>
    public class usp_FleetMeterandFuelTracking_ValidiationForUnvoid_V2
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_FleetMeterandFuelTracking_ValidiationForUnvoid_V2";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_FleetMeterandFuelTracking_ValidiationForUnvoid_V2()
        {
        }

        /// <summary>
        /// Static method to call the usp_FleetMeterandFuelTracking_ValidiationForUnvoid_V2 stored procedure using SqlClient.
        /// </summary>
        ...
        )
        {
            ...
            command.SetStringInputParameter(SqlDbType.NVarChar, "TableName", obj.TableName,256);
