...
{
    public class usp_PurchaseRequest_WorkBenchRetrieveAll_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_PurchaseRequest_WorkBenchRetrieveAll_V2";

        public usp_PurchaseRequest_WorkBenchRetrieveAll_V2()
        {
        }
