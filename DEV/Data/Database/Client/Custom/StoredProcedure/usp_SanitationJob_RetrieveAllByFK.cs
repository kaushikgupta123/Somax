...
{
   public class usp_SanitationJob_RetrieveAllByFK
    {
       private static string STOREDPROCEDURE_NAME = "usp_SanitationJob_RetrieveAllByFK";
       public usp_SanitationJob_RetrieveAllByFK()
        {
        }
       ...
       )
         {
             ...
             command.SetInputParameter(SqlDbType.Bit, "ShowCompleted", obj.ShowCompleted);
             try
             {
