...
{
    public class usp_PurchaseRequest_ValidateByClientLookupId
    {
        private static string STOREDPROCEDURE_NAME = "usp_PurchaseRequest_ValidateByClientLookupId";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_PurchaseRequest_ValidateByClientLookupId()
        {
        }
