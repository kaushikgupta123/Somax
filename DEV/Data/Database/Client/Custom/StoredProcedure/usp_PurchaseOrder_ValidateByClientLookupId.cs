...
{
    public class usp_PurchaseOrder_ValidateByClientLookupId
    {
        private static string STOREDPROCEDURE_NAME = "usp_PurchaseOrder_ValidateByClientLookupId";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_PurchaseOrder_ValidateByClientLookupId()
        {
        }
