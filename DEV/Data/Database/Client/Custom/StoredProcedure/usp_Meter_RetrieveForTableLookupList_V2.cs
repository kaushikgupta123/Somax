...
{
    public class usp_Meter_RetrieveForTableLookupList_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_Meter_RetrieveForTableLookupList_V2";
        public usp_Meter_RetrieveForTableLookupList_V2()
        {
       ...
       )
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    b_Meter tmpEq = b_Meter.ProcessRowRetrieveForTableLookupList_V2(reader);
