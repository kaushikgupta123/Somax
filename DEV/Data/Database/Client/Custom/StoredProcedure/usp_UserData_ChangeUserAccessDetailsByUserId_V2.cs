...
{
    public class usp_UserData_ChangeUserAccessDetailsByUserId_V2
    {
        //private static string STOREDPROCEDURE_NAME = "usp_UserData_ChangeUserAccessDetailsByUserId_V2";
        private static string STOREDPROCEDURE_NAME = "usp_UserData_ChangeUserAccessDetailsByUserId_V2";

        public usp_UserData_ChangeUserAccessDetailsByUserId_V2()
        {
        }
