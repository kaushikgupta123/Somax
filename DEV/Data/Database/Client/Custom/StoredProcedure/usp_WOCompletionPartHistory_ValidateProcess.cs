...
{
    /// <summary>
    /// Access the usp_PartHistory_ValidateProcess stored procedure.
    /// </summary>
    public class usp_WOCompletionPartHistory_ValidateProcess
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_WOCompletionPartHistory_ValidateProcess";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_WOCompletionPartHistory_ValidateProcess()
        {
        }

        /// <summary>
        /// Static method to call the usp_PartHistory_ValidateProcess stored procedure using SqlClient.
        /// </summary>
        ...
        )
        {
          ...
          //  command.SetStringInputParameter(SqlDbType.NVarChar, "IssueToClientLookupId", obj.IssueToClientLookupId, 31);
