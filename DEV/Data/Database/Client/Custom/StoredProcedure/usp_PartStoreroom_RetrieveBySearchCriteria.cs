...
{
    /// <summary>
    /// Access the usp_PartStoreroom_RetrieveBySearchCriteria stored procedure.
    /// </summary>
    public class usp_PartStoreroom_RetrieveBySearchCriteria
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_PartStoreroom_RetrieveBySearchCriteria";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_PartStoreroom_RetrieveBySearchCriteria()
        {
        }
        ...
        )
        {
            ...
            command.SetStringInputParameter(SqlDbType.VarChar, "Storeroom", storeroom, 256);
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    b_Part p = (b_Part)b_Part.ProcessRow(reader);
                    b_PartStoreroom ps = (b_PartStoreroom)b_PartStoreroom.ProcessRowForPartStoreroomSearchResult(reader);

                    KeyValuePair<b_Part, b_PartStoreroom> record = new KeyValuePair<b_Part, b_PartStoreroom>(p, ps);
