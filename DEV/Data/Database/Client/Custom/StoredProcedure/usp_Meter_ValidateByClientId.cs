...
{
    public class usp_Meter_ValidateByClientId
    {
        private static string STOREDPROCEDURE_NAME = "usp_Meter_ValidateByClientLookupId";
        public usp_Meter_ValidateByClientId()
        {
