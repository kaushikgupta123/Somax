...
{
  public class usp_VendorCatalogImport_ProcessInterface
  {
    /// <summary>
    /// Constants.
    /// </summary>
    private static string STOREDPROCEDURE_NAME = "usp_VendorCatalogImport_ProcessInterface";

    /// <summary>
    /// Default constructor.
    /// </summary>
    public usp_VendorCatalogImport_ProcessInterface()
    {
    ...
    )
    {
      ...
      command.SetInputParameter(SqlDbType.BigInt, "VendorCatalogImportId", obj.VendorCatalogImportId);
