...
namespace Database.StoredProcedure
{
    ...
    /// </summary>
    public class usp_PrevMaintSched_SchedulingRecordsForReassign
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_PrevMaintSched_SchedulingRecordsForReassign";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_PrevMaintSched_SchedulingRecordsForReassign()
        {
        }
        ...
        )
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    records.Add((b_PrevMaintSched)b_PrevMaintSched.ProcessRowForSchedulingRecords(reader));
                }
