...
{
    /// <summary>
    /// Access the usp_Vendor_RetrieveInitialSearchConfigurationData stored procedure.
    /// </summary>
    public class usp_Vendor_RetrieveInitialSearchConfigurationData
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_Vendor_RetrieveInitialSearchConfigurationData";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_Vendor_RetrieveInitialSearchConfigurationData()
        {
        }
            ...
            )
        {
            ...
            try
            {
                string[] categories = new string[] { SearchCategoryConstants.P_QUERY, SearchCategoryConstants.P_SITE, SearchCategoryConstants.P_AREA, SearchCategoryConstants.P_DEPARTMENT, SearchCategoryConstants.P_TYPE };
