...
{
    public class usp_PurchaseRequestLineItem_RetrieveByPurchaseRequestLineItemId_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_PurchaseRequestLineItem_RetrieveByPurchaseRequestLineItemId_V2";

        public usp_PurchaseRequestLineItem_RetrieveByPurchaseRequestLineItemId_V2()
        {
        }
        ...
        public static ArrayList CallStoredProcedure(
           SqlCommand command,
           Database.SqlClient.ProcessRow<b_PurchaseRequestLineItem> processRow,
