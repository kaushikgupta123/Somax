...
{
    public class usp_ReceiptImpLine_ValidateImport
  {
        private static string STOREDPROCEDURE_NAME = "usp_ReceiptImpLine_ValidateImport";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_ReceiptImpLine_ValidateImport()
        {
        }
        ...
        )
        {
           ...
           // command.SetInputParameter(SqlDbType.BigInt, "SiteId", obj.SiteId);
            ...
            command.SetStringInputParameter(SqlDbType.NVarChar, "ReceiptStatus", obj.ReceiptStatus, 31);    // V2-412
      try
      {
