...
{
    public class usp_SanitationJob_Retrieve_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_SanitationJob_Retrieve_V2";

        public usp_SanitationJob_Retrieve_V2()
        {
        }
