...
{
    public class usp_InvoiceMatchHeader_ValidateByClientLookupId
    {
        private static string STOREDPROCEDURE_NAME = "usp_InvoiceMatchHeader_ValidateByClientLookupId";

        public usp_InvoiceMatchHeader_ValidateByClientLookupId()
        {
        }
        ...
        )
        {
            ...
            command.SetStringInputParameter(SqlDbType.NVarChar, "Flag", obj.Flag, 5);
