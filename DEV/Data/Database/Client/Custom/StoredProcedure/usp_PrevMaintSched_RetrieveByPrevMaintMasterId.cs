...
namespace Database.StoredProcedure
{
    ...
    /// </summary>
    public class usp_PrevMaintSched_RetrieveByPrevMaintMasterId
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_PrevMaintSched_RetrieveByPrevMaintMasterId";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_PrevMaintSched_RetrieveByPrevMaintMasterId()
        {
        }
        ...
        )
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    records.Add((b_PrevMaintSched)b_PrevMaintSched.ProcessRowForForeignKeys(reader));
                }
