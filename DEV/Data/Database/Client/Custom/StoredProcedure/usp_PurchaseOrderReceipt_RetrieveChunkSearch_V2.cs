...
{
   public class usp_PurchaseOrderReceipt_RetrieveChunkSearch_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_PurchaseOrderReceipt_RetrieveChunkSearch_V2";
        public usp_PurchaseOrderReceipt_RetrieveChunkSearch_V2()
        {
        }
       ...
       b_PurchaseOrder obj
       )
        {
            ...
            command.SetStringInputParameter(SqlDbType.NVarChar, "orderbyColumn", obj.orderbyColumn, 100); //V2-331
            ...
            command.SetStringInputParameter(SqlDbType.NVarChar, "CreatedDate", obj.strCreatedDate, 500);
            command.SetStringInputParameter(SqlDbType.NVarChar, "SearchText", obj.SearchText, 800);//V2-331
