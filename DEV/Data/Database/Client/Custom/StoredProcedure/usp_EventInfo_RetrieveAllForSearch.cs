...
{
   public class usp_EventInfo_RetrieveAllForSearch
    {
        private static string STOREDPROCEDURE_NAME = "usp_EventInfo_RetrieveAllForSearch";

        public usp_EventInfo_RetrieveAllForSearch()
        {
        }
       ...
       )
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    b_EventInfo tmpWorkOrders = b_EventInfo.ProcessRowForEventInfoRetriveAllForSearch(reader);
