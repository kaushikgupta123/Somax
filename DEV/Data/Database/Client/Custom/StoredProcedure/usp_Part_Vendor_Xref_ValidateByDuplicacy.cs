    ...
    Database.StoredProcedure
{
    ...
    /// </summary>
    public class usp_Part_Vendor_Xref_ValidateByDuplicacy
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_Part_Vendor_Xref_ValidateByDuplicacy";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_Part_Vendor_Xref_ValidateByDuplicacy()
        {
        }
        ...
        )
        {
           ...
           // command.SetStringInputParameter(SqlDbType.NVarChar, "Part_ClientLookupId", obj.Part_ClientLookupId, 31);
