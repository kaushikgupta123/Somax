...
{
    public class usp_PurchaseOrderLineItem_RetrieveByPurchaseOrderLineItemId_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_PurchaseOrderLineItem_RetrieveByPurchaseOrderLineItemId_V2";

        public usp_PurchaseOrderLineItem_RetrieveByPurchaseOrderLineItemId_V2()
        {
        }
