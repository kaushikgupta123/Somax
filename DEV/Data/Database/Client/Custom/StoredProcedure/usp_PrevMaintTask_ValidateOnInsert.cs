...
{
    public class usp_PrevMaintTask_ValidateOnInsert
    {
        private static string STOREDPROCEDURE_NAME = "usp_PrevMaintTask_ValidateOnInsert";

        public usp_PrevMaintTask_ValidateOnInsert()
        {
        }
