...
namespace Database.StoredProcedure
{
    ...
    /// </summary>
    public class usp_Account_RetrieveBySearchCriteria
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_Account_RetrieveBySearchCriteria";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_Account_RetrieveBySearchCriteria()
        {
        }
        ...
        )
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    record = (b_Account)b_Account.ProcessRow(reader);
