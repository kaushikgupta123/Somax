...
{
    public class usp_Part_SearchForCart_VendorCatalog_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_Part_SearchForCart_VendorCatalog_V2";

        public usp_Part_SearchForCart_VendorCatalog_V2()
        {
        }
