...
{
    public class usp_PartHistory_PartIssueStockOutForMultiStoreroom_V2
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_PartHistory_PartIssueStockOutForMultiStoreroom_V2";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_PartHistory_PartIssueStockOutForMultiStoreroom_V2()
        {
        }

        /// <summary>
        /// Static method to call the usp_PartHistory_PartIssueStockOutForMultiStoreroom_V2 stored procedure using SqlClient.
        /// </summary>
      ...
      )
        {
            ...
            command.SetOutputParameter(SqlDbType.Bit, "StockOut");
            // Execute stored procedure.
            command.ExecuteNonQuery();

            obj.PartHistoryId = command.Parameters["@PartHistoryId"].Value == null ? 0 : (long)command.Parameters["@PartHistoryId"].Value;
            obj.IspartIssueStockOut = command.Parameters["@StockOut"].Value == null ? false : (bool)command.Parameters["@StockOut"].Value;
