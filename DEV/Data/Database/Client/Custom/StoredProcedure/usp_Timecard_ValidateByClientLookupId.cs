...
{
    /// <summary>
    /// Access the usp_Timecard_ValidateByClientLookupId stored procedure.
    /// </summary>
    public class usp_Timecard_ValidateByClientLookupId
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_Timecard_ValidateByClientLookupId";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_Timecard_ValidateByClientLookupId()
        {
        }

        /// <summary>
        /// Static method to call the usp_Timecard_ValidateByClientLookupId stored procedure using SqlClient.
        /// </summary>
        ...
        )
        {
            ...
            command.SetStringInputParameter(SqlDbType.NVarChar, "ChargeType_Primary", obj.@ChargeType_Primary, 31);
            command.SetStringInputParameter(SqlDbType.NVarChar, "ChargeToClientLookupId_Primary", obj.ChargeToPrimeClientLookupId, 31);
            ...
            command.SetStringInputParameter(SqlDbType.NVarChar, "AccountClientLookupId", obj.AccountClientLookupId, 31);
