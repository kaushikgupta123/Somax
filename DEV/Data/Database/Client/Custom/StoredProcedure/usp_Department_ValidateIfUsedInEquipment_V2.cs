...
{
    public class usp_Department_ValidateIfUsedInEquipment_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_Department_ValidateIfUsedInEquipment_V2";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_Department_ValidateIfUsedInEquipment_V2()
        {
        }
