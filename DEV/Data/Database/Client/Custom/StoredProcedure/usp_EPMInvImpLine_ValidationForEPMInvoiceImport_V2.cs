...
{
    public class usp_EPMInvImpLine_ValidationForEPMInvoiceImport_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_EPMInvImpLine_ValidationForEPMInvoiceImport_V2";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_EPMInvImpLine_ValidationForEPMInvoiceImport_V2()
        {
        }
