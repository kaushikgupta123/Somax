...
{
    public class usp_Personnel_RetrieveForLookupList
    {
        private static string STOREDPROCEDURE_NAME = "usp_Personnel_RetrieveForLookupList";

        public usp_Personnel_RetrieveForLookupList()
        {
        }
