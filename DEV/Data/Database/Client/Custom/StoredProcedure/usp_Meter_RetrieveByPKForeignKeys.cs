...
{
    public class usp_Meter_RetrieveByPKForeignKeys
    {
        private static string STOREDPROCEDURE_NAME = "usp_Meter_RetrieveByPKForeignKeys";

        public usp_Meter_RetrieveByPKForeignKeys()
        {
