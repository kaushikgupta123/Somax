...
{
    public class usp_SanMasterBatchEntry_ForSanitationMasterFromSanitationJob_V2
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_SanMasterBatchEntry_ForSanitationMasterFromSanitationJob_V2";
        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_SanMasterBatchEntry_ForSanitationMasterFromSanitationJob_V2()
        {
        ...
        /// <param name="PrintSanitationJobs"></param>
        /// <param name="PrintAttachments"></param>
        /// <returns></returns>
        /// 
        public static List<b_SanMasterBatchEntry> CallStoredProcedure(
           SqlCommand command,
        ...
        {
            List<b_SanMasterBatchEntry> records = new List<b_SanMasterBatchEntry>();
            ...
            command.SetInputParameter(SqlDbType.Bit, "PrintSanitationJobs", PrintSanitationJobs);
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    record = b_SanMasterBatchEntry.ProcessRowAfterBatchEntry(reader);
