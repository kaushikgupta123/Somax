 ...
 * =========== ======== =================== ===================================
 * 2012-Mar-19          Roger Lawton        Added Lookuplist validation
 ******************************************************************************
 */
...
namespace Database.StoredProcedure
{
  ...
  /// </summary>
  public class usp_Personnel_UpdateExtended
  {
    /// <summary>
    /// Constants.
    /// </summary>
    private static string STOREDPROCEDURE_NAME = "usp_Personnel_UpdateExtended";

    /// <summary>
    /// Default constructor.
    /// </summary>
    public usp_Personnel_UpdateExtended()
    {
    }
    ...
    )
    {
      ...
      //command.SetStringInputParameter(SqlDbType.NVarChar, "NameFull", obj.NameFull, 127);
