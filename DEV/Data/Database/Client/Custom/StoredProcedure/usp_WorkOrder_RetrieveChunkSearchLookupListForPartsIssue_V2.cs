...
{
    public class usp_WorkOrder_RetrieveChunkSearchLookupListForPartsIssue_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_WorkOrder_RetrieveChunkSearchLookupListForPartsIssue_V2";

        public usp_WorkOrder_RetrieveChunkSearchLookupListForPartsIssue_V2()
        {
        }
      ...
      b_WorkOrder obj
  )
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    b_WorkOrder = b_WorkOrder.ProcessRowForChunkSearchLookupListForIssuePart(reader);
