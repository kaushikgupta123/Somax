...
{
    public class usp_POPrint_RetrieveEPMByPurchaseOrder_V2
    {        /// <summary>
             /// Constants.
             /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_POPrint_RetrieveEPMByPurchaseOrder_V2";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_POPrint_RetrieveEPMByPurchaseOrder_V2()
        {
        }
        ...
        )
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    b_PurchaseOrder tmpPurchaseOrders = b_PurchaseOrder.ProcessRowForPurchaseOrderEPMPrint(reader);
                ...
                while (reader.Read())
                {
                    b_PurchaseOrderLineItem tmpPOLineItem = b_PurchaseOrderLineItem.ProcessRowForPurchaseOrderLineItemEPMPrint(reader);
