...
{
    /// <summary>
    /// Access the usp_PreventiveMaintenance_RetrieveInitialSearchConfigurationData stored procedure.
    /// </summary>
    public class usp_PreventiveMaintenance_RetrieveInitialSearchConfigurationData
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_PreventiveMaintenance_RetrieveInitialSearchConfigurationData";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_PreventiveMaintenance_RetrieveInitialSearchConfigurationData()
        {
        }
            ...
            )
        {
            ...
            try
            {
                string[] categories = new string[] { SearchCategoryConstants.P_QUERY, SearchCategoryConstants.P_SITE, SearchCategoryConstants.P_AREA, 
                    SearchCategoryConstants.P_DEPARTMENT, SearchCategoryConstants.P_CHARGETYPE, SearchCategoryConstants.P_SCHEDULETYPE, 
                    SearchCategoryConstants.P_CREW, SearchCategoryConstants.P_PRIORITY, SearchCategoryConstants.P_STATUS, SearchCategoryConstants.P_SHIFT };
