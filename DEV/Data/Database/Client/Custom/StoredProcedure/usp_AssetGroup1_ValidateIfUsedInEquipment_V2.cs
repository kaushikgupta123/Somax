...
{
    public class usp_AssetGroup1_ValidateIfUsedInEquipment_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_AssetGroup1_ValidateIfUsedInEquipment_V2";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_AssetGroup1_ValidateIfUsedInEquipment_V2()
        {
        }
        ...
        )
        {
            ...
            command.SetInputParameter(SqlDbType.BigInt, "AssetGroup1Id ", obj.AssetGroup1);
