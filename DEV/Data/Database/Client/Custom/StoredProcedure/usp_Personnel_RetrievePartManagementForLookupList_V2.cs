...
{
    public class usp_Personnel_RetrievePartManagementForLookupList_V2
  {
        private static string STOREDPROCEDURE_NAME = "usp_Personnel_RetrievePartManagementForLookupList_V2";

        public usp_Personnel_RetrievePartManagementForLookupList_V2()
        {
        }
