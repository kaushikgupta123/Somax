...
{
    public class usp_Part_ValidateByInactivateorActivate
    {
        private static string STOREDPROCEDURE_NAME = "usp_Part_ValidateByInactivateorActivate";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_Part_ValidateByInactivateorActivate()
        {
        }
