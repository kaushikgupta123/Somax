...
{
    public class usp_Part_SearchForCart_VendorCatalogWO_MultiStoreroom_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_Part_SearchForCart_VendorCatalogWO_MultiStoreroom_V2";

        public usp_Part_SearchForCart_VendorCatalogWO_MultiStoreroom_V2()
        {
        }
       ...
       b_Part obj
       )
        {
            ...
            command.SetInputParameter(SqlDbType.Bit, "CheckFlag", obj.CheckFlag);
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    records.Add(b_Part.ProcessRowSearchForCart_VendorCatalogWOMultiStoreroom(reader));
                }
            }
            finally
            {
