...
{
    public class usp_PurchaseRequest_RetrieveForExportSAP_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_PurchaseRequest_RetrieveForExportSAP_V2";

        public usp_PurchaseRequest_RetrieveForExportSAP_V2()
        {

        }
        public static ArrayList CallStoredProcedure(
           SqlCommand command,
           ProcessRow<b_PurchaseRequest> processRow,
