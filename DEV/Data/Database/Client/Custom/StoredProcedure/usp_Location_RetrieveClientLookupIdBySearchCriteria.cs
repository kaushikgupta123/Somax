...
{
    /// <summary>
    /// Access the usp_Location_RetrieveClientLookupIdBySearchCriteria stored procedure.
    /// </summary>
    public class usp_Location_RetrieveClientLookupIdBySearchCriteria
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_Location_RetrieveClientLookupIdBySearchCriteria";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_Location_RetrieveClientLookupIdBySearchCriteria()
        {
        }
        ...
        )
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    records.Add(b_Location.ProcessRowForClientIdLookup(reader));
                }
