...
namespace Database.StoredProcedure
{
    ...
    /// </summary>
    public class usp_PartMaster_NumberLookup
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_PartMaster_NumberLookup";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_PartMaster_NumberLookup()
        {
        }
        ...
        )
        {
            ...
            //command.SetStringInputParameter(SqlDbType.NVarChar, "RequestType", obj.orderColumn,15);
            ...
            command.SetStringInputParameter(SqlDbType.NVarChar, "OrderColumn", obj.orderColumn, 256);
            command.SetStringInputParameter(SqlDbType.NVarChar, "OrderDirection", obj.orderDirection, 256);
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    record = (b_PartMaster)b_PartMaster.ProcessRowForLookUp2(reader);
