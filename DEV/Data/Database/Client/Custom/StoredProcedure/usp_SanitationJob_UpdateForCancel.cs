...
{
    public class usp_SanitationJob_UpdateForCancel
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_SanitationJob_UpdateForCancel";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_SanitationJob_UpdateForCancel()
        {
        ...
        )
        {
            ...
            command.SetStringInputParameter(SqlDbType.NVarChar, "CompleteComments", obj.CompleteComments, 1000);
