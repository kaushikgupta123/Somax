...
{
    public class usp_SanitationJob_UpdateForInterface
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_SanitationJob_UpdateForInterface";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_SanitationJob_UpdateForInterface()
        {
