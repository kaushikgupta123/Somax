...
namespace Database.StoredProcedure
{
    ...
    /// </summary>
    public class usp_Vendor_RetrieveClientLookupIdBySearchCriteria
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_Vendor_RetrieveClientLookupIdBySearchCriteria";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_Vendor_RetrieveClientLookupIdBySearchCriteria()
        {
        }
        ...
        )
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    b_Vendor tmpVandor = b_Vendor.ProcessRowForClientIdLookup(reader);
                    tmpVandor.ClientId = obj.ClientId;
                    records.Add(tmpVandor);
                }
