...
{
    public class usp_Part_RetrieveChunkSearchLookupListForMultiStoreroomMobile_V2
    { /// <summary>
      /// Constants.
      /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_Part_RetrieveChunkSearchLookupListForMultiStoreroomMobile_V2";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_Part_RetrieveChunkSearchLookupListForMultiStoreroomMobile_V2()
        {
        }
