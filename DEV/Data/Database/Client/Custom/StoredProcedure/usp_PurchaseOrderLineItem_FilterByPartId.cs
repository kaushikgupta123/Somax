...
{
    public class usp_PurchaseOrderLineItem_FilterByPartId
    {
        private static string STOREDPROCEDURE_NAME = "usp_PurchaseOrderLineItem_FilterByPartId";

        public usp_PurchaseOrderLineItem_FilterByPartId()
        {
        }
        ...
        )
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                  ...
                  record.LoadFromDatabaseFilterByPartId(reader);
                  records.Add(record);
                }
            }
            catch (Exception ex)
