...
{
   public class usp_WorkOrder_RetrieveAllForSearch
    {
        private static string STOREDPROCEDURE_NAME = "usp_WorkOrder_RetrieveAllForSearch";

        public usp_WorkOrder_RetrieveAllForSearch()
        {
        }
       ...
       )
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    b_WorkOrder tmpWorkOrders = b_WorkOrder.ProcessRowForWorkOrderRetriveAllForSearch(reader);
