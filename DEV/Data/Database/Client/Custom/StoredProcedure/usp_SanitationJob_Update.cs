...
{
    public class usp_SanitationJob_Update
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_SanitationJob_Update";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_SanitationJob_Update()
        {
        }
        ...
        )
        {
            ...
            command.SetStringInputParameter(SqlDbType.NVarChar, "ChargeToClientLookupId", obj.ChargeTo_ClientLookupId, 256);
            ...
            command.SetStringInputParameter(SqlDbType.NVarChar, "CheckStatus", obj.CheckStatus, 31);
