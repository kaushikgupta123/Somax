...
{
    public class usp_Part_ValidateClientLookupIdForPI
    {
        private static string STOREDPROCEDURE_NAME = "usp_Part_ValidateClientLookupIdForPI";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_Part_ValidateClientLookupIdForPI()
        {
        }
