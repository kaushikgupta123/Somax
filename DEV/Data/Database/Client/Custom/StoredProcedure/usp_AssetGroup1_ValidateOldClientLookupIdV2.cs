...
{
    public class usp_AssetGroup1_ValidateOldClientLookupIdV2
    {
        private static string STOREDPROCEDURE_NAME = "usp_AssetGroup1_ValidateOldClientLookupIdV2";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_AssetGroup1_ValidateOldClientLookupIdV2()
        {
        }
