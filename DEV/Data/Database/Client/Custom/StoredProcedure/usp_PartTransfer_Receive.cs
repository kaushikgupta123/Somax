...
namespace Database.StoredProcedure
{
    ...
    /// </summary>
    public class usp_PartTransfer_Receive
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_PartTransfer_Receive";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_PartTransfer_Receive()
        {
        }
        ...
        )
        {
            ...
            command.SetInputParameter(SqlDbType.Decimal, "TxnQuantity", obj.TxnQuantity);
            ...
            command.SetInputParameter(SqlDbType.BigInt, "LoggedUser_PersonnelId", obj.LoggedUser_PersonnelId);
            command.SetStringInputParameter(SqlDbType.NVarChar, "TransactionType", obj.TransactionType, 61);
            ...
            obj.PartTransferEventLogId = (long)PartTransferEventLogIdOut_parameter.Value;
