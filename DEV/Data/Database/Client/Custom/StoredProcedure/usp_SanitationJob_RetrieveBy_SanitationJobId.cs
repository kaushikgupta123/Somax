...
{
    public class usp_SanitationJob_RetrieveBy_SanitationJobId
    {
        private static string STOREDPROCEDURE_NAME = "usp_SanitationJob_RetrieveBy_SanitationJobId";
        public usp_SanitationJob_RetrieveBy_SanitationJobId()
        {
        }
