...
{  /// <summary>
   /// Access the usp_WorkOrderSchedule_RemoveScheduleRecordFromResourceList_V2 stored procedure.
   /// </summary>
    public class usp_WorkOrderSchedule_RemoveScheduleRecordFromResourceList_V2
    {  /// <summary>
       /// Constants.
       /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_WorkOrderSchedule_RemoveScheduleRecordFromResourceList_V2";
        ...
        public usp_WorkOrderSchedule_RemoveScheduleRecordFromResourceList_V2()
        {
        }
