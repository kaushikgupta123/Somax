...
{
    public class usp_Workorder_RetrieveApprovalWorkbenchforSearch_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_Workorder_RetrieveApprovalWorkbenchforSearch_V2";

        public usp_Workorder_RetrieveApprovalWorkbenchforSearch_V2()
        {
        }
       ...
       )
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    b_WorkOrder tmpWorkOrders = b_WorkOrder.ProcessRowForWorkbenchRetriveAllForSearch(reader);
