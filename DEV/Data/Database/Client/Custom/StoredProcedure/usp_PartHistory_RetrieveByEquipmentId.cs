...
namespace Database.StoredProcedure
{
    ...
    /// </summary>
    public class usp_PartHistory_RetrieveByEquipmentId
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_PartHistory_RetrieveEquipmentIssues";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_PartHistory_RetrieveByEquipmentId()
        {
        }
        ...
        )
        {
            ...
            command.SetInputParameter(SqlDbType.BigInt, "EquipmentId", obj.ChargeToId_Primary);
            ...
            try
            {
                ...
                while (reader.Read())
                {
                   ...
                   // records.Add((b_PartHistory)b_PartHistory.ProcessRow(reader));
                    records.Add((b_PartHistory)b_PartHistory.ProcessRowPartIssueNew(reader));
                }
