...
{
    public class usp_PrevMaintMaster_CreateFromPMLibrary
    {
        private static string STOREDPROCEDURE_NAME = "usp_PrevMaintMaster_CreateFromPMLibrary";
        public usp_PrevMaintMaster_CreateFromPMLibrary()
        {
        }
       ...
       )
        {
            ...
            command.SetInputParameter(SqlDbType.BigInt, "PrevMaintLibraryId", obj.PrevMaintLibraryId);
            command.SetOutputParameter(SqlDbType.BigInt, "PrevMaintMasterId");
