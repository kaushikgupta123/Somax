...
{
    public class usp_Line_ValidateNewClientLookupId
    {
        private static string STOREDPROCEDURE_NAME = "usp_Line_ValidateNewClientLookupId";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_Line_ValidateNewClientLookupId()
        {
        }
