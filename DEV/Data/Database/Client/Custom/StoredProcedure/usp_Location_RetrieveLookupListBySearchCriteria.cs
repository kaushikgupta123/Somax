...
{
    /// <summary>
    /// Access the usp_Location_RetrieveLookupListBySearchCriteria stored procedure.
    /// </summary>
    public class usp_Location_RetrieveLookupListBySearchCriteria
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_Location_RetrieveLookupListBySearchCriteria";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_Location_RetrieveLookupListBySearchCriteria()
        {
        }
        ...
        )
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    record = (b_Location)b_Location.ProcessRow(reader);
