...
{
    public class usp_WorkOrder_RetrieveChunkForSearch_V2
    {
        /// <summary>
        /// Constants.
        /// </summary>
        /// usp_WorkOrder_RetrieveChunkForSearch_V2_Source
        private static string STOREDPROCEDURE_NAME = "usp_WorkOrder_RetrieveChunkForSearch_V2";
        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_WorkOrder_RetrieveChunkForSearch_V2()
        {
        }

        /// <summary>
        /// Static method to call the usp_WorkOrder_RetrieveChunkForSearch_V2 stored procedure using SqlClient.
        /// </summary>
        ...
        )
        {
            ...
            //V2-347
            command.SetStringInputParameter(SqlDbType.NVarChar, "CompleteStartDateVw", obj.StartActualFinishDateVw, 500);
            command.SetStringInputParameter(SqlDbType.NVarChar, "CompleteEndDateVw", obj.EndActualFinishDateVw, 500);
            ...
            command.SetStringInputParameter(SqlDbType.NVarChar, "StartScheduledDate", obj.StartScheduledDate, 500);
            command.SetStringInputParameter(SqlDbType.NVarChar, "EndScheduledDate", obj.EndScheduledDate, 500);
            command.SetStringInputParameter(SqlDbType.NVarChar, "StartActualFinishDate", obj.StartActualFinishDate, 500);
            command.SetStringInputParameter(SqlDbType.NVarChar, "EndActualFinishDate", obj.EndActualFinishDate, 500);
            //v2-364
            ...
            command.SetStringInputParameter(SqlDbType.NVarChar, "SourceType", obj.SourceType, 500);//<!--Added on 23/06/2020-->
            command.SetStringInputParameter(SqlDbType.NVarChar, "AssetGroup1Id", obj.AssetGroup1AdvSearchId, 500);
            command.SetStringInputParameter(SqlDbType.NVarChar, "AssetGroup2Id", obj.AssetGroup2AdvSearchId, 500);
            command.SetStringInputParameter(SqlDbType.NVarChar, "AssetGroup3Id", obj.AssetGroup3AdvSearchId, 500);
            command.SetInputParameter(SqlDbType.Bit, "DownRequired", obj.downRequired);
            //V2-984
            command.SetStringInputParameter(SqlDbType.NVarChar, "assignedWO", obj.Assigned, 500);
            command.SetStringInputParameter(SqlDbType.NVarChar, "requiredDate", obj.RequireDate, 500);
            command.SetStringInputParameter(SqlDbType.NVarChar, "planner", obj.PlannerFullName, 500); //V2-1078
            command.SetStringInputParameter(SqlDbType.NVarChar, "ProjectIds", obj.ProjectIds, 500); //V2-1135
            try
            {
