...
{
    public class usp_Vendor_ValidateByClientLookupId_SiteId
    {
        private static string STOREDPROCEDURE_NAME = "usp_Vendor_ValidateByClientLookupId_SiteId";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_Vendor_ValidateByClientLookupId_SiteId()
        {
        }
