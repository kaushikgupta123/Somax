...
{
    public class usp_FleetMeterReading_RetrieveChunkSearch_V2
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_FleetMeterReading_RetrieveChunkSearch_V2";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_FleetMeterReading_RetrieveChunkSearch_V2()
        {
        }

        /// <summary>
        /// Static method to call the usp_FleetMeterReading_RetrieveChunkSearch_V2 stored procedure using SqlClient.
        /// </summary>
        ...
        )
        {
            ...
            command.SetStringInputParameter(SqlDbType.VarChar, "ReadingDateStart", obj.ReadingDateStart, 50);
            command.SetStringInputParameter(SqlDbType.VarChar, "ReadingDateEnd", obj.ReadingDateEnd, 50);
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    b_Equipment tmpEquipment = b_Equipment.ProcessRetrieveForFleetMeterReadingChunkV2(reader);
