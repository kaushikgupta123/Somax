...
{
    public class usp_Part_ValidateClientLookupId
    {
        private static string STOREDPROCEDURE_NAME = "usp_Part_ValidateClientLookupId";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_Part_ValidateClientLookupId()
        {
        }
