...
namespace Database.StoredProcedure
{
    ...
    /// </summary>
    public class usp_Equipment_ValidateClientLookupId
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_Equipment_ValidateClientLookupId";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_Equipment_ValidateClientLookupId()
        {
        }
        ...
        )
        {
            ...
            command.SetStringInputParameter(SqlDbType.NVarChar, "AssetCategory", obj.AssetCategory, 15);      // V2-356
