...
{
    public class usp_Part_SearchForCart_VendorCatalogForMultiStoreroom_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_Part_SearchForCart_VendorCatalogForMultiStoreroom_V2";

        public usp_Part_SearchForCart_VendorCatalogForMultiStoreroom_V2()
        {
        }
   ...
   )
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    records.Add(b_Part.ProcessRowSearchForCart_VendorCatalog(reader));
                }
            }
            finally
            {
