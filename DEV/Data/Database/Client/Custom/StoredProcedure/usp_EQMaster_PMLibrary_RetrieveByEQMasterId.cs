...
{
    /// <summary>
    /// Access the usp_Part_Vendor_Xref_RetrieveByVendorId stored procedure.
    /// </summary>
    public class usp_EQMaster_PMLibrary_RetrieveByEQMasterId
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_EQMaster_PMLibrary_RetrieveByEQMasterId";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_EQMaster_PMLibrary_RetrieveByEQMasterId()
        {
        }
        ...
        public static List<b_EQMaster_PMLibrary> CallStoredProcedure(
            SqlCommand command,
        ...
        {
          List<b_EQMaster_PMLibrary> records = new List<b_EQMaster_PMLibrary>();
            ...
            try
            {
                ...
                while (reader.Read())
                {
                  ...
                  records.Add((b_EQMaster_PMLibrary)b_EQMaster_PMLibrary.ProcessRowExtended(reader));
                }
