...
{
    public class usp_PurchaseRequestLineItem_RetrieveForLookupListByPartId_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_PurchaseRequestLineItem_RetrieveForLookupListByPartId_V2";

        public usp_PurchaseRequestLineItem_RetrieveForLookupListByPartId_V2()
        {
        }
       ...
       )
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    record.LoadFromDatabaseLookupListByPartid(reader);
