...
{
    public class usp_SanitationJobSchedule_DeleteByPKForSanitationJob
    {

        private static string STOREDPROCEDURE_NAME = "usp_SanitationJobSchedule_DeleteByPKForSanitationJob";


        public usp_SanitationJobSchedule_DeleteByPKForSanitationJob()
        {
        }
