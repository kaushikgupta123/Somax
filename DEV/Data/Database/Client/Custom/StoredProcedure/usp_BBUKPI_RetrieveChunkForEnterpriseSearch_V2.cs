...
{
    public class usp_BBUKPI_RetrieveChunkForEnterpriseSearch_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_BBUKPI_RetrieveChunkForEnterpriseSearch_V2";
        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_BBUKPI_RetrieveChunkForEnterpriseSearch_V2()
        {
        }

        /// <summary>
        /// Static method to call the usp_BBUKPI_RetrieveChunkForSearch_V2 stored procedure using SqlClient.
        /// </summary>
        ...
        )
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    b_BBUKPI tmpBBUKPIs = b_BBUKPI.ProcessRetrieveChunkEnterpriseSearch(reader);
