...
{
    public class usp_WorkOrderPlan_RetrieveForChunkSearchResourceList_V2
    { /// <summary>
      /// Constants.
      /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_WorkOrderPlan_RetrieveForChunkSearchResourceList_V2";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_WorkOrderPlan_RetrieveForChunkSearchResourceList_V2()
        {
        }

        /// <summary>
        /// Static method to call the usp_WorkOrderPlan_RetrieveForChunkSearchResourceList_V2 stored procedure using SqlClient.
        /// </summary>
     ...
     )
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    b_WorkOrderPlan = b_WorkOrderPlan.ProcessRowForResourceListChunkSearch(reader);
