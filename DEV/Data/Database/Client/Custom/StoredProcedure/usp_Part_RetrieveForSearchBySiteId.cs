...
{
   public class usp_Part_RetrieveForSearchBySiteId
    {

       private static string STOREDPROCEDURE_NAME = "usp_Part_RetrieveForSearchBySiteId";

       public usp_Part_RetrieveForSearchBySiteId()
        {
        }
      ...
      try
      {
               ...
               while (reader.Read())
               {
                   ...
                   b_Part tmpParts = b_Part.ProcessRowForPartSearch(reader);
