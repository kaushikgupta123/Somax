...
{
    /// <summary>
  /// Access the usp_WorkOrderSchedule_RemoveRecord stored procedure.
    /// </summary>
  public class usp_WorkOrderSchedule_RemoveRecord
    {
        /// <summary>
        /// Constants.
        /// </summary>
      private static string STOREDPROCEDURE_NAME = "usp_WorkOrderSchedule_RemoveRecord";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_WorkOrderSchedule_RemoveRecord()
        {
        }
