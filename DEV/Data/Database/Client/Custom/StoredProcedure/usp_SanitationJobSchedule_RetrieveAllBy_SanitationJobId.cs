...
{
    public class usp_SanitationJobSchedule_RetrieveAllBy_SanitationJobId
    {
        private static string STOREDPROCEDURE_NAME = "usp_SanitationJobSchedule_RetrieveAllBy_SanitationJobId";

      
        public usp_SanitationJobSchedule_RetrieveAllBy_SanitationJobId()
        {
        }
