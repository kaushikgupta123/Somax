...
namespace Database.StoredProcedure
{
    ...
    /// </summary>
    public class usp_PartHistory_ValidateProcess
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_PartHistory_ValidateProcess";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_PartHistory_ValidateProcess()
        {
        }
        ...
        )
        {
            ...
            command.SetStringInputParameter(SqlDbType.NVarChar, "IssueToClientLookupId", obj.IssueToClientLookupId, 63);
