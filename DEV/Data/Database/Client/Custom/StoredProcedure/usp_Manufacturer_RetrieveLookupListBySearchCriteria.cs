...
{
    /// <summary>
    /// Access the usp_Account_RetrieveLookupListBySearchCriteria stored procedure.
    /// </summary>
    public class usp_ManufacturerMaster_RetrieveLookupListBySearchCriteria
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_ManufacturerMaster_RetrieveLookupListBySearchCriteria";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_ManufacturerMaster_RetrieveLookupListBySearchCriteria()
        {
        }
        ...
        public static List<b_ManufacturerMaster> CallStoredProcedure(
            SqlCommand command,
        ...
        {
            List<b_ManufacturerMaster> records = new List<b_ManufacturerMaster>();
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    record = (b_ManufacturerMaster)b_ManufacturerMaster.ProcessRow(reader);
