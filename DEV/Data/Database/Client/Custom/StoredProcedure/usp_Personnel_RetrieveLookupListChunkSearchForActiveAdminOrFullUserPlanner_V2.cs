...
{
    public class usp_Personnel_RetrieveLookupListChunkSearchForActiveAdminOrFullUserPlanner_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_Personnel_RetrieveLookupListChunkSearchForActiveAdminOrFullUserPlanner_V2";

        public usp_Personnel_RetrieveLookupListChunkSearchForActiveAdminOrFullUserPlanner_V2()
        {
        }
       ...
       )
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    b_Personnel tmpPersonnel = b_Personnel.ProcessRowForRetriveLookupListActiveAdminOrFullUserPlanner(reader);
