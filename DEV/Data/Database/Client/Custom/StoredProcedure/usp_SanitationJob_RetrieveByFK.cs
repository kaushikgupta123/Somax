...
{
    public class usp_SanitationJob_RetrieveByFK
    {
         private static string STOREDPROCEDURE_NAME = "usp_SanitationJob_RetrieveByFK";
         public usp_SanitationJob_RetrieveByFK()
        {
        }
