...
{
    public class usp_ProcessSystem_Validate
    {
        private static string STOREDPROCEDURE_NAME = "usp_ProcessSystem_Validate";

        public usp_ProcessSystem_Validate()
        {
        }
        ...
        )
        {
            ...
            command.SetStringInputParameter(SqlDbType.NVarChar, "Process", obj.Process, 256);
            command.SetStringInputParameter(SqlDbType.NVarChar, "System", obj.System, 256);
            ...
            command.SetInputParameter(SqlDbType.BigInt, "ProcessSystemId", obj.ProcessSystemId);
