...
{
    class usp_ScheduledService_ValidateByInactivateOrActivate_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_ScheduledService_ValidateByInactivateOrActivate_V2";

        public usp_ScheduledService_ValidateByInactivateOrActivate_V2()
        {
