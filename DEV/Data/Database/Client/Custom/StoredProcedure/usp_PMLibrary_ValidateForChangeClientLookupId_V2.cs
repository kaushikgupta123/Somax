...
{
    public class usp_PMLibrary_ValidateForChangeClientLookupId_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_PMLibrary_ValidateForChangeClientLookupId_V2 ";
        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_PMLibrary_ValidateForChangeClientLookupId_V2()
        {
        }
        ...
        )
        {
            ...
            command.SetInputParameter(SqlDbType.BigInt, "PMLibraryId", obj.PrevMaintLibraryId);
