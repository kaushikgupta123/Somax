...
{
    public class usp_PurchaseOrderLineItem_RetrieveByPurchaseOrderLineItemId
    {
        private static string STOREDPROCEDURE_NAME = "usp_PurchaseOrderLineItem_RetrieveByPurchaseOrderLineItemId";

        public usp_PurchaseOrderLineItem_RetrieveByPurchaseOrderLineItemId()
        {
        }
