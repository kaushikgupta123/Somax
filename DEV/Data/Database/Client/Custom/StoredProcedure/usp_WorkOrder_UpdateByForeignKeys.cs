...
namespace Database.StoredProcedure
{
    ...
    /// </summary>
    public class usp_WorkOrder_UpdateByForeignKeys
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_WorkOrder_UpdateByForeignKeys_V2";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_WorkOrder_UpdateByForeignKeys()
        {
        }
        ...
        )
        {
            ...
            command.SetStringInputParameter(SqlDbType.NVarChar, "CompleteComments", obj.CompleteComments,-1);   // SOM-1081
            ...
            command.SetStringInputParameter(SqlDbType.NVarChar, "Description", obj.Description, -1);            // SOM-1081
            ...
            command.SetStringInputParameter(SqlDbType.NVarChar, "DeniedReason", obj.DeniedReason, 15);
            command.SetInputParameter(SqlDbType.DateTime2, "DeniedDate", obj.DeniedDate);
            ...
            command.SetStringInputParameter(SqlDbType.NVarChar, "Requestor_PersonnelClientLookupId", obj.Requestor_PersonnelClientLookupId, 63);
            ...
            command.SetStringInputParameter(SqlDbType.NVarChar, "Planner_PersonnelClientLookupId", obj.Planner_PersonnelClientLookupId, 63);
            command.SetStringInputParameter(SqlDbType.NVarChar, "Scheduler_PersonnelClientLookupId", obj.Scheduler_PersonnelClientLookupId,63);
            ...
            command.SetStringInputParameter(SqlDbType.NVarChar, "CloseBy_PersonnelClientLookupId", obj.CloseBy_PersonnelClientLookupId, 63);
            command.SetStringInputParameter(SqlDbType.NVarChar, "ReleaseBy_PersonnelClientLookupId", obj.ReleaseBy_PersonnelClientLookupId, 63);
            // RKL - Cannot use setoutputparameter as we need to set the size
            //command.SetOutputParameter(SqlDbType.NVarChar, "ChargeTo_Name");
