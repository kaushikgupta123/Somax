...
{
    public class usp_Account_ValidateByInactivateorActivate_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_Account_ValidateByInactivateorActivate_V2";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_Account_ValidateByInactivateorActivate_V2()
        {
        }
