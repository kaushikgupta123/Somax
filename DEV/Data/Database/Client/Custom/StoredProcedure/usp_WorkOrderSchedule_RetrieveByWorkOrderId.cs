...
namespace Database.StoredProcedure
{
    ...
    /// </summary>
    public class usp_WorkOrderSchedule_RetrieveByWorkOrderId
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_WorkOrderSchedule_RetrieveByWorkOrderId";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_WorkOrderSchedule_RetrieveByWorkOrderId()
        {
        }
        ...
        )
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    records.Add((b_WorkOrderSchedule)b_WorkOrderSchedule.ProcessRowForScheduleCrossReference(reader));
                }
