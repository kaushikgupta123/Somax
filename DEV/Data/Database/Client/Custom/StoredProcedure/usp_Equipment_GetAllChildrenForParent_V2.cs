...
{
    public class usp_Equipment_GetAllChildrenForParent_V2
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_Equipment_GetAllChildrenForParent_V2";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_Equipment_GetAllChildrenForParent_V2()
        {
        }
       ...
       )
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    record = (b_Equipment)b_Equipment.ProcessRowForusp_Equipment_GetAllChildrenForParentV2(reader);
