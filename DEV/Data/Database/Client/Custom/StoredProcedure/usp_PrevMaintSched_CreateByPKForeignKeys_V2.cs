...
{
    public class usp_PrevMaintSched_CreateByPKForeignKeys_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_PrevMaintSched_CreateByPKForeignKeys_V2";

        public usp_PrevMaintSched_CreateByPKForeignKeys_V2()
        {
        ...
        )
        {
            ...
            command.SetOutputParameter(SqlDbType.BigInt, "PrevMaintSchedId");
            ...
            obj.PrevMaintSchedId = (long)command.Parameters["@PrevMaintSchedId"].Value;
