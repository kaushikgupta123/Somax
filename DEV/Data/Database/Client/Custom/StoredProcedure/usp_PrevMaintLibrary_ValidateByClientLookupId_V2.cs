...
{
    public class usp_PrevMaintLibrary_ValidateByClientLookupId_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_PrevMaintLibrary_ValidateByClientLookupId_V2";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_PrevMaintLibrary_ValidateByClientLookupId_V2()
        {
        }
