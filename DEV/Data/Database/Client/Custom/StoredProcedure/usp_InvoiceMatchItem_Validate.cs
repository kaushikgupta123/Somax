...
{
    public class usp_InvoiceMatchItem_Validate
    {
        private static string STOREDPROCEDURE_NAME = "usp_InvoiceMatchItem_Validate";

        public usp_InvoiceMatchItem_Validate()
        {
        }
