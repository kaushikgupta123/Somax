...
{
    public class usp_MaintOnDemandMaster_ValidateId
    {
        private static string STOREDPROCEDURE_NAME = "usp_MaintOnDemandMaster_ValidateId";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_MaintOnDemandMaster_ValidateId()
        {
        }
        ...
        )
        {
            ...
            command.SetInputParameter(SqlDbType.BigInt, "Creator_PersonneIId", obj.Creator_PersonneIId);
