...
{
    public class usp_PurchaseRequestLineItem_RetrieveByPurchaseRequestId
    {
        private static string STOREDPROCEDURE_NAME = "usp_PurchaseRequestLineItem_RetrieveByPurchaseRequestId";

        public usp_PurchaseRequestLineItem_RetrieveByPurchaseRequestId()
        {
        }
