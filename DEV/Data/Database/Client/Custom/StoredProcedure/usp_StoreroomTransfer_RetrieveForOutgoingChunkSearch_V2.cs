...
{
    public class usp_StoreroomTransfer_RetrieveForOutgoingChunkSearch_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_StoreroomTransfer_RetrieveForOutgoingChunkSearch_V2";

        public usp_StoreroomTransfer_RetrieveForOutgoingChunkSearch_V2()
        {
        }
       ...
       )
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    b_StoreroomTransfer tmpStoreroomTransfer = b_StoreroomTransfer.ProcessRowForStoreroomTransferRetriveForOutgoingTransferChunkSearch(reader);
