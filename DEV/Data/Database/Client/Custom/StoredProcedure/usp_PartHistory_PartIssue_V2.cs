...
{
    class usp_PartHistory_PartIssue_V2
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_PartHistory_PartIssue_V2";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_PartHistory_PartIssue_V2()
        {
        }
        ...
        )
        {
            ...
            command.SetStringInputParameter(SqlDbType.VarChar, "VMRSFailure", obj.VMRSFailure, 30);
