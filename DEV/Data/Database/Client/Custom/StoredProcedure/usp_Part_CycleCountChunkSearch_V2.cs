...
{
    public class usp_Part_CycleCountChunkSearch_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_Part_CycleCountChunkSearch_V2";
        public usp_Part_CycleCountChunkSearch_V2()
        {
        }
    ...
    b_Part obj
)
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    b_Part tmpPart = b_Part.ProcessRetrieveForCycleCountChunkSearch(reader);
