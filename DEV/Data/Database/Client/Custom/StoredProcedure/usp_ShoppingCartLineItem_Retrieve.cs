...
namespace Database.StoredProcedure
{
    ...
    public class usp_ShoppingCartLineItem_Retrieve
    {
        private static string STOREDPROCEDURE_NAME = "usp_ShoppingCartLineItem_RetrieveForShoppingCart";

        /// <summary>
        /// Constructor
        /// </summary>
        public usp_ShoppingCartLineItem_Retrieve()
        {
        }
        ...
        )
        {
            ...
            command.SetInputParameter(SqlDbType.BigInt, "ShoppingCartId", b_ShoppingCartLineItem.ShoppingCartId);
            try
            {
