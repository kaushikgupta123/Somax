...
namespace Database.StoredProcedure
{
    ...
    /// </summary>
    public class usp_PartMaster_RetrieveLookupListBySearchCriteria
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_PartMaster_RetrieveLookupListBySearchCriteria";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_PartMaster_RetrieveLookupListBySearchCriteria()
        {
        }
        ...
        )
        {
            ...
            command.SetStringInputParameter(SqlDbType.NVarChar, "ShortDescription", shortDescription, 127);            
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    record = (b_PartMaster)b_PartMaster.ProcessRowForSearch(reader);
