...
{
    public class usp_Personnel_ValidateClientLookUp
    {
        private static string STOREDPROCEDURE_NAME = "usp_Personnel_ValidateClientLookUp";

        public usp_Personnel_ValidateClientLookUp()
        {
        }
