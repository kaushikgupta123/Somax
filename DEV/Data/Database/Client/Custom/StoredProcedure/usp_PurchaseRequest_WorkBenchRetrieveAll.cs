...
{
    public class usp_PurchaseRequest_WorkBenchRetrieveAll
    {
        private static string STOREDPROCEDURE_NAME = "usp_PurchaseRequest_WorkBenchRetrieveAll";

        public usp_PurchaseRequest_WorkBenchRetrieveAll()
        {
        }
