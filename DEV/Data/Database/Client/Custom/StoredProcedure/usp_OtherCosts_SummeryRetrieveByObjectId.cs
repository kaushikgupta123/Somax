...
{
  /// <summary>
  /// Access the usp_OtherCosts_SummeryRetrieveByObjectId stored procedure.
  /// </summary>
  public class usp_OtherCosts_SummeryRetrieveByObjectId
  {
    /// <summary>
    /// Constants.
    /// </summary>
    private static string STOREDPROCEDURE_NAME = "usp_OtherCosts_SummeryRetrieveByObjectId";

    /// <summary>
    /// Default constructor.
    /// </summary>
    public usp_OtherCosts_SummeryRetrieveByObjectId()
    {
    }

    /// <summary>
    /// Static method to call the usp_OtherCosts_SummeryRetrieveByObjectId stored procedure using SqlClient.
    /// </summary>
    ...
    )
    {
      ...
      try
      {
        ...
        while (reader.Read())
        {
          ...
          records.Add((b_OtherCosts)b_OtherCosts.ProcessRowForOtherCostsSummeryCrossReference(reader));
        }
