...
{
    public class usp_AssetGroup3_ValidateOldClientLookupIdV2
    {
        private static string STOREDPROCEDURE_NAME = "usp_AssetGroup3_ValidateOldClientLookupIdV2";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_AssetGroup3_ValidateOldClientLookupIdV2()
        {
        }
