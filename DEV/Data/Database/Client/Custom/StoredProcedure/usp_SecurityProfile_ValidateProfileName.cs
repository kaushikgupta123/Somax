...
{
    public class usp_SecurityProfile_ValidateProfileName
    {
        private static string STOREDPROCEDURE_NAME = "usp_SecurityProfile_ValidateProfileName";

        public usp_SecurityProfile_ValidateProfileName()
        {
        }
      ...
      )
        {
            ...
            command.SetInputParameter(SqlDbType.BigInt, "ClientId", AccessClientId);
