...
{
    public class usp_PurchaseRequestLineItem_Validate
    {
        private static string STOREDPROCEDURE_NAME = "usp_PurchaseRequestLineItem_Validate";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_PurchaseRequestLineItem_Validate()
        {
        }
