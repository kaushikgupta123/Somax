...
{
    class usp_Meter_RetrieveLookupListBySearchCriteria
    {
        private static string STOREDPROCEDURE_NAME = "usp_Meter_RetrieveLookupListBySearchCriteria";
        public usp_Meter_RetrieveLookupListBySearchCriteria()
        {
       ...
       )
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    record = (b_Meter)b_Meter.ProcessRow(reader);
