...
namespace Database.StoredProcedure
{
    ...
    /// </summary>
    public class usp_PartTransfer_ForceComplete
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_PartTransfer_ForceComplete";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_PartTransfer_ForceComplete()
        {
        }
        ...
        )
        {
            ...
            command.SetStringInputParameter(SqlDbType.NVarChar, "EventCode", obj.EventCode, 255);
            command.SetInputParameter(SqlDbType.Bit, "ConfirmForceComplete", obj.ConfirmForceComplete);
