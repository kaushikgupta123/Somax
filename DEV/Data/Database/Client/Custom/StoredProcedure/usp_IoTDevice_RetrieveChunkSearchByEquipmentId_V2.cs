...
{
    internal class usp_IoTDevice_RetrieveChunkSearchByEquipmentId_V2
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_IoTDevice_RetrieveChunkSearchByEquipmentId_V2";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_IoTDevice_RetrieveChunkSearchByEquipmentId_V2()
        {
        }

        /// <summary>
        /// Static method to call the usp_IoTDevice_RetrieveChunkSearchByEquipmentId_V2 stored procedure using SqlClient.
        /// </summary>
        ...
        )
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    b_IoTDevice tmpDevice = b_IoTDevice.ProcessRetrieveChunkSearchByEqipmentId(reader);
