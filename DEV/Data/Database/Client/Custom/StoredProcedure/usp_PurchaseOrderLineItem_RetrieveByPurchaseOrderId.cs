...
{
    public class usp_PurchaseOrderLineItem_RetrieveByPurchaseOrderId
    {
        private static string STOREDPROCEDURE_NAME = "usp_PurchaseOrderLineItem_RetrieveByPurchaseOrderId";

        public usp_PurchaseOrderLineItem_RetrieveByPurchaseOrderId()
        {
        }
