...
{
    /// <summary>
    /// Access the usp_PartCategoryMaster_RetrieveLookupListBySearchCriteria stored procedure.
    /// </summary>
    public class usp_PrevMaintLibrary_RetrieveLookupListBySearchCriteria
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_PrevMaintLibrary_RetrieveLookupListBySearchCriteriaV2";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_PrevMaintLibrary_RetrieveLookupListBySearchCriteria()
        {
        }
        ...
        public static List<b_PrevMaintLibrary> CallStoredProcedure(
            SqlCommand command,
        ...
        {
            List<b_PrevMaintLibrary> records = new List<b_PrevMaintLibrary>();
            ...
            command.SetStringInputParameter(SqlDbType.NVarChar, "Description", Description, 127);            
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    record = (b_PrevMaintLibrary)b_PrevMaintLibrary.ProcessRowForSearch(reader);
