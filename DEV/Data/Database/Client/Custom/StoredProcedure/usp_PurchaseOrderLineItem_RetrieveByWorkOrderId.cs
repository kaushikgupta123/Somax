...
namespace Database.StoredProcedure
{
    ...
    /// </summary>
    public class usp_PurchaseOrderLineItem_RetrieveByWorkOrderId
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_PurchaseOrderLineItem_RetrieveByWorkOrderId";


        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_PurchaseOrderLineItem_RetrieveByWorkOrderId()
        {
        }
        ...
        )
        {
            ...
            command.SetInputParameter(SqlDbType.BigInt, "WorkOrderId", obj.ChargeToId);
            ...
            try
            {
                ...
                while (reader.Read())
                {
                   ...
                   // records.Add((b_PartHistory)b_PartHistory.ProcessRow(reader));
                    records.Add((b_PurchaseOrderLineItem)b_PurchaseOrderLineItem.ProcessRowPOL(reader));
                }
