...
{
    public class usp_SanitationJob_OnDemandJobAndRequest_Create
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_SanitationJob_OnDemandJobAndRequest_Create";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_SanitationJob_OnDemandJobAndRequest_Create()
        {
        }
