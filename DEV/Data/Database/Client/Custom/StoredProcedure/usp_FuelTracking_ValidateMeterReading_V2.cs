...
{
    /// <summary>
    /// Access the usp_Equipment_ValidateClientLookupId stored procedure.
    /// </summary>
    public class usp_FuelTracking_ValidateMeterReading_V2
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_FuelTracking_ValidateMeterReading_V2";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_FuelTracking_ValidateMeterReading_V2()
        {
        }
        ...
        )
        {
            ...
            command.SetInputParameter(SqlDbType.Decimal, "MeterReading", obj.Reading);
            command.SetStringInputParameter(SqlDbType.NVarChar, "Tablename", obj.ObjectName, 31);
            try
            {
