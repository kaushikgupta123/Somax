...
{
    public class usp_Line_ValidateIfUsedInEquipment_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_Line_ValidateIfUsedInEquipment_V2";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_Line_ValidateIfUsedInEquipment_V2()
        {
        }
