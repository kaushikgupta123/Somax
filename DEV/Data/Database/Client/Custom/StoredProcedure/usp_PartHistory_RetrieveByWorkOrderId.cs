...
namespace Database.StoredProcedure
{
    ...
    /// </summary>
    public class usp_PartHistory_RetrieveByWorkOrderId
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_PartHistory_RetrieveByWorkOrderId";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_PartHistory_RetrieveByWorkOrderId()
        {
        }
            ...
            try
            {
                ...
                while (reader.Read())
                {
                   ...
                   // records.Add((b_PartHistory)b_PartHistory.ProcessRow(reader));
                    records.Add((b_PartHistory)b_PartHistory.ProcessRowPartIssue(reader));
                }
