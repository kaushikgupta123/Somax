...
{
    public class usp_SanitationJob_RetrieveForExtraction
    {
         private static string STOREDPROCEDURE_NAME = "usp_SanitationJob_RetrieveForExtraction";
         public usp_SanitationJob_RetrieveForExtraction()
        {
        }
