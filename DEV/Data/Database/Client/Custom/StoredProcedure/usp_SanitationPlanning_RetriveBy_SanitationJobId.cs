...
{
    public class usp_SanitationPlanning_RetriveBy_SanitationJobId
    {
        private static string STOREDPROCEDURE_NAME = "usp_SanitationPlanning_RetriveBy_SanitationJobId";

        public usp_SanitationPlanning_RetriveBy_SanitationJobId()
        {
