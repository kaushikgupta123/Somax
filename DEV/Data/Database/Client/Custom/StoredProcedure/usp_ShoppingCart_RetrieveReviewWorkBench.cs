...
{
    public class usp_ShoppingCart_RetrieveReviewWorkBench
    {
        private static string STOREDPROCEDURE_NAME = "usp_ShoppingCart_ReviewWorkBenchRetrieveAll";

        public usp_ShoppingCart_RetrieveReviewWorkBench()
        {
        }
