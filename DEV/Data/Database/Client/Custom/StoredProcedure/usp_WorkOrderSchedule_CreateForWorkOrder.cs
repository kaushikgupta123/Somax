...
namespace Database.StoredProcedure
{
    ...
    /// </summary>
    public class usp_WorkOrderSchedule_CreateForWorkOrder
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_WorkOrderSchedule_CreateForWorkOrder";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_WorkOrderSchedule_CreateForWorkOrder()
        {
        }
        ...
        public static void CallStoredProcedure(SqlCommand command, long callerUserInfoId, string callerUserName, b_WorkOrderSchedule obj)
        {
            ...
            command.SetOutputParameter(SqlDbType.BigInt, "WorkOrderSchedId");
            ...
            obj.WorkOrderSchedId = (long)command.Parameters["@WorkOrderSchedId"].Value;
