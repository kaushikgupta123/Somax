...
{
    public class usp_Vendor_ValidateByClientLookupId
    {
        private static string STOREDPROCEDURE_NAME = "usp_Vendor_ValidateByClientLookupId";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_Vendor_ValidateByClientLookupId()
        {
        }
