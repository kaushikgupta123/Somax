...
{
    public class usp_WorkRequest_RetrieveAllForSearch
    {
        private static string STOREDPROCEDURE_NAME = "usp_WorkRequest_RetrieveAllForSearch";

        public usp_WorkRequest_RetrieveAllForSearch()
        {
        }
      ...
      )
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    b_WorkOrder tmpWorkOrders = b_WorkOrder.ProcessRowForWorkRequestRetriveAllForSearch(reader);
