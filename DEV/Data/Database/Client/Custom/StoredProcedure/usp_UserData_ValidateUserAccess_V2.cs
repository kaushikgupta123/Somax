...
{
    public class usp_UserData_ValidateUserAccess_V2
    {

        private static string STOREDPROCEDURE_NAME = "usp_UserData_ValidateUserAccess_V2";

        public usp_UserData_ValidateUserAccess_V2()
        {
        }
     ...
     )
        {
            ...
            command.SetInputParameter(SqlDbType.BigInt, "UserInfoId", obj.UserInfoId);                // 2022-11-22
