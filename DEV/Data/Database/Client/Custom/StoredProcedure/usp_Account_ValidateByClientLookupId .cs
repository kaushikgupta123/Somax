...
{
    public class usp_Account_ValidateByClientLookupId
    {
        private static string STOREDPROCEDURE_NAME = "usp_Account_ValidateByClientLookupId";

        public usp_Account_ValidateByClientLookupId()
        {
        }
