...
{
    /// <summary>
  /// Access the usp_PrevMaintSched_UpdateByPKForeignKeys stored procedure.
    /// </summary>
    public class usp_ShoppingCart_UpdateByPKForeignKeys
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_ShoppingCart_UpdateByPKForeignKeys";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_ShoppingCart_UpdateByPKForeignKeys()
        {
        }

        /// <summary>
        /// Static method to call the usp_PrevMaintSched_UpdateByPKForeignKeys stored procedure using SqlClient.
        /// </summary>
        ...
        )
        {
            ...
            command.SetInputParameter(SqlDbType.BigInt, "By_PersonnelId", obj.PersonnelId);
            command.SetStringInputParameter(SqlDbType.NVarChar, "Status", obj.Status, 15);
            command.SetStringInputParameter(SqlDbType.NVarChar, "Flag", obj.Flag, 4);
