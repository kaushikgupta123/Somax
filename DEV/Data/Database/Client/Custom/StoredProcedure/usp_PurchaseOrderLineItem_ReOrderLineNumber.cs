...
{
    public class usp_PurchaseOrderLineItem_ReOrderLineNumber
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_PurchaseOrderLineItem_ReOrderLineNumber";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_PurchaseOrderLineItem_ReOrderLineNumber()
        {
        }
