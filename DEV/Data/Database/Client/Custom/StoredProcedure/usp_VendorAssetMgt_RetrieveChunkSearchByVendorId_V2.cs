...
{
    public class usp_VendorAssetMgt_RetrieveChunkSearchByVendorId_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_VendorAssetMgt_RetrieveChunkSearchByVendorId_V2";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_VendorAssetMgt_RetrieveChunkSearchByVendorId_V2()
        {
        }
        ...
        )
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    b_VendorAssetMgt tmpAssetMgt = b_VendorAssetMgt.ProcessRowForVendorAssetMgtChunkSearchSearchByVendorId(reader);
