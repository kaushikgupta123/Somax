...
{
    public class usp_SanitationJob_CreateFromSanMasterBatchEntry_OnDemand_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_SanitationJob_CreateFromSanMasterBatchEntry_OnDemand_V2";
