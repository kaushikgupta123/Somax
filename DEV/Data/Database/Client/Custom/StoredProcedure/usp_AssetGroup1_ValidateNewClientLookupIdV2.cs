...
{
    public class usp_AssetGroup1_ValidateNewClientLookupIdV2
    {
        private static string STOREDPROCEDURE_NAME = "usp_AssetGroup1_ValidateNewClientLookupIdV2";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_AssetGroup1_ValidateNewClientLookupIdV2()
        {
        }
