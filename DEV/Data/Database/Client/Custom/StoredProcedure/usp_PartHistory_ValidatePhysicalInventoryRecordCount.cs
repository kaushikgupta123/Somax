...
* =========== ======== =================== =======================================================
* 2015-Apr-02 SOM-619  Roger Lawton        Changed Parameters
***************************************************************************************************
*/
using System;
...
{
    public class usp_PartHistory_ValidatePhysicalInventoryRecordCount
    {
        /// <summary>
        /// Constants
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_PartHistory_ValidatePhysicalInventoryRecordCount";

        /// <summary>
        /// Constructor
        /// </summary>
        public usp_PartHistory_ValidatePhysicalInventoryRecordCount()
        {
