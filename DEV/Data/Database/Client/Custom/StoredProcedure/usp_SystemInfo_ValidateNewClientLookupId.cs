...
{
    public class usp_SystemInfo_ValidateNewClientLookupId
    {
        private static string STOREDPROCEDURE_NAME = "usp_SystemInfo_ValidateNewClientLookupIdV2";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_SystemInfo_ValidateNewClientLookupId()
        {
        }
