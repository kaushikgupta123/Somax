...
{
    public class usp_WorkOrder_RetrieveChunkForPrint_V2
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_WorkOrder_RetrieveChunkForPrint_V2";
        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_WorkOrder_RetrieveChunkForPrint_V2()
        {
        }
        ...
        ) 
        {
            ...
            //V2-271
            command.SetInputParameter(SqlDbType.DateTime, "CompleteDate ", obj.CompleteDate);
