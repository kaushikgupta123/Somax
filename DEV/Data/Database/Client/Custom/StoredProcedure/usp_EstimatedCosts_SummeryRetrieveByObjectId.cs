...
namespace Database.StoredProcedure
{
    ...
    /// </summary>
    public class usp_EstimatedCosts_SummeryRetrieveByObjectId
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_EstimateSummeryRetrieveByObjectId";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_EstimatedCosts_SummeryRetrieveByObjectId()
        {
        }
        ...
        )
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    records.Add((b_EstimatedCosts)b_EstimatedCosts.ProcessRowForEstimatedCostsSummeryCrossReference(reader));
                }
