...
{
    public class usp_SensorAlertProcedure_RetrieveActiveChunkSearchLookupList_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_SensorAlertProcedure_RetrieveActiveChunkSearchLookupList_V2";
        public usp_SensorAlertProcedure_RetrieveActiveChunkSearchLookupList_V2()
        {

        }

        public static List<b_SensorAlertProcedure> CallStoredProcedure(
           SqlCommand command,
           long callerUserInfoId,
           string callerUserName,
           b_SensorAlertProcedure obj
       )
        {
            List<b_SensorAlertProcedure> records = new List<b_SensorAlertProcedure>();
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    b_SensorAlertProcedure tmpEq = b_SensorAlertProcedure.ProcessRowRetrieveForActiveTableLookupList_V2(reader);
