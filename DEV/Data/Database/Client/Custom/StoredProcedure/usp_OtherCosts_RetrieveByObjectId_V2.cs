...
{
    class usp_OtherCosts_RetrieveByObjectId_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_OtherCosts_RetrieveByObjectId_V2";

        public usp_OtherCosts_RetrieveByObjectId_V2()
        {
        }
