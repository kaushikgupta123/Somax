...
{
    public class usp_SanitationJob_RetrieveBy_Filter
    {
        private static string STOREDPROCEDURE_NAME = "usp_SanitationJob_RetrieveBy_Filter";

        public usp_SanitationJob_RetrieveBy_Filter()
        {
        }
       ...
       )
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    b_SanitationJob tmpSanitationJob = b_SanitationJob.ProcessRowForSanitationJobRetriveAllForSearch(reader);
