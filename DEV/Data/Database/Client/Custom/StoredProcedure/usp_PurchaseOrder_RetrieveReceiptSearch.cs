...
{
   public class usp_PurchaseOrder_RetrieveReceiptSearch
    {
        private static string STOREDPROCEDURE_NAME = "usp_PurchaseOrder_RetrieveReceiptSearch";

        public usp_PurchaseOrder_RetrieveReceiptSearch()
        {
        }
