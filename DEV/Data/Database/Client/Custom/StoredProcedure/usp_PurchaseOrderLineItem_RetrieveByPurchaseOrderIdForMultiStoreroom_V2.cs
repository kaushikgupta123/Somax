...
{
    public class usp_PurchaseOrderLineItem_RetrieveByPurchaseOrderIdForMultiStoreroom_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_PurchaseOrderLineItem_RetrieveByPurchaseOrderIdForMultiStoreroom_V2";
        
        public usp_PurchaseOrderLineItem_RetrieveByPurchaseOrderIdForMultiStoreroom_V2()
        {
        }
        /// <summary>
        ...
        )
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    record.LoadFromDatabaseExtended_V2(reader);
                    records.Add(record);
                }
            }
            catch (Exception ex)
