...
{
    public class usp_PartMaster_ValidateByClientLookupId
    {
        private static string STOREDPROCEDURE_NAME = "usp_PartMaster_ValidateByClientLookupId ";
        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_PartMaster_ValidateByClientLookupId()
        {
        }
        ...
        )
        {
            ...
            command.SetStringInputParameter(SqlDbType.NVarChar, "Manufacturer", obj.Manufacturer, 256);
