...
{
    public class usp_Meter_RetrieveAllByClientId
    {
        private static string STOREDPROCEDURE_NAME = "usp_Meter_RetrieveAllByClientId";

        public usp_Meter_RetrieveAllByClientId()
        {
