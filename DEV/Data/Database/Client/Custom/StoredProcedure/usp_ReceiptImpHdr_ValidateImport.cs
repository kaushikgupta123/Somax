...
{
    public class usp_ReceiptImpHdr_ValidateImport
  {
        private static string STOREDPROCEDURE_NAME = "usp_ReceiptImpHdr_ValidateImport";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_ReceiptImpHdr_ValidateImport()
        {
        }
