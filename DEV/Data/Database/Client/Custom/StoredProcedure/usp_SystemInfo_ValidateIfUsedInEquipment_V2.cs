...
{
    public class usp_SystemInfo_ValidateIfUsedInEquipment_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_SystemInfo_ValidateIfUsedInEquipment_V2";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_SystemInfo_ValidateIfUsedInEquipment_V2()
        {
        }
