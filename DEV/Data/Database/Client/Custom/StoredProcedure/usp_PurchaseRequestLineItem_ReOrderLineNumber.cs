...
{
    public class usp_PurchaseRequestLineItem_ReOrderLineNumber
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_PurchaseRequestLineItem_ReOrderLineNumber";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_PurchaseRequestLineItem_ReOrderLineNumber()
        {
        }

        /// <summary>
        /// Static method to call the usp_WorkOrderTask_ReOrderTask stored procedure using SqlClient.
        /// </summary>
