...
{
    /// <summary>
    /// Access the usp_Personnel_RetrieveBySearchCriteria stored procedure.
    /// </summary>
    public class usp_Personnel_RetrieveBySearchCriteria
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_Personnel_RetrieveBySearchCriteria";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_Personnel_RetrieveBySearchCriteria()
        {
        }
        ...
        )
        {
            ...
            command.SetStringInputParameter(SqlDbType.VarChar, "Craft", craft, 256);
