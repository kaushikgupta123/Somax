...
{
    public class usp_AppGroupApprovers_RetrieveListForMultiLevelApproval_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_AppGroupApprovers_RetrieveListForMultiLevelApproval_V2";

        public usp_AppGroupApprovers_RetrieveListForMultiLevelApproval_V2()
        {
        }
        ...
        public static List<b_AppGroupApprovers> CallStoredProcedure(SqlCommand command, long callerUserInfoId, string callerUserName, b_AppGroupApprovers obj)
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    records.Add(b_AppGroupApprovers.ProcessRowForForMultilevelApprover(reader));
                }
