...
{
    public class usp_PartStoreroom_ValidateStoreroomId_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_PartStoreroom_ValidateStoreroomId_V2";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_PartStoreroom_ValidateStoreroomId_V2()
        {
        }
