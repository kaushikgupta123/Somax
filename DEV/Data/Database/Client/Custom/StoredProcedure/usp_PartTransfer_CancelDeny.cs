...
namespace Database.StoredProcedure
{
    ...
    /// </summary>
    public class usp_PartTransfer_CancelDeny
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_PartTransfer_CancelDeny";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_PartTransfer_CancelDeny()
        {
        }
        ...
        )
        {
            ...
            command.SetInputParameter(SqlDbType.BigInt, "LoggedUser_PersonnelId", obj.LastEventBy_PersonnelId);
            command.SetStringInputParameter(SqlDbType.NVarChar, "Comments", obj.Comments, -1);
            command.SetStringInputParameter(SqlDbType.NVarChar, "CancelOrDenyState", obj.CancelOrDenyState, 15);
            command.SetStringInputParameter(SqlDbType.NVarChar, "CancelDenyReason", obj.EventCode, 255);
