...
namespace Data.Database.StoredProcedure
{
    ...
    /// </summary>
    public class usp_PartCategoryMaster_RetrieveLookupListBySearchCriteria
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_PartCategoryMaster_RetrieveLookupListBySearchCriteria";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_PartCategoryMaster_RetrieveLookupListBySearchCriteria()
        {
        }
        ...
        )
        {
            ...
            command.SetStringInputParameter(SqlDbType.NVarChar, "ClientLookupId", clientLookupId, 255);
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    record = (b_PartCategoryMaster)b_PartCategoryMaster.ProcessRow(reader);
