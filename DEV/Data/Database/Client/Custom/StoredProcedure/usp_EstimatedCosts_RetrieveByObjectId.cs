...
namespace Database.StoredProcedure
{
    ...
    /// </summary>
    public class usp_EstimatedCosts_RetrieveByObjectId
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_EstimatedCosts_RetrieveByObjectId";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_EstimatedCosts_RetrieveByObjectId()
        {
        }
        ...
        )
        {
            ...
            command.SetStringInputParameter(SqlDbType.VarChar, "Category", obj.Category, 256);
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    records.Add((b_EstimatedCosts)b_EstimatedCosts.ProcessRowForEstimatedCostsCrossReference(reader));
                }
