...
{
    public class usp_PartHistory_UpdatePartCountsForMultiStoreroom_V2
    {

        /// <summary>
        /// Constants
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_PartHistory_UpdatePartCountsForMultiStoreroom_V2";

        /// <summary>
        /// Constructor
        /// </summary>
        public usp_PartHistory_UpdatePartCountsForMultiStoreroom_V2()
        {
