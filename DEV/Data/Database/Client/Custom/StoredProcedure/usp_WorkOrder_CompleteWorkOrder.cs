...
{
    /// <summary>
    /// Access the usp_WorkOrder_CompleteWorkOrder stored procedure.
    /// </summary>
    public class usp_WorkOrder_CompleteWorkOrder
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_WorkOrder_CompleteWorkOrder";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_WorkOrder_CompleteWorkOrder()
        {
        }
        ...
        )
        {
            ...
            command.SetStringInputParameter(SqlDbType.NVarChar, "Creator_PersonnelClientLookupId", obj.Creator_PersonnelClientLookupId, 31);
            command.SetStringInputParameter(SqlDbType.NVarChar, "ChargeToClientLookupId", obj.ChargeToClientLookupId, 31);
            command.SetStringInputParameter(SqlDbType.NVarChar, "ApproveBy_PersonnelClientLookupId", obj.ApproveBy_PersonnelClientLookupId, 31);
            ...
            command.SetStringInputParameter(SqlDbType.NVarChar, "SignoffBy_PersonnelClientLookupId", obj.SignoffBy_PersonnelClientLookupId, 31);
            command.SetStringInputParameter(SqlDbType.NVarChar, "WorkAssigned_PersonnelClientLookupId", obj.WorkAssigned_PersonnelClientLookupId, 31);
            command.SetStringInputParameter(SqlDbType.NVarChar, "CompleteBy_PersonnelClientLookupId", obj.CompleteBy_PersonnelClientLookupId, 31);
