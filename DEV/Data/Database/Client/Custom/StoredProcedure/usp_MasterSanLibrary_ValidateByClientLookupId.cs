...
{
    public class usp_MasterSanLibrary_ValidateByClientLookupId
    {
        private static string STOREDPROCEDURE_NAME = "usp_MasterSanLibrary_ValidateByClientLookupId";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_MasterSanLibrary_ValidateByClientLookupId()
        {
        }
