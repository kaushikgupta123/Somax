...
{
    public class usp_AssetGroup2_ValidateIfUsedInEquipment_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_AssetGroup2_ValidateIfUsedInEquipment_V2";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_AssetGroup2_ValidateIfUsedInEquipment_V2()
        {
        }
        ...
        )
        {
            ...
            command.SetInputParameter(SqlDbType.BigInt, "AssetGroup2Id ", obj.AssetGroup2);
