...
{
    /// <summary>
    /// Access the usp_PurchaseOrder_RetrieveLookupListBySearchCriteria stored procedure.
    /// </summary>
    public class usp_PurchaseOrder_RetrieveLookupListBySearchCriteria
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_PurchaseOrder_RetrieveLookupListBySearchCriteria";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_PurchaseOrder_RetrieveLookupListBySearchCriteria()
        {
        }
        ...
        )
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    record = (b_PurchaseOrder)b_PurchaseOrder.ProcessRowForLookUp(reader);
