...
{
    public class usp_MeterReading_ValidateProces
    {
        private static string STOREDPROCEDURE_NAME = "usp_MeterReading_ValidateProces";
        public usp_MeterReading_ValidateProces()
        {
