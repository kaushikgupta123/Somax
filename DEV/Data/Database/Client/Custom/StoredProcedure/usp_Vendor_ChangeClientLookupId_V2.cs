...
{
    public class usp_Vendor_ChangeClientLookupId_V2
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_Vendor_ChangeClientLookupId_V2";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_Vendor_ChangeClientLookupId_V2()
        {
        }

        /// <summary>
        /// Static method to call the usp_Vendor_ChangeClientLookupId stored procedure using SqlClient.
        /// </summary>
