...
{
    public class usp_Vendor_RetrieveBYFilterText
    {
         private static string STOREDPROCEDURE_NAME = "usp_Vendor_RetrieveBYFilterText";

         public usp_Vendor_RetrieveBYFilterText()
         {
         }
  ...
  )
         {
             ...
             try
             {
                 ...
                 while (reader.Read())
                 {
                     ...
                     records.Add(b_Vendor.ProcessRowForRetrieveByFilterText(reader));
                 }
             }
             finally
             {
