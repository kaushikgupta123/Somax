...
{
    public class usp_VendorMasterImport_Validation
    {
        private static string STOREDPROCEDURE_NAME = "usp_VendorMasterImport_Validation";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_VendorMasterImport_Validation()
        {
        }
        ...
        )
        {
            ...
            //command.SetStringInputParameter(SqlDbType.NVarChar, "VendorNumber", obj.VendorNumber, 31);
