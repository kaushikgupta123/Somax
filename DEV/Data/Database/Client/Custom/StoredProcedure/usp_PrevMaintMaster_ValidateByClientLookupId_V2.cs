...
{
    public class usp_PrevMaintMaster_ValidateByClientLookupId_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_PrevMaintMaster_ValidateByClientLookupId_V2";

        public usp_PrevMaintMaster_ValidateByClientLookupId_V2()
        {
        }
