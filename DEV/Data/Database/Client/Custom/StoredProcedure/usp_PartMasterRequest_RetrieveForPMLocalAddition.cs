...
{
    public class usp_PartMasterRequest_RetrieveForPMLocalAddition
    {
        private static string STOREDPROCEDURE_NAME = "usp_PartMasterRequest_RetrieveForPMLocalAddition";
        public usp_PartMasterRequest_RetrieveForPMLocalAddition()
        {
        }
