...
{
  /// <summary>
  /// Access the usp_POImpLine_UpdateByPK stored procedure.
  /// </summary>
  public class usp_POImpLine_UpdateByPKCustom
  {
    /// <summary>
    /// Constants.
    /// </summary>
    private static string STOREDPROCEDURE_NAME = "usp_POImpLine_UpdateByPKCustom";

    /// <summary>
    /// Default constructor.
    /// </summary>
    public usp_POImpLine_UpdateByPKCustom()
    {
    }

    /// <summary>
    /// Static method to call the usp_POImpLine_UpdateByPKCustom stored procedure using SqlClient.
    /// </summary>
    ...
    )
    {
      ...
      command.SetInputParameter(SqlDbType.BigInt, "POImpLineId", obj.POImpLineId);
