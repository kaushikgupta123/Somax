...
* =========== ======== ================== ========================================================
* 2014-Oct-21 SOM-384  Roger Lawton       Additional Parameter WebAppUser
***************************************************************************************************
*/
...
{
    public class usp_Site_ValidateNewUserAdd
    {
        private static string STOREDPROCEDURE_NAME = "usp_Site_ValidateNewUserAdd";

        public usp_Site_ValidateNewUserAdd()
        {
        }
      ...
      )
        {
            ...
            command.SetInputParameter(SqlDbType.Bit, "IsSuperUser", IsSuperUser);
