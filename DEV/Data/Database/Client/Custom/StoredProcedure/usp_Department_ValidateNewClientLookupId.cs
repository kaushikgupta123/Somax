...
{
    public class usp_Department_ValidateNewClientLookupId
    {
        private static string STOREDPROCEDURE_NAME = "usp_Department_ValidateNewClientLookupIdV2";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_Department_ValidateNewClientLookupId()
        {
        }
