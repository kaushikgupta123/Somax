...
{
    public class usp_Personnel_RetrieveForPrevMaintAssignLookupList_V2
    {
        private static string STOREDPROCEDURE_NAME = "usp_Personnel_RetrieveForPrevMaintAssignLookupList_V2";

        public usp_Personnel_RetrieveForPrevMaintAssignLookupList_V2()
        {
        }
