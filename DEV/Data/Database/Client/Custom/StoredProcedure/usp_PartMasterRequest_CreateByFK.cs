...
namespace Database.StoredProcedure
{
    ...
    /// </summary>
    public class usp_PartMasterRequest_CreateByFK
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_PartMasterRequest_CreateByFK";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_PartMasterRequest_CreateByFK()
        {
        }
        ...
        )
        {
            ...
            command.SetInputParameter(SqlDbType.BigInt, "ExportLogId", obj.ExportLogId);        // 2022-01-04-RKL
            ...
            command.SetStringInputParameter(SqlDbType.NVarChar, "PartMaster_ClientLookupId", obj.PartMaster_ClientLookupId, 70);
            ...
            if (!string.IsNullOrEmpty(command.Parameters["@PartMasterRequestId"].Value.ToString()))
            {
