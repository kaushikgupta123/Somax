...
* a Trade Secret. 
****************************************************************************************************
* usp_Attachment_RetrieveAllAttachment - Code to call sp
****************************************************************************************************
* Copyright (c) 2014-2018 by SOMAX Inc.
* FileAttachmentPanel.ascx.cs
* All rights reserved. 
****************************************************************************************************
* Date        JIRA-ID  Person       Description
* =========== ======== ============ ================================================================
* 2018-Oct-31 SOM-1650 Roger Lawton Retrieve all Attachments for Object 
****************************************************************************************************
*/
...
{
    /// <summary>
    /// Access the usp_Attachment_RetrieveAllAttachment stored procedure.
    /// </summary>
    public class usp_Attachment_RetrieveAllAttachmentsForObject
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_Attachment_RetrieveAllAttachmentsForObject";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_Attachment_RetrieveAllAttachmentsForObject()
        {
        }
