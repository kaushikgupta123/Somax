...
namespace Database.StoredProcedure
{
    ...
    /// </summary>
    public class usp_SecurityProfile_RetrieveByPackageLevel_V2
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_SecurityProfile_RetrieveByPackageLevel_V2";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_SecurityProfile_RetrieveByPackageLevel_V2()
        {
        }
        ...
        )
        {
            ...
            command.SetStringInputParameter(SqlDbType.NVarChar, "OrderColumn", obj.OrderColumn, 15);
            command.SetStringInputParameter(SqlDbType.NVarChar, "OrderDirection", obj.OrderDirection, 15);
