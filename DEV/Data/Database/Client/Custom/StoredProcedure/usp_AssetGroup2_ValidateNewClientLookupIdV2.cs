...
{
    public class usp_AssetGroup2_ValidateNewClientLookupIdV2
    {
        private static string STOREDPROCEDURE_NAME = "usp_AssetGroup2_ValidateNewClientLookupIdV2";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_AssetGroup2_ValidateNewClientLookupIdV2()
        {
        }               
