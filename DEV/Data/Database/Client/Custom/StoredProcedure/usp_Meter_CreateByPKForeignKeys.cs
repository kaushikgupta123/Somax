...
{
    public class usp_Meter_CreateByPKForeignKeys
    {
        private static string STOREDPROCEDURE_NAME = "usp_Meter_CreateByPKForeignKeys";
        public usp_Meter_CreateByPKForeignKeys()
        {
       ...
       )
        {
            ...
            command.SetInputParameter(SqlDbType.Decimal, "ReadingLife", obj.ReadingCurrent);
            ...
            if (!string.IsNullOrEmpty(command.Parameters["@MeterId"].Value.ToString()))
            {
