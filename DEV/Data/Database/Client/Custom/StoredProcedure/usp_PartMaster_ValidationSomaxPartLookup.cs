...
{
    public class usp_PartMaster_ValidationSomaxPartLookup
    {
        private static string STOREDPROCEDURE_NAME = "usp_PartMaster_ValidationSomaxPartLookup ";
        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_PartMaster_ValidationSomaxPartLookup()
        {
        }
        ...
        )
        {
            ...
            command.SetStringInputParameter(SqlDbType.NVarChar, "SelectedPart", obj.Part_ClientLookupId, 70);
