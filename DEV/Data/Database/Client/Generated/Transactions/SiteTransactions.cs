...
namespace Database
{
    public class Site_TransactionBaseClass : AbstractTransactionManager
    {
        public Site_TransactionBaseClass()
        {
        ...
        public override void PerformLocalValidation()
        {
            ...
            this.Site.ClientId = this.dbKey.Client.ClientId;
    ...
    public class Site_Create : Site_TransactionBaseClass
    {
    ...
    public class Site_Retrieve : Site_TransactionBaseClass
    {
    ...
    public class Site_Update : Site_TransactionBaseClass
    {
    ...
    public class Site_Delete : Site_TransactionBaseClass
    {
        public override void PerformLocalValidation()
        {
            base.PerformLocalValidation();
        ...
        public override void PerformWorkItem()
        {
            Site.DeleteFromDatabase(this.Connection, this.Transaction, CallerUserInfoId, CallerUserName);
        }
    }

    public class Site_RetrieveAll : AbstractTransactionManager
    {

        public Site_RetrieveAll()
        {
            // Set the database in which this table resides.
            // This must be called prior to base.PerformLocalValidation(), 
            // since that process will validate that the appropriate 
