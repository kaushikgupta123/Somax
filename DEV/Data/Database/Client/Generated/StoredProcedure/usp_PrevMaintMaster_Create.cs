...
{
  /// <summary>
  /// Access the usp_PrevMaintMaster_Create stored procedure.
  /// </summary>
  public class usp_PrevMaintMaster_Create
  {
    /// <summary>
    /// Constants.
    /// </summary>
    private static string STOREDPROCEDURE_NAME = "usp_PrevMaintMaster_Create";

    /// <summary>
    /// Default constructor.
    /// </summary>
    public usp_PrevMaintMaster_Create ()
    {
    }

    /// <summary>
    /// Static method to call the usp_PrevMaintMaster_Create stored procedure using SqlClient.
    /// </summary>
    ...
    )
    {
      ...
      command.SetInputParameter(SqlDbType.BigInt, "PMLibSourceId", obj.PMLibSourceId);
