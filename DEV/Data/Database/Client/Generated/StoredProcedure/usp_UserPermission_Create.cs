...
{
    /// <summary>
    /// Access the usp_UserPermission_Create stored procedure.
    /// </summary>
    public class usp_UserPermission_Create
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_UserPermission_Create";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_UserPermission_Create ()
        {
        }

        /// <summary>
        /// Static method to call the usp_UserPermission_Create stored procedure using SqlClient.
        /// </summary>
        ...
        )
        {
            ...
            command.SetOutputParameter(SqlDbType.BigInt, "UserPermissionId");
            ...
            obj.UserPermissionId = (long)command.Parameters["@UserPermissionId"].Value;
