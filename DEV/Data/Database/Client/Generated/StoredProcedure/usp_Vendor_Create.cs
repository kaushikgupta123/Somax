...
{
    /// <summary>
    /// Access the usp_Vendor_Create stored procedure.
    /// </summary>
    public class usp_Vendor_Create
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_Vendor_Create";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_Vendor_Create()
        {
        }

        /// <summary>
        /// Static method to call the usp_Vendor_Create stored procedure using SqlClient.
        /// </summary>
       ...
       )
        {
            ...
            command.SetOutputParameter(SqlDbType.BigInt, "VendorId");
            ...
            obj.VendorId = (long)command.Parameters["@VendorId"].Value;
