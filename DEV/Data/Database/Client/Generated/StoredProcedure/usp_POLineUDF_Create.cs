...
{
    /// <summary>
    /// Access the usp_POLineUDF_Create stored procedure.
    /// </summary>
    public class usp_POLineUDF_Create
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_POLineUDF_Create";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_POLineUDF_Create ()
        {
        }

        /// <summary>
        /// Static method to call the usp_POLineUDF_Create stored procedure using SqlClient.
        /// </summary>
        ...
        )
        {
            ...
            command.SetOutputParameter(SqlDbType.BigInt, "POLineUDFId");
            ...
            obj.POLineUDFId = (long)command.Parameters["@POLineUDFId"].Value;
