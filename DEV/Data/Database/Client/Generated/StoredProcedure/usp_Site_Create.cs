...
{
    /// <summary>
    /// Access the usp_Site_Create stored procedure.
    /// </summary>
    public class usp_Site_Create
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_Site_Create";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_Site_Create()
        {
        }

        /// <summary>
        /// Static method to call the usp_Site_Create stored procedure using SqlClient.
        /// </summary>
       ...
       )
        {
            ...
            command.SetOutputParameter(SqlDbType.BigInt, "SiteId");
            ...
            obj.SiteId = (long)command.Parameters["@SiteId"].Value;
