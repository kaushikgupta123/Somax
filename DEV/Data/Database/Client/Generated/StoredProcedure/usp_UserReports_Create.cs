...
{
    /// <summary>
    /// Access the usp_UserReports_Create stored procedure.
    /// </summary>
    public class usp_UserReports_Create
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_UserReports_Create";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_UserReports_Create ()
        {
        }

        /// <summary>
        /// Static method to call the usp_UserReports_Create stored procedure using SqlClient.
        /// </summary>
        ...
        )
        {
            ...
            command.SetOutputParameter(SqlDbType.BigInt, "UserReportsId");
            ...
            command.SetStringInputParameter(SqlDbType.NVarChar, "SaveType", obj.SaveType, 15);
            ...
            obj.UserReportsId = (long)command.Parameters["@UserReportsId"].Value;
