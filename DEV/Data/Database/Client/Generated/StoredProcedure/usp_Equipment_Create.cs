...
namespace Database.StoredProcedure
{
    ...
    /// </summary>
    public class usp_Equipment_Create
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_Equipment_Create";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_Equipment_Create()
        {
        }

        /// <summary>
        /// Static method to call the usp_Equipment_Create stored procedure using SqlClient.
        /// </summary>
        ...
        )
        {
            ...
            command.SetStringInputParameter(SqlDbType.NVarChar, "RegistrationLoc", obj.RegistrationLoc, 15);
            command.SetInputParameter(SqlDbType.Int, "VehicleYear", obj.VehicleYear);
            command.SetInputParameter(SqlDbType.Decimal, "CurrentReading", obj.CurrentReading);
            command.SetInputParameter(SqlDbType.DateTime2, "CurrentReadingDate", obj.CurrentReadingDate);
            command.SetStringInputParameter(SqlDbType.NVarChar, "FuelUnits", obj.FuelUnits, 15);
            ...
            command.SetStringInputParameter(SqlDbType.NVarChar, "Meter1Type", obj.Meter1Type, 15);
            command.SetStringInputParameter(SqlDbType.NVarChar, "Meter1Units", obj.Meter1Units, 15);
            ...
            command.SetStringInputParameter(SqlDbType.NVarChar, "Meter2Type", obj.Meter2Type, 15);
            command.SetStringInputParameter(SqlDbType.NVarChar, "Meter2Units", obj.Meter2Units, 15);
