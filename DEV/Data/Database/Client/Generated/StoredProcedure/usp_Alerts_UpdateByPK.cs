...
{
    /// <summary>
    /// Access the usp_Alerts_UpdateByPK stored procedure.
    /// </summary>
    public class usp_Alerts_UpdateByPK
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_Alerts_UpdateByPK";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_Alerts_UpdateByPK()
        {
        }

        /// <summary>
        /// Static method to call the usp_Alerts_UpdateByPK stored procedure using SqlClient.
        /// </summary>
