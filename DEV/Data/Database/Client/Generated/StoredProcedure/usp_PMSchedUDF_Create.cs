...
{
    /// <summary>
    /// Access the usp_PMSchedUDF_Create stored procedure.
    /// </summary>
    public class usp_PMSchedUDF_Create
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_PMSchedUDF_Create";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_PMSchedUDF_Create ()
        {
        }

        /// <summary>
        /// Static method to call the usp_PMSchedUDF_Create stored procedure using SqlClient.
        /// </summary>
        ...
        )
        {
            ...
            command.SetOutputParameter(SqlDbType.BigInt, "PMSchedUDFId");
            ...
            obj.PMSchedUDFId = (long)command.Parameters["@PMSchedUDFId"].Value;
