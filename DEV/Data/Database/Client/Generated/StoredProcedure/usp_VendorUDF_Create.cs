...
{
    /// <summary>
    /// Access the usp_VendorUDF_Create stored procedure.
    /// </summary>
    public class usp_VendorUDF_Create
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_VendorUDF_Create";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_VendorUDF_Create ()
        {
        }

        /// <summary>
        /// Static method to call the usp_VendorUDF_Create stored procedure using SqlClient.
        /// </summary>
        ...
        )
        {
            ...
            command.SetOutputParameter(SqlDbType.BigInt, "VendorUDFId");
            ...
            obj.VendorUDFId = (long)command.Parameters["@VendorUDFId"].Value;
