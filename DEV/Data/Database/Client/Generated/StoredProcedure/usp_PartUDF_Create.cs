...
{
    /// <summary>
    /// Access the usp_PartUDF_Create stored procedure.
    /// </summary>
    public class usp_PartUDF_Create
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_PartUDF_Create";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_PartUDF_Create ()
        {
        }

        /// <summary>
        /// Static method to call the usp_PartUDF_Create stored procedure using SqlClient.
        /// </summary>
        ...
        )
        {
            ...
            command.SetOutputParameter(SqlDbType.BigInt, "PartUDFId");
            ...
            obj.PartUDFId = (long)command.Parameters["@PartUDFId"].Value;
