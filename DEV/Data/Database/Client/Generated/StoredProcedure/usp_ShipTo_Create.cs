...
{
    /// <summary>
    /// Access the usp_ShipTo_Create stored procedure.
    /// </summary>
    public class usp_ShipTo_Create
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_ShipTo_Create";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_ShipTo_Create ()
        {
        }

        /// <summary>
        /// Static method to call the usp_ShipTo_Create stored procedure using SqlClient.
        /// </summary>
        ...
        )
        {
            ...
            command.SetOutputParameter(SqlDbType.BigInt, "ShipToId");
            ...
            command.SetStringInputParameter(SqlDbType.NVarChar, "AttnName", obj.AttnName, 63);
            command.SetStringInputParameter(SqlDbType.NVarChar, "PhoneNumber", obj.PhoneNumber, 31);

            // Execute stored procedure.
            command.ExecuteNonQuery();

            obj.ShipToId = (long)command.Parameters["@ShipToId"].Value;
