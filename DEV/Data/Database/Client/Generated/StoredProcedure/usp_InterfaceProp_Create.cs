...
{
    /// <summary>
    /// Access the usp_InterfaceProp_Create stored procedure.
    /// </summary>
    public class usp_InterfaceProp_Create
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_InterfaceProp_Create";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_InterfaceProp_Create()
        {
        }

        /// <summary>
        /// Static method to call the usp_InterfaceProp_Create stored procedure using SqlClient.
        /// </summary>
        ...
        )
        {
            ...
            command.SetOutputParameter(SqlDbType.BigInt, "InterfacePropId");
            ...
            obj.InterfacePropId = (long)command.Parameters["@InterfacePropId"].Value;
