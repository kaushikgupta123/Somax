...
{
    /// <summary>
    /// Access the usp_CustomQueryDisplay_Create stored procedure.
    /// </summary>
    public class usp_CustomQueryDisplay_Create
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_CustomQueryDisplay_Create";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_CustomQueryDisplay_Create ()
        {
        }

        /// <summary>
        /// Static method to call the usp_CustomQueryDisplay_Create stored procedure using SqlClient.
        /// </summary>
        ...
        )
        {
            ...
            command.SetOutputParameter(SqlDbType.BigInt, "CustomQueryDisplayId");
            ...
            obj.CustomQueryDisplayId = (long)command.Parameters["@CustomQueryDisplayId"].Value;
