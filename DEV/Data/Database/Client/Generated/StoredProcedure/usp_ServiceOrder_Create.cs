...
{
    /// <summary>
    /// Access the usp_ServiceOrder_Create stored procedure.
    /// </summary>
    public class usp_ServiceOrder_Create
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_ServiceOrder_Create";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_ServiceOrder_Create ()
        {
        }

        /// <summary>
        /// Static method to call the usp_ServiceOrder_Create stored procedure using SqlClient.
        /// </summary>
        ...
        )
        {
            ...
            command.SetOutputParameter(SqlDbType.BigInt, "ServiceOrderId");
            ...
            command.SetInputParameter(SqlDbType.DateTime2, "ScheduleDate", obj.ScheduleDate);
            ...
            obj.ServiceOrderId = (long)command.Parameters["@ServiceOrderId"].Value;
