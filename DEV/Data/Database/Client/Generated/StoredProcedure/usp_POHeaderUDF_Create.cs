...
{
    /// <summary>
    /// Access the usp_POHeaderUDF_Create stored procedure.
    /// </summary>
    public class usp_POHeaderUDF_Create
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_POHeaderUDF_Create";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_POHeaderUDF_Create ()
        {
        }

        /// <summary>
        /// Static method to call the usp_POHeaderUDF_Create stored procedure using SqlClient.
        /// </summary>
        ...
        )
        {
            ...
            command.SetOutputParameter(SqlDbType.BigInt, "POHeaderUDFId");
            ...
            obj.POHeaderUDFId = (long)command.Parameters["@POHeaderUDFId"].Value;
