...
{
    /// <summary>
    /// Access the usp_SanitationJob_UpdateByPK stored procedure.
    /// </summary>
    public class usp_SanitationJob_UpdateByPK
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_SanitationJob_UpdateByPK";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_SanitationJob_UpdateByPK ()
        {
        }

        /// <summary>
        /// Static method to call the usp_SanitationJob_UpdateByPK stored procedure using SqlClient.
        /// </summary>
        ...
        )
        {
            ...
            command.SetInputParameter(SqlDbType.BigInt, "PassBy_PersonnelId", obj.PassBy_PersonnelId);
            command.SetInputParameter(SqlDbType.DateTime2, "PassDate", obj.PassDate);
            command.SetInputParameter(SqlDbType.BigInt, "FailBy_PersonnelId", obj.FailBy_PersonnelId);
            command.SetInputParameter(SqlDbType.DateTime2, "FailDate", obj.FailDate);
            command.SetStringInputParameter(SqlDbType.NVarChar, "FailReason", obj.FailReason, 15);
            command.SetStringInputParameter(SqlDbType.NVarChar, "FailComment", obj.FailComment, 500);
