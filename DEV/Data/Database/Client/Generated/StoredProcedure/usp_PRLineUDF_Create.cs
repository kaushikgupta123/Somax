...
{
    /// <summary>
    /// Access the usp_PRLineUDF_Create stored procedure.
    /// </summary>
    public class usp_PRLineUDF_Create
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_PRLineUDF_Create";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_PRLineUDF_Create ()
        {
        }

        /// <summary>
        /// Static method to call the usp_PRLineUDF_Create stored procedure using SqlClient.
        /// </summary>
        ...
        )
        {
            ...
            command.SetOutputParameter(SqlDbType.BigInt, "PRLineUDFId");
            ...
            obj.PRLineUDFId = (long)command.Parameters["@PRLineUDFId"].Value;
