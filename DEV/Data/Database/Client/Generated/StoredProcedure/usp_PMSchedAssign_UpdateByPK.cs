...
{
    /// <summary>
    /// Access the usp_PMSchedAssign_UpdateByPK stored procedure.
    /// </summary>
    public class usp_PMSchedAssign_UpdateByPK
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_PMSchedAssign_UpdateByPK";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_PMSchedAssign_UpdateByPK()
        {
        }

        /// <summary>
        /// Static method to call the usp_PMSchedAssign_UpdateByPK stored procedure using SqlClient.
        /// </summary>
