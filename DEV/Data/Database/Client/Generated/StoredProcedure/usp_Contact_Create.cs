...
{
    /// <summary>
    /// Access the usp_Contact_Create stored procedure.
    /// </summary>
    public class usp_Contact_Create
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_Contact_Create";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_Contact_Create ()
        {
        }

        /// <summary>
        /// Static method to call the usp_Contact_Create stored procedure using SqlClient.
        /// </summary>
        ...
        )
        {
            ...
            command.SetOutputParameter(SqlDbType.BigInt, "ContactId");
            ...
            command.SetInputParameter(SqlDbType.BigInt, "OwnerId", obj.OwnerId);
            command.SetStringInputParameter(SqlDbType.NVarChar, "OwnerName", obj.OwnerName, 127);
            ...
            command.SetStringInputParameter(SqlDbType.NVarChar, "Phone3", obj.Phone3, 31);
            command.SetStringInputParameter(SqlDbType.NVarChar, "Email1", obj.Email1, 127);
            command.SetStringInputParameter(SqlDbType.NVarChar, "Email2", obj.Email2, 127);

            // Execute stored procedure.
            command.ExecuteNonQuery();

            obj.ContactId = (long)command.Parameters["@ContactId"].Value;
