...
{
    /// <summary>
    /// Access the usp_ServiceOrderSchedule_Create stored procedure.
    /// </summary>
    public class usp_ServiceOrderSchedule_Create
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_ServiceOrderSchedule_Create";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_ServiceOrderSchedule_Create ()
        {
        }

        /// <summary>
        /// Static method to call the usp_ServiceOrderSchedule_Create stored procedure using SqlClient.
        /// </summary>
        ...
        )
        {
            ...
            command.SetOutputParameter(SqlDbType.BigInt, "ServiceOrderScheduleId");
            ...
            obj.ServiceOrderScheduleId = (long)command.Parameters["@ServiceOrderScheduleId"].Value;
