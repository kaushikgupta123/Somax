...
{
    /// <summary>
    /// Access the usp_PRHeaderUDF_Create stored procedure.
    /// </summary>
    public class usp_PRHeaderUDF_Create
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_PRHeaderUDF_Create";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_PRHeaderUDF_Create ()
        {
        }

        /// <summary>
        /// Static method to call the usp_PRHeaderUDF_Create stored procedure using SqlClient.
        /// </summary>
        ...
        )
        {
            ...
            command.SetOutputParameter(SqlDbType.BigInt, "PRHeaderUDFId");
            ...
            obj.PRHeaderUDFId = (long)command.Parameters["@PRHeaderUDFId"].Value;
