...
{
    /// <summary>
    /// Access the usp_FleetIssues_Create stored procedure.
    /// </summary>
    public class usp_FleetIssues_Create
    {
        /// <summary>
        /// Constants.
        /// </summary>
        private static string STOREDPROCEDURE_NAME = "usp_FleetIssues_Create";

        /// <summary>
        /// Default constructor.
        /// </summary>
        public usp_FleetIssues_Create ()
        {
        }

        /// <summary>
        /// Static method to call the usp_FleetIssues_Create stored procedure using SqlClient.
        /// </summary>
        ...
        )
        {
            ...
            command.SetOutputParameter(SqlDbType.BigInt, "FleetIssuesId");
            ...
            command.SetStringInputParameter(SqlDbType.NVarChar, "Defects", obj.Defects, 1073741823);
            command.SetStringInputParameter(SqlDbType.NVarChar, "Description", obj.Description, 1073741823);
            command.SetStringInputParameter(SqlDbType.NVarChar, "DriverName", obj.DriverName, 255);
            command.SetInputParameter(SqlDbType.BigInt, "EquipmentId", obj.EquipmentId);
            command.SetInputParameter(SqlDbType.DateTime2, "RecordDate", obj.RecordDate);
            ...
            obj.FleetIssuesId = (long)command.Parameters["@FleetIssuesId"].Value;
