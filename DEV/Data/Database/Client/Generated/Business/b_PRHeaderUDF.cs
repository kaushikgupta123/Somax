...
{
    /// <summary>
    /// Business object that stores a record from the PRHeaderUDF table.InsertIntoDatabase
    /// </summary>
    [Serializable()]
    public partial class b_PRHeaderUDF : DataBusinessBase
    {
        /// <summary>
        /// Default constructor.
        /// </summary>
        public b_PRHeaderUDF ()
        {
            ClientId = 0;
            PRHeaderUDFId = 0;
            PurchaseRequestId = 0;
        ...
        /// <summary>
        /// Process the current row in the input SqlDataReader into a b_PRHeaderUDF object.
        /// This routine should be applied to the usp_PRHeaderUDF_RetrieveByPK stored procedure.
        /// This routine should be applied to the usp_PRHeaderUDF_RetrieveAll. stored procedure.
        /// </summary>
        /// <param name="reader">SqlDataReader containing the reader to process for the next row</param>
        /// <returns>object cast of the b_PRHeaderUDF object</returns>
        ...
        /// <summary>
        /// Load the current row in the input SqlDataReader into a b_PRHeaderUDF object.
        /// This routine should be applied to the usp_PRHeaderUDF_RetrieveByPK stored procedure.
        /// This routine should be applied to the usp_PRHeaderUDF_RetrieveAll. stored procedure.
        /// </summary>
        /// <param name="reader">SqlDataReader containing the reader to process for the next row</param>
        ...
        try
        {
            ...
            catch { missing.Append("PRHeaderUDFId "); }
     ...
     return i;
        ...
        /// <summary>
        /// Insert this object into the database as a PRHeaderUDF table record.
        /// </summary>
        ...
        )
        {
            ...
            try
            {
                ...
                Database.StoredProcedure.usp_PRHeaderUDF_Create.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
        ...
        /// <summary>
        /// Update the PRHeaderUDF table record represented by this object in the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
        ...
        )
        {
            ...
            try
            {
                ...
                Database.StoredProcedure.usp_PRHeaderUDF_UpdateByPK.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
        ...
        /// <summary>
        /// Delete the PRHeaderUDF table record represented by this object from the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
      ...
      string callerUserName
        )
        {
            ...
            try
            {
                ...
                Database.StoredProcedure.usp_PRHeaderUDF_DeleteByPK.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
        ...
        /// <summary>
        /// Retrieve all PRHeaderUDF table records represented by this object in the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
        /// <param name="callerUserName">string that identifies the user calling the database</param>
        /// <param name="data">b_PRHeaderUDF[] that contains the results</param>
        public void RetrieveAllFromDatabase (
            SqlConnection connection,
            SqlTransaction transaction,
            long callerUserInfoId,
      string callerUserName,
            ref b_PRHeaderUDF[] data
        )
        {
            Database.SqlClient.ProcessRow<b_PRHeaderUDF> processRow = null;
            ArrayList results = null;
            SqlCommand command = null;
            string message = String.Empty;

            // Initialize the results
            data = new b_PRHeaderUDF[0];
            ...
            try
            {
                ...
                processRow = new Database.SqlClient.ProcessRow<b_PRHeaderUDF>(reader => { b_PRHeaderUDF obj = new b_PRHeaderUDF(); obj.LoadFromDatabase(reader); return obj; });
                results = Database.StoredProcedure.usp_PRHeaderUDF_RetrieveAll.CallStoredProcedure(command, processRow, callerUserInfoId, callerUserName, ClientId);

                // Extract the results
                if (null != results)
                {
                    data = (b_PRHeaderUDF[])results.ToArray(typeof(b_PRHeaderUDF));
                }
                else
                {
                    data = new b_PRHeaderUDF[0];
        ...
        /// <summary>
        /// Retrieve PRHeaderUDF table records with specified primary key from the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
      ...
      string callerUserName
        )
        {
            ...
            try
            {
                ...
                // Call the stored procedure to retrieve the data
                processRow = new Database.SqlClient.ProcessRow<b_PRHeaderUDF>(reader => { this.LoadFromDatabase(reader); return this; });
                Database.StoredProcedure.usp_PRHeaderUDF_RetrieveByPK.CallStoredProcedure(command, processRow, callerUserInfoId, callerUserName, this);
        ...
        /// <summary>
        /// Test equality of two b_PRHeaderUDF objects.
        /// </summary>
        /// <param name="obj">b_PRHeaderUDF object to compare against the current object.</param>
        public bool Equals (b_PRHeaderUDF obj)
        {
            if (ClientId != obj.ClientId) return false;
            if (PRHeaderUDFId != obj.PRHeaderUDFId) return false;
        ...
        /// Test equality of two b_PRHeaderUDF objects.
        /// </summary>
        /// <param name="obj1">b_PRHeaderUDF object to use in the comparison.</param>
        /// <param name="obj2">b_PRHeaderUDF object to use in the comparison.</param>
        public static bool Equals (b_PRHeaderUDF obj1, b_PRHeaderUDF obj2)
        {
