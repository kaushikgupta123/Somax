...
{
    /// <summary>
    /// Business object that stores a record from the VendorUDF table.InsertIntoDatabase
    /// </summary>
    [Serializable()]
    public partial class b_VendorUDF : DataBusinessBase
    {
        /// <summary>
        /// Default constructor.
        /// </summary>
        ...
        /// <summary>
        /// Process the current row in the input SqlDataReader into a b_VendorUDF object.
        /// This routine should be applied to the usp_VendorUDF_RetrieveByPK stored procedure.
        /// This routine should be applied to the usp_VendorUDF_RetrieveAll. stored procedure.
        /// </summary>
        /// <param name="reader">SqlDataReader containing the reader to process for the next row</param>
        /// <returns>object cast of the b_VendorUDF object</returns>
        ...
        /// <summary>
        /// Load the current row in the input SqlDataReader into a b_VendorUDF object.
        /// This routine should be applied to the usp_VendorUDF_RetrieveByPK stored procedure.
        /// This routine should be applied to the usp_VendorUDF_RetrieveAll. stored procedure.
        /// </summary>
        /// <param name="reader">SqlDataReader containing the reader to process for the next row</param>
        ...
        try
        {
                        ...
                        // VendorUDFId column, bigint, not null
     ...
     return i;
        ...
        /// <summary>
        /// Insert this object into the database as a VendorUDF table record.
        /// </summary>
        ...
        )
        {
            ...
            try
            {
                ...
                Database.StoredProcedure.usp_VendorUDF_Create.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
        ...
        /// <summary>
        /// Update the VendorUDF table record represented by this object in the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
        ...
        )
        {
            ...
            try
            {
                ...
                Database.StoredProcedure.usp_VendorUDF_UpdateByPK.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
        ...
        /// <summary>
        /// Delete the VendorUDF table record represented by this object from the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
      ...
      string callerUserName
        )
        {
            ...
            try
            {
                ...
                Database.StoredProcedure.usp_VendorUDF_DeleteByPK.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
        ...
        /// <summary>
        /// Retrieve all VendorUDF table records represented by this object in the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
        /// <param name="callerUserName">string that identifies the user calling the database</param>
        /// <param name="data">b_VendorUDF[] that contains the results</param>
        public void RetrieveAllFromDatabase (
            SqlConnection connection,
            SqlTransaction transaction,
            long callerUserInfoId,
      string callerUserName,
            ref b_VendorUDF[] data
        )
        {
            Database.SqlClient.ProcessRow<b_VendorUDF> processRow = null;
            ArrayList results = null;
            SqlCommand command = null;
            string message = String.Empty;

            // Initialize the results
            data = new b_VendorUDF[0];
            ...
            try
            {
                ...
                processRow = new Database.SqlClient.ProcessRow<b_VendorUDF>(reader => { b_VendorUDF obj = new b_VendorUDF(); obj.LoadFromDatabase(reader); return obj; });
                results = Database.StoredProcedure.usp_VendorUDF_RetrieveAll.CallStoredProcedure(command, processRow, callerUserInfoId, callerUserName, ClientId);

                // Extract the results
                if (null != results)
                {
                    data = (b_VendorUDF[])results.ToArray(typeof(b_VendorUDF));
                }
                else
                {
                    data = new b_VendorUDF[0];
        ...
        /// <summary>
        /// Retrieve VendorUDF table records with specified primary key from the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
      ...
      string callerUserName
        )
        {
            ...
            try
            {
                ...
                // Call the stored procedure to retrieve the data
                processRow = new Database.SqlClient.ProcessRow<b_VendorUDF>(reader => { this.LoadFromDatabase(reader); return this; });
                Database.StoredProcedure.usp_VendorUDF_RetrieveByPK.CallStoredProcedure(command, processRow, callerUserInfoId, callerUserName, this);
        ...
        /// <summary>
        /// Test equality of two b_VendorUDF objects.
        /// </summary>
        /// <param name="obj">b_VendorUDF object to compare against the current object.</param>
        public bool Equals (b_VendorUDF obj)
        {
            if (ClientId != obj.ClientId) return false;
            if (VendorUDFId != obj.VendorUDFId) return false;
        ...
        /// Test equality of two b_VendorUDF objects.
        /// </summary>
        /// <param name="obj1">b_VendorUDF object to use in the comparison.</param>
        /// <param name="obj2">b_VendorUDF object to use in the comparison.</param>
        public static bool Equals (b_VendorUDF obj1, b_VendorUDF obj2)
        {
