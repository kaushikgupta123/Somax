...
namespace Database.Business
{
    ...
    [Serializable()]
    public partial class b_IoTEvent : DataBusinessBase
    {
        /// <summary>
        /// Default constructor.
        /// </summary>
        ...
        /// <summary>
        /// Process the current row in the input SqlDataReader into a b_IoTEvent object.
        /// This routine should be applied to the usp_IoTEvent_RetrieveByPK stored procedure.
        /// This routine should be applied to the usp_IoTEvent_RetrieveAll. stored procedure.
        /// </summary>
        /// <param name="reader">SqlDataReader containing the reader to process for the next row</param>
        /// <returns>object cast of the b_IoTEvent object</returns>
        public static object ProcessRow(SqlDataReader reader)
        {
            // Create instance of object
            b_IoTEvent obj = new b_IoTEvent();
        ...
        /// <summary>
        /// Load the current row in the input SqlDataReader into a b_IoTEvent object.
        /// This routine should be applied to the usp_IoTEvent_RetrieveByPK stored procedure.
        /// This routine should be applied to the usp_IoTEvent_RetrieveAll. stored procedure.
        /// </summary>
        /// <param name="reader">SqlDataReader containing the reader to process for the next row</param>
        ...
        /// <summary>
        /// Insert this object into the database as a IoTEvent table record.
        /// </summary>
        ...
        )
        {
            ...
            try
            {
                ...
                Database.StoredProcedure.usp_IoTEvent_Create.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
        ...
        /// <summary>
        /// Update the IoTEvent table record represented by this object in the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
        ...
        )
        {
            ...
            try
            {
                ...
                Database.StoredProcedure.usp_IoTEvent_UpdateByPK.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
        ...
        /// <summary>
        /// Delete the IoTEvent table record represented by this object from the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
      ...
      string callerUserName
        )
        {
            ...
            try
            {
                ...
                Database.StoredProcedure.usp_IoTEvent_DeleteByPK.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
        ...
        /// <summary>
        /// Retrieve all IoTEvent table records represented by this object in the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
        /// <param name="callerUserName">string that identifies the user calling the database</param>
        /// <param name="data">b_IoTEvent[] that contains the results</param>
      ...
      string callerUserName,
        ...
        )
        {
            ...
            try
            {
                ...
                processRow = new Database.SqlClient.ProcessRow<b_IoTEvent>(reader => { b_IoTEvent obj = new b_IoTEvent(); obj.LoadFromDatabase(reader); return obj; });
                results = Database.StoredProcedure.usp_IoTEvent_RetrieveAll.CallStoredProcedure(command, processRow, callerUserInfoId, callerUserName, ClientId);

                // Extract the results
                if (null != results)
                {
                    data = (b_IoTEvent[])results.ToArray(typeof(b_IoTEvent));
                }
                else
                {
                    data = new b_IoTEvent[0];
        ...
        /// <summary>
        /// Retrieve IoTEvent table records with specified primary key from the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
      ...
      string callerUserName
        )
        {
            ...
            try
            {
                ...
                // Call the stored procedure to retrieve the data
                processRow = new Database.SqlClient.ProcessRow<b_IoTEvent>(reader => { this.LoadFromDatabase(reader); return this; });
                Database.StoredProcedure.usp_IoTEvent_RetrieveByPK.CallStoredProcedure(command, processRow, callerUserInfoId, callerUserName, this);
        ...
        /// <summary>
        /// Test equality of two b_IoTEvent objects.
        /// </summary>
        /// <param name="obj">b_IoTEvent object to compare against the current object.</param>
        public bool Equals(b_IoTEvent obj)
        {
        ...
        /// Test equality of two b_IoTEvent objects.
        /// </summary>
        /// <param name="obj1">b_IoTEvent object to use in the comparison.</param>
        /// <param name="obj2">b_IoTEvent object to use in the comparison.</param>
        public static bool Equals(b_IoTEvent obj1, b_IoTEvent obj2)
        {
