...
{
    /// <summary>
    /// Business object that stores a record from the POLineUDF table.InsertIntoDatabase
    /// </summary>
    [Serializable()]
    public partial class b_POLineUDF : DataBusinessBase
    {
        /// <summary>
        /// Default constructor.
        /// </summary>
        ...
        /// <summary>
        /// Process the current row in the input SqlDataReader into a b_POLineUDF object.
        /// This routine should be applied to the usp_POLineUDF_RetrieveByPK stored procedure.
        /// This routine should be applied to the usp_POLineUDF_RetrieveAll. stored procedure.
        /// </summary>
        /// <param name="reader">SqlDataReader containing the reader to process for the next row</param>
        /// <returns>object cast of the b_POLineUDF object</returns>
        ...
        /// <summary>
        /// Load the current row in the input SqlDataReader into a b_POLineUDF object.
        /// This routine should be applied to the usp_POLineUDF_RetrieveByPK stored procedure.
        /// This routine should be applied to the usp_POLineUDF_RetrieveAll. stored procedure.
        /// </summary>
        /// <param name="reader">SqlDataReader containing the reader to process for the next row</param>
     ...
     return i;
        ...
        /// <summary>
        /// Insert this object into the database as a POLineUDF table record.
        /// </summary>
        ...
        )
        {
            ...
            try
            {
                ...
                Database.StoredProcedure.usp_POLineUDF_Create.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
        ...
        /// <summary>
        /// Update the POLineUDF table record represented by this object in the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
        ...
        )
        {
            ...
            try
            {
                ...
                Database.StoredProcedure.usp_POLineUDF_UpdateByPK.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
        ...
        /// <summary>
        /// Delete the POLineUDF table record represented by this object from the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
      ...
      string callerUserName
        )
        {
            ...
            try
            {
                ...
                Database.StoredProcedure.usp_POLineUDF_DeleteByPK.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
        ...
        /// <summary>
        /// Retrieve all POLineUDF table records represented by this object in the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
        /// <param name="callerUserName">string that identifies the user calling the database</param>
        /// <param name="data">b_POLineUDF[] that contains the results</param>
        public void RetrieveAllFromDatabase (
            SqlConnection connection,
            SqlTransaction transaction,
            long callerUserInfoId,
      string callerUserName,
            ref b_POLineUDF[] data
        )
        {
            Database.SqlClient.ProcessRow<b_POLineUDF> processRow = null;
            ArrayList results = null;
            SqlCommand command = null;
            string message = String.Empty;

            // Initialize the results
            data = new b_POLineUDF[0];
            ...
            try
            {
                ...
                processRow = new Database.SqlClient.ProcessRow<b_POLineUDF>(reader => { b_POLineUDF obj = new b_POLineUDF(); obj.LoadFromDatabase(reader); return obj; });
                results = Database.StoredProcedure.usp_POLineUDF_RetrieveAll.CallStoredProcedure(command, processRow, callerUserInfoId, callerUserName, ClientId);

                // Extract the results
                if (null != results)
                {
                    data = (b_POLineUDF[])results.ToArray(typeof(b_POLineUDF));
                }
                else
                {
                    data = new b_POLineUDF[0];
        ...
        /// <summary>
        /// Retrieve POLineUDF table records with specified primary key from the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
      ...
      string callerUserName
        )
        {
            ...
            try
            {
                ...
                // Call the stored procedure to retrieve the data
                processRow = new Database.SqlClient.ProcessRow<b_POLineUDF>(reader => { this.LoadFromDatabase(reader); return this; });
                Database.StoredProcedure.usp_POLineUDF_RetrieveByPK.CallStoredProcedure(command, processRow, callerUserInfoId, callerUserName, this);
        ...
        /// <summary>
        /// Test equality of two b_POLineUDF objects.
        /// </summary>
        /// <param name="obj">b_POLineUDF object to compare against the current object.</param>
        public bool Equals (b_POLineUDF obj)
        {
            if (ClientId != obj.ClientId) return false;
            if (POLineUDFId != obj.POLineUDFId) return false;
        ...
        /// Test equality of two b_POLineUDF objects.
        /// </summary>
        /// <param name="obj1">b_POLineUDF object to use in the comparison.</param>
        /// <param name="obj2">b_POLineUDF object to use in the comparison.</param>
        public static bool Equals (b_POLineUDF obj1, b_POLineUDF obj2)
        {
