...
{
    /// <summary>
    /// Business object that stores a record from the PMSchedUDF table.InsertIntoDatabase
    /// </summary>
    [Serializable()]
    public partial class b_PMSchedUDF : DataBusinessBase
    {
        /// <summary>
        /// Default constructor.
        /// </summary>
        ...
        /// <summary>
        /// Process the current row in the input SqlDataReader into a b_PMSchedUDF object.
        /// This routine should be applied to the usp_PMSchedUDF_RetrieveByPK stored procedure.
        /// This routine should be applied to the usp_PMSchedUDF_RetrieveAll. stored procedure.
        /// </summary>
        /// <param name="reader">SqlDataReader containing the reader to process for the next row</param>
        /// <returns>object cast of the b_PMSchedUDF object</returns>
        ...
        /// <summary>
        /// Load the current row in the input SqlDataReader into a b_PMSchedUDF object.
        /// This routine should be applied to the usp_PMSchedUDF_RetrieveByPK stored procedure.
        /// This routine should be applied to the usp_PMSchedUDF_RetrieveAll. stored procedure.
        /// </summary>
        /// <param name="reader">SqlDataReader containing the reader to process for the next row</param>
     ...
     return i;
        ...
        /// <summary>
        /// Insert this object into the database as a PMSchedUDF table record.
        /// </summary>
        ...
        )
        {
            ...
            try
            {
                ...
                Database.StoredProcedure.usp_PMSchedUDF_Create.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
        ...
        /// <summary>
        /// Update the PMSchedUDF table record represented by this object in the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
        ...
        )
        {
            ...
            try
            {
                ...
                Database.StoredProcedure.usp_PMSchedUDF_UpdateByPK.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
        ...
        /// <summary>
        /// Delete the PMSchedUDF table record represented by this object from the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
      ...
      string callerUserName
        )
        {
            ...
            try
            {
                ...
                Database.StoredProcedure.usp_PMSchedUDF_DeleteByPK.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
        ...
        /// <summary>
        /// Retrieve all PMSchedUDF table records represented by this object in the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
        /// <param name="callerUserName">string that identifies the user calling the database</param>
        /// <param name="data">b_PMSchedUDF[] that contains the results</param>
      ...
      string callerUserName,
        ...
        {
            Database.SqlClient.ProcessRow<b_PMSchedUDF> processRow = null;
            ArrayList results = null;
            SqlCommand command = null;
            string message = String.Empty;

            // Initialize the results
            data = new b_PMSchedUDF[0];
            ...
            try
            {
                ...
                processRow = new Database.SqlClient.ProcessRow<b_PMSchedUDF>(reader => { b_PMSchedUDF obj = new b_PMSchedUDF(); obj.LoadFromDatabase(reader); return obj; });
                results = Database.StoredProcedure.usp_PMSchedUDF_RetrieveAll.CallStoredProcedure(command, processRow, callerUserInfoId, callerUserName, ClientId);

                // Extract the results
                if (null != results)
                {
                    data = (b_PMSchedUDF[])results.ToArray(typeof(b_PMSchedUDF));
                }
                else
                {
                    data = new b_PMSchedUDF[0];
        ...
        /// <summary>
        /// Retrieve PMSchedUDF table records with specified primary key from the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
      ...
      string callerUserName
        )
        {
            ...
            try
            {
                ...
                // Call the stored procedure to retrieve the data
                processRow = new Database.SqlClient.ProcessRow<b_PMSchedUDF>(reader => { this.LoadFromDatabase(reader); return this; });
                Database.StoredProcedure.usp_PMSchedUDF_RetrieveByPK.CallStoredProcedure(command, processRow, callerUserInfoId, callerUserName, this);
        ...
        /// <summary>
        /// Test equality of two b_PMSchedUDF objects.
        /// </summary>
        /// <param name="obj">b_PMSchedUDF object to compare against the current object.</param>
        public bool Equals (b_PMSchedUDF obj)
        {
            if (ClientId != obj.ClientId) return false;
            if (PMSchedUDFId != obj.PMSchedUDFId) return false;
        ...
        /// Test equality of two b_PMSchedUDF objects.
        /// </summary>
        /// <param name="obj1">b_PMSchedUDF object to use in the comparison.</param>
        /// <param name="obj2">b_PMSchedUDF object to use in the comparison.</param>
        public static bool Equals (b_PMSchedUDF obj1, b_PMSchedUDF obj2)
        {
