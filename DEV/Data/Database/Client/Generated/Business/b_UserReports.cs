...
{
    /// <summary>
    /// Business object that stores a record from the UserReports table.InsertIntoDatabase
    /// </summary>
    [Serializable()]
    public partial class b_UserReports : DataBusinessBase
    {
        /// <summary>
        /// Default constructor.
        /// </summary>
        public b_UserReports ()
        {
            ClientId = 0;
            SiteId = 0;
            UserReportsId = 0;
        ...
        /// <summary>
        /// Process the current row in the input SqlDataReader into a b_UserReports object.
        /// This routine should be applied to the usp_UserReports_RetrieveByPK stored procedure.
        /// This routine should be applied to the usp_UserReports_RetrieveAll. stored procedure.
        /// </summary>
        /// <param name="reader">SqlDataReader containing the reader to process for the next row</param>
        /// <returns>object cast of the b_UserReports object</returns>
        ...
        /// <summary>
        /// Load the current row in the input SqlDataReader into a b_UserReports object.
        /// This routine should be applied to the usp_UserReports_RetrieveByPK stored procedure.
        /// This routine should be applied to the usp_UserReports_RetrieveAll. stored procedure.
        /// </summary>
        /// <param name="reader">SqlDataReader containing the reader to process for the next row</param>
        ...
        try
        {
                        ...
                        // UserReportsId column, bigint, not null
                        ...
                        // SaveType column, nvarchar(15), not null
     ...
     return i;
        ...
        /// <summary>
        /// Insert this object into the database as a UserReports table record.
        /// </summary>
        ...
        )
        {
            ...
            try
            {
                ...
                Database.StoredProcedure.usp_UserReports_Create.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
        ...
        /// <summary>
        /// Update the UserReports table record represented by this object in the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
        ...
        )
        {
            ...
            try
            {
                ...
                Database.StoredProcedure.usp_UserReports_UpdateByPK.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
        ...
        /// <summary>
        /// Delete the UserReports table record represented by this object from the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
      ...
      string callerUserName
        )
        {
            ...
            try
            {
                ...
                Database.StoredProcedure.usp_UserReports_DeleteByPK.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
        ...
        /// <summary>
        /// Retrieve all UserReports table records represented by this object in the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
        /// <param name="callerUserName">string that identifies the user calling the database</param>
        /// <param name="data">b_UserReports[] that contains the results</param>
        public void RetrieveAllFromDatabase (
            SqlConnection connection,
            SqlTransaction transaction,
            long callerUserInfoId,
      string callerUserName,
            ref b_UserReports[] data
        )
        {
            ...
            try
            {
                ...
                processRow = new Database.SqlClient.ProcessRow<b_UserReports>(reader => { b_UserReports obj = new b_UserReports(); obj.LoadFromDatabase(reader); return obj; });
                results = Database.StoredProcedure.usp_UserReports_RetrieveAll.CallStoredProcedure(command, processRow, callerUserInfoId, callerUserName, ClientId);

                // Extract the results
                if (null != results)
                {
                    data = (b_UserReports[])results.ToArray(typeof(b_UserReports));
                }
                else
                {
                    data = new b_UserReports[0];
        ...
        /// <summary>
        /// Retrieve UserReports table records with specified primary key from the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
      ...
      string callerUserName
        )
        {
            ...
            try
            {
                ...
                // Call the stored procedure to retrieve the data
                processRow = new Database.SqlClient.ProcessRow<b_UserReports>(reader => { this.LoadFromDatabase(reader); return this; });
                Database.StoredProcedure.usp_UserReports_RetrieveByPK.CallStoredProcedure(command, processRow, callerUserInfoId, callerUserName, this);
        ...
        /// <summary>
        /// Test equality of two b_UserReports objects.
        /// </summary>
        /// <param name="obj">b_UserReports object to compare against the current object.</param>
        public bool Equals (b_UserReports obj)
        {
            if (ClientId != obj.ClientId) return false;
            if (SiteId != obj.SiteId) return false;
            if (UserReportsId != obj.UserReportsId) return false;
            ...
            if (!SaveType.Equals(obj.SaveType)) return false;
        ...
        /// Test equality of two b_UserReports objects.
        /// </summary>
        /// <param name="obj1">b_UserReports object to use in the comparison.</param>
        /// <param name="obj2">b_UserReports object to use in the comparison.</param>
        public static bool Equals (b_UserReports obj1, b_UserReports obj2)
        {
