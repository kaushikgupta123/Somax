...
{
    /// <summary>
    /// Business object that stores a record from the VendorMasterImportHist table.InsertIntoDatabase
    /// </summary>
    [Serializable()]
    public partial class b_VendorMasterImportHist : DataBusinessBase
    {
        /// <summary>
        /// Default constructor.
        /// </summary>
        public b_VendorMasterImportHist ()
        {
            ClientId = 0;
            VendorMasterImportHistId = 0;
        ...
        /// </summary>
        public long VendorMasterImportHistId { get; set; }
        ...
        /// <summary>
        /// Process the current row in the input SqlDataReader into a b_VendorMasterImportHist object.
        /// This routine should be applied to the usp_VendorMasterImportHist_RetrieveByPK stored procedure.
        /// This routine should be applied to the usp_VendorMasterImportHist_RetrieveAll. stored procedure.
        /// </summary>
        /// <param name="reader">SqlDataReader containing the reader to process for the next row</param>
        /// <returns>object cast of the b_VendorMasterImportHist object</returns>
        public static object ProcessRow (SqlDataReader reader)
        {
            // Create instance of object
            b_VendorMasterImportHist obj = new b_VendorMasterImportHist();
        ...
        /// <summary>
        /// Load the current row in the input SqlDataReader into a b_VendorMasterImportHist object.
        /// This routine should be applied to the usp_VendorMasterImportHist_RetrieveByPK stored procedure.
        /// This routine should be applied to the usp_VendorMasterImportHist_RetrieveAll. stored procedure.
        /// </summary>
        /// <param name="reader">SqlDataReader containing the reader to process for the next row</param>
        ...
        try
        {
                        ...
                        // VendorMasterImportHistId column, bigint, not null
                        VendorMasterImportHistId = reader.GetInt64(i++);
                        ...
                        // EmailAddress column, nvarchar(31), not null
            ...
            try { reader["VendorMasterImportHistId"].ToString(); }
            catch { missing.Append("VendorMasterImportHistId "); }
     ...
     return i;
        ...
        /// <summary>
        /// Insert this object into the database as a VendorMasterImportHist table record.
        /// </summary>
        ...
        )
        {
            ...
            try
            {
                ...
                Database.StoredProcedure.usp_VendorMasterImportHist_Create.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
        ...
        /// <summary>
        /// Update the VendorMasterImportHist table record represented by this object in the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
        ...
        )
        {
            ...
            try
            {
                ...
                Database.StoredProcedure.usp_VendorMasterImportHist_UpdateByPK.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
        ...
        /// <summary>
        /// Delete the VendorMasterImportHist table record represented by this object from the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
      ...
      string callerUserName
        )
        {
            ...
            try
            {
                ...
                Database.StoredProcedure.usp_VendorMasterImportHist_DeleteByPK.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
        ...
        /// <summary>
        /// Retrieve all VendorMasterImportHist table records represented by this object in the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
        /// <param name="callerUserName">string that identifies the user calling the database</param>
        /// <param name="data">b_VendorMasterImportHist[] that contains the results</param>
        public void RetrieveAllFromDatabase (
            SqlConnection connection,
            SqlTransaction transaction,
            long callerUserInfoId,
      string callerUserName,
            ref b_VendorMasterImportHist[] data
        )
        {
           Database.SqlClient.ProcessRow<b_VendorMasterImportHist> processRow = null;
            ArrayList results = null;
            SqlCommand command = null;
            string message = String.Empty;

            // Initialize the results
            data = new b_VendorMasterImportHist[0];
            ...
            try
            {
                ...
                processRow = new Database.SqlClient.ProcessRow<b_VendorMasterImportHist>(reader => { b_VendorMasterImportHist obj = new b_VendorMasterImportHist(); obj.LoadFromDatabase(reader); return obj; });
                results = Database.StoredProcedure.usp_VendorMasterImportHist_RetrieveAll.CallStoredProcedure(command, processRow, callerUserInfoId, callerUserName, ClientId);

                // Extract the results
                if (null != results)
                {
                    data = (b_VendorMasterImportHist[])results.ToArray(typeof(b_VendorMasterImportHist));
                }
                else
                {
                    data = new b_VendorMasterImportHist[0];
        ...
        /// <summary>
        /// Retrieve VendorMasterImportHist table records with specified primary key from the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
      ...
      string callerUserName
        )
        {
            ...
            try
            {
                ...
                // Call the stored procedure to retrieve the data
                processRow = new Database.SqlClient.ProcessRow<b_VendorMasterImportHist>(reader => { this.LoadFromDatabase(reader); return this; });
                Database.StoredProcedure.usp_VendorMasterImportHist_RetrieveByPK.CallStoredProcedure(command, processRow, callerUserInfoId, callerUserName, this);
        ...
        /// <summary>
        /// Test equality of two b_VendorMasterImportHist objects.
        /// </summary>
        /// <param name="obj">b_VendorMasterImportHist object to compare against the current object.</param>
        public bool Equals (b_VendorMasterImportHist obj)
        {
            if (ClientId != obj.ClientId) return false;
            if (VendorMasterImportHistId != obj.VendorMasterImportHistId) return false;
        ...
        /// Test equality of two b_VendorMasterImportHist objects.
        /// </summary>
        /// <param name="obj1">b_VendorMasterImportHist object to use in the comparison.</param>
        /// <param name="obj2">b_VendorMasterImportHist object to use in the comparison.</param>
        public static bool Equals (b_VendorMasterImportHist obj1, b_VendorMasterImportHist obj2)
        {
