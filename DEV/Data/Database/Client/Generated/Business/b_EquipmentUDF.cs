...
{
    /// <summary>
    /// Business object that stores a record from the EquipmentUDF table.InsertIntoDatabase
    /// </summary>
    [Serializable()]
    public partial class b_EquipmentUDF : DataBusinessBase
    {
        /// <summary>
        /// Default constructor.
        /// </summary>
        public b_EquipmentUDF()
        {
            ClientId = 0;
            EquipmentUDFId = 0;
            Text1 = String.Empty;
        ...
        /// <summary>
        /// Process the current row in the input SqlDataReader into a b_EquipmentUDF object.
        /// This routine should be applied to the usp_EquipmentUDF_RetrieveByPK stored procedure.
        /// This routine should be applied to the usp_EquipmentUDF_RetrieveAll. stored procedure.
        /// </summary>
        /// <param name="reader">SqlDataReader containing the reader to process for the next row</param>
        /// <returns>object cast of the b_EquipmentUDF object</returns>
        ...
        /// <summary>
        /// Load the current row in the input SqlDataReader into a b_EquipmentUDF object.
        /// This routine should be applied to the usp_EquipmentUDF_RetrieveByPK stored procedure.
        /// This routine should be applied to the usp_EquipmentUDF_RetrieveAll. stored procedure.
        /// </summary>
        /// <param name="reader">SqlDataReader containing the reader to process for the next row</param>
        ...
        /// <summary>
        /// Insert this object into the database as a EquipmentUDF table record.
        /// </summary>
        ...
        )
        {
            ...
            try
            {
                ...
                Database.StoredProcedure.usp_EquipmentUDF_Create.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
        ...
        /// <summary>
        /// Update the EquipmentUDF table record represented by this object in the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
        ...
        )
        {
            ...
            try
            {
                ...
                Database.StoredProcedure.usp_EquipmentUDF_UpdateByPK.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
        ...
        /// <summary>
        /// Delete the EquipmentUDF table record represented by this object from the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
      ...
      string callerUserName
        )
        {
            ...
            try
            {
                ...
                Database.StoredProcedure.usp_EquipmentUDF_DeleteByPK.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
        ...
        /// <summary>
        /// Retrieve all EquipmentUDF table records represented by this object in the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
        /// <param name="callerUserName">string that identifies the user calling the database</param>
        /// <param name="data">b_EquipmentUDF[] that contains the results</param>
        public void RetrieveAllFromDatabase(
            SqlConnection connection,
            SqlTransaction transaction,
            long callerUserInfoId,
      string callerUserName,
            ref b_EquipmentUDF[] data
        )
        {
            Database.SqlClient.ProcessRow<b_EquipmentUDF> processRow = null;
            ArrayList results = null;
            SqlCommand command = null;
            string message = String.Empty;

            // Initialize the results
            data = new b_EquipmentUDF[0];
            ...
            try
            {
                ...
                processRow = new Database.SqlClient.ProcessRow<b_EquipmentUDF>(reader => { b_EquipmentUDF obj = new b_EquipmentUDF(); obj.LoadFromDatabase(reader); return obj; });
                results = Database.StoredProcedure.usp_EquipmentUDF_RetrieveAll.CallStoredProcedure(command, processRow, callerUserInfoId, callerUserName, ClientId);

                // Extract the results
                if (null != results)
                {
                    data = (b_EquipmentUDF[])results.ToArray(typeof(b_EquipmentUDF));
                }
                else
                {
                    data = new b_EquipmentUDF[0];
        ...
        /// <summary>
        /// Retrieve EquipmentUDF table records with specified primary key from the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
      ...
      string callerUserName
        )
        {
            ...
            try
            {
                ...
                // Call the stored procedure to retrieve the data
                processRow = new Database.SqlClient.ProcessRow<b_EquipmentUDF>(reader => { this.LoadFromDatabase(reader); return this; });
                Database.StoredProcedure.usp_EquipmentUDF_RetrieveByPK.CallStoredProcedure(command, processRow, callerUserInfoId, callerUserName, this);
        ...
        /// <summary>
        /// Test equality of two b_EquipmentUDF objects.
        /// </summary>
        /// <param name="obj">b_EquipmentUDF object to compare against the current object.</param>
        public bool Equals(b_EquipmentUDF obj)
        {
            if (ClientId != obj.ClientId) return false;
            if (EquipmentUDFId != obj.EquipmentUDFId) return false;
        ...
        /// Test equality of two b_EquipmentUDF objects.
        /// </summary>
        /// <param name="obj1">b_EquipmentUDF object to use in the comparison.</param>
        /// <param name="obj2">b_EquipmentUDF object to use in the comparison.</param>
        public static bool Equals(b_EquipmentUDF obj1, b_EquipmentUDF obj2)
        {
