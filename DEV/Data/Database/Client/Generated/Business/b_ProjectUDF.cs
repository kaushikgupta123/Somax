...
{
    /// <summary>
    /// Business object that stores a record from the ProjectUDF table.InsertIntoDatabase
    /// </summary>
    [Serializable()]
    public partial class b_ProjectUDF : DataBusinessBase
    {
        /// <summary>
        /// Default constructor.
        /// </summary>
        ...
        /// <summary>
        /// Process the current row in the input SqlDataReader into a b_ProjectUDF object.
        /// This routine should be applied to the usp_ProjectUDF_RetrieveByPK stored procedure.
        /// This routine should be applied to the usp_ProjectUDF_RetrieveAll. stored procedure.
        /// </summary>
        /// <param name="reader">SqlDataReader containing the reader to process for the next row</param>
        /// <returns>object cast of the b_ProjectUDF object</returns>
        ...
        /// <summary>
        /// Load the current row in the input SqlDataReader into a b_ProjectUDF object.
        /// This routine should be applied to the usp_ProjectUDF_RetrieveByPK stored procedure.
        /// This routine should be applied to the usp_ProjectUDF_RetrieveAll. stored procedure.
        /// </summary>
        /// <param name="reader">SqlDataReader containing the reader to process for the next row</param>
        ...
        /// <summary>
        /// Insert this object into the database as a ProjectUDF table record.
        /// </summary>
        ...
        )
        {
            ...
            try
            {
                ...
                Database.StoredProcedure.usp_ProjectUDF_Create.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
        ...
        /// <summary>
        /// Update the ProjectUDF table record represented by this object in the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
        ...
        )
        {
            ...
            try
            {
                ...
                Database.StoredProcedure.usp_ProjectUDF_UpdateByPK.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
        ...
        /// <summary>
        /// Delete the ProjectUDF table record represented by this object from the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
      ...
      string callerUserName
        )
        {
            ...
            try
            {
                ...
                Database.StoredProcedure.usp_ProjectUDF_DeleteByPK.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
        ...
        /// <summary>
        /// Retrieve all ProjectUDF table records represented by this object in the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
        /// <param name="callerUserName">string that identifies the user calling the database</param>
        /// <param name="data">b_ProjectUDF[] that contains the results</param>
        public void RetrieveAllFromDatabase(
            SqlConnection connection,
            SqlTransaction transaction,
            long callerUserInfoId,
      string callerUserName,
            ref b_ProjectUDF[] data
        )
        {
            Database.SqlClient.ProcessRow<b_ProjectUDF> processRow = null;
            ArrayList results = null;
            SqlCommand command = null;
            string message = String.Empty;

            // Initialize the results
            data = new b_ProjectUDF[0];
            ...
            try
            {
                ...
                processRow = new Database.SqlClient.ProcessRow<b_ProjectUDF>(reader => { b_ProjectUDF obj = new b_ProjectUDF(); obj.LoadFromDatabase(reader); return obj; });
                results = Database.StoredProcedure.usp_ProjectUDF_RetrieveAll.CallStoredProcedure(command, processRow, callerUserInfoId, callerUserName, ClientId);

                // Extract the results
                if (null != results)
                {
                    data = (b_ProjectUDF[])results.ToArray(typeof(b_ProjectUDF));
                }
                else
                {
                    data = new b_ProjectUDF[0];
        ...
        /// <summary>
        /// Retrieve ProjectUDF table records with specified primary key from the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
      ...
      string callerUserName
        )
        {
            ...
            try
            {
                ...
                // Call the stored procedure to retrieve the data
                processRow = new Database.SqlClient.ProcessRow<b_ProjectUDF>(reader => { this.LoadFromDatabase(reader); return this; });
                Database.StoredProcedure.usp_ProjectUDF_RetrieveByPK.CallStoredProcedure(command, processRow, callerUserInfoId, callerUserName, this);
        ...
        /// <summary>
        /// Test equality of two b_ProjectUDF objects.
        /// </summary>
        /// <param name="obj">b_ProjectUDF object to compare against the current object.</param>
        public bool Equals(b_ProjectUDF obj)
        {
            if (ClientId != obj.ClientId) return false;
            if (ProjectUDFId != obj.ProjectUDFId) return false;
        ...
        /// Test equality of two b_ProjectUDF objects.
        /// </summary>
        /// <param name="obj1">b_ProjectUDF object to use in the comparison.</param>
        /// <param name="obj2">b_ProjectUDF object to use in the comparison.</param>
        public static bool Equals(b_ProjectUDF obj1, b_ProjectUDF obj2)
        {
