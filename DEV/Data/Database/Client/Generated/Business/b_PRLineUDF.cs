...
{
    /// <summary>
    /// Business object that stores a record from the PRLineUDF table.InsertIntoDatabase
    /// </summary>
    [Serializable()]
    public partial class b_PRLineUDF : DataBusinessBase
    {
        /// <summary>
        /// Default constructor.
        /// </summary>
        ...
        /// <summary>
        /// Process the current row in the input SqlDataReader into a b_PRLineUDF object.
        /// This routine should be applied to the usp_PRLineUDF_RetrieveByPK stored procedure.
        /// This routine should be applied to the usp_PRLineUDF_RetrieveAll. stored procedure.
        /// </summary>
        /// <param name="reader">SqlDataReader containing the reader to process for the next row</param>
        /// <returns>object cast of the b_PRLineUDF object</returns>
        ...
        /// <summary>
        /// Load the current row in the input SqlDataReader into a b_PRLineUDF object.
        /// This routine should be applied to the usp_PRLineUDF_RetrieveByPK stored procedure.
        /// This routine should be applied to the usp_PRLineUDF_RetrieveAll. stored procedure.
        /// </summary>
        /// <param name="reader">SqlDataReader containing the reader to process for the next row</param>
     ...
     return i;
        ...
        /// <summary>
        /// Insert this object into the database as a PRLineUDF table record.
        /// </summary>
        ...
        )
        {
            ...
            try
            {
                ...
                Database.StoredProcedure.usp_PRLineUDF_Create.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
        ...
        /// <summary>
        /// Update the PRLineUDF table record represented by this object in the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
        ...
        )
        {
            ...
            try
            {
                ...
                Database.StoredProcedure.usp_PRLineUDF_UpdateByPK.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
        ...
        /// <summary>
        /// Delete the PRLineUDF table record represented by this object from the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
      ...
      string callerUserName
        )
        {
            ...
            try
            {
                ...
                Database.StoredProcedure.usp_PRLineUDF_DeleteByPK.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
        ...
        /// <summary>
        /// Retrieve all PRLineUDF table records represented by this object in the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
        /// <param name="callerUserName">string that identifies the user calling the database</param>
        /// <param name="data">b_PRLineUDF[] that contains the results</param>
        public void RetrieveAllFromDatabase (
            SqlConnection connection,
            SqlTransaction transaction,
            long callerUserInfoId,
      string callerUserName,
            ref b_PRLineUDF[] data
        )
        {
            Database.SqlClient.ProcessRow<b_PRLineUDF> processRow = null;
            ArrayList results = null;
            SqlCommand command = null;
            string message = String.Empty;

            // Initialize the results
            data = new b_PRLineUDF[0];
            ...
            try
            {
                ...
                processRow = new Database.SqlClient.ProcessRow<b_PRLineUDF>(reader => { b_PRLineUDF obj = new b_PRLineUDF(); obj.LoadFromDatabase(reader); return obj; });
                results = Database.StoredProcedure.usp_PRLineUDF_RetrieveAll.CallStoredProcedure(command, processRow, callerUserInfoId, callerUserName, ClientId);

                // Extract the results
                if (null != results)
                {
                    data = (b_PRLineUDF[])results.ToArray(typeof(b_PRLineUDF));
                }
                else
                {
                    data = new b_PRLineUDF[0];
        ...
        /// <summary>
        /// Retrieve PRLineUDF table records with specified primary key from the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
      ...
      string callerUserName
        )
        {
            ...
            try
            {
                ...
                // Call the stored procedure to retrieve the data
                processRow = new Database.SqlClient.ProcessRow<b_PRLineUDF>(reader => { this.LoadFromDatabase(reader); return this; });
                Database.StoredProcedure.usp_PRLineUDF_RetrieveByPK.CallStoredProcedure(command, processRow, callerUserInfoId, callerUserName, this);
        ...
        /// <summary>
        /// Test equality of two b_PRLineUDF objects.
        /// </summary>
        /// <param name="obj">b_PRLineUDF object to compare against the current object.</param>
        public bool Equals (b_PRLineUDF obj)
        {
            if (ClientId != obj.ClientId) return false;
            if (PRLineUDFId != obj.PRLineUDFId) return false;
        ...
        /// Test equality of two b_PRLineUDF objects.
        /// </summary>
        /// <param name="obj1">b_PRLineUDF object to use in the comparison.</param>
        /// <param name="obj2">b_PRLineUDF object to use in the comparison.</param>
        public static bool Equals (b_PRLineUDF obj1, b_PRLineUDF obj2)
        {
