...
{
    /// <summary>
    /// Business object that stores a record from the UserReportGridDefintion table.InsertIntoDatabase
    /// </summary>
    [Serializable()]
    public partial class b_UserReportGridDefintion : DataBusinessBase
    {
        /// <summary>
        /// Default constructor.
        /// </summary>
        public b_UserReportGridDefintion ()
        {
            UserReportGridDefintionId = 0;
            ReportId = 0;
            Sequence = 0;
        ...
        /// <summary>
        /// Process the current row in the input SqlDataReader into a b_UserReportGridDefintion object.
        /// This routine should be applied to the usp_UserReportGridDefintion_RetrieveByPK stored procedure.
        /// This routine should be applied to the usp_UserReportGridDefintion_RetrieveAll. stored procedure.
        /// </summary>
        /// <param name="reader">SqlDataReader containing the reader to process for the next row</param>
        /// <returns>object cast of the b_UserReportGridDefintion object</returns>
        public static object ProcessRow (SqlDataReader reader)
        {
            // Create instance of object
            b_UserReportGridDefintion obj = new b_UserReportGridDefintion();
        ...
        /// <summary>
        /// Load the current row in the input SqlDataReader into a b_UserReportGridDefintion object.
        /// This routine should be applied to the usp_UserReportGridDefintion_RetrieveByPK stored procedure.
        /// This routine should be applied to the usp_UserReportGridDefintion_RetrieveAll. stored procedure.
        /// </summary>
        /// <param name="reader">SqlDataReader containing the reader to process for the next row</param>
     ...
     return i;
        ...
        /// <summary>
        /// Insert this object into the database as a UserReportGridDefintion table record.
        /// </summary>
        ...
        )
        {
            ...
            try
            {
                ...
                Database.StoredProcedure.usp_UserReportGridDefintion_Create.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
        ...
        /// <summary>
        /// Update the UserReportGridDefintion table record represented by this object in the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
        ...
        )
        {
            ...
            try
            {
                ...
                Database.StoredProcedure.usp_UserReportGridDefintion_UpdateByPK.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
        ...
        /// <summary>
        /// Delete the UserReportGridDefintion table record represented by this object from the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
      ...
      string callerUserName
        )
        {
            ...
            try
            {
                ...
                Database.StoredProcedure.usp_UserReportGridDefintion_DeleteByPK.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
        ...
        /// <summary>
        /// Retrieve all UserReportGridDefintion table records represented by this object in the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
        /// <param name="callerUserName">string that identifies the user calling the database</param>
        /// <param name="data">b_UserReportGridDefintion[] that contains the results</param>
        public void RetrieveAllFromDatabase (
            SqlConnection connection,
            SqlTransaction transaction,
            long callerUserInfoId,
      string callerUserName,
            ref b_UserReportGridDefintion[] data
        )
        {
            ...
            data = new b_UserReportGridDefintion[0];
            ...
            try
            {
                ...
                processRow = new Database.SqlClient.ProcessRow<b_UserReportGridDefintion>(reader => { b_UserReportGridDefintion obj = new b_UserReportGridDefintion(); obj.LoadFromDatabase(reader); return obj; });
                results = Database.StoredProcedure.usp_UserReportGridDefintion_RetrieveAll.CallStoredProcedure(command, processRow, callerUserInfoId, callerUserName);

                // Extract the results
                if (null != results)
                {
                    data = (b_UserReportGridDefintion[])results.ToArray(typeof(b_UserReportGridDefintion));
                }
                else
                {
                    data = new b_UserReportGridDefintion[0];
        ...
        /// <summary>
        /// Retrieve UserReportGridDefintion table records with specified primary key from the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
      ...
      string callerUserName
        )
        {
            ...
            try
            {
                ...
                Database.StoredProcedure.usp_UserReportGridDefintion_RetrieveByPK.CallStoredProcedure(command, processRow, callerUserInfoId, callerUserName, this);
        ...
        /// <summary>
        /// Test equality of two b_UserReportGridDefintion objects.
        /// </summary>
        /// <param name="obj">b_UserReportGridDefintion object to compare against the current object.</param>
        public bool Equals (b_UserReportGridDefintion obj)
        {
            if (UserReportGridDefintionId != obj.UserReportGridDefintionId) return false;
            if (ReportId != obj.ReportId) return false;
        ...
        /// Test equality of two b_UserReportGridDefintion objects.
        /// </summary>
        /// <param name="obj1">b_UserReportGridDefintion object to use in the comparison.</param>
        /// <param name="obj2">b_UserReportGridDefintion object to use in the comparison.</param>
        public static bool Equals (b_UserReportGridDefintion obj1, b_UserReportGridDefintion obj2)
        {
