...
{
    /// <summary>
    /// Business object that stores a record from the POHeaderUDF table.InsertIntoDatabase
    /// </summary>
    [Serializable()]
    public partial class b_POHeaderUDF : DataBusinessBase
    {
        /// <summary>
        /// Default constructor.
        /// </summary>
        public b_POHeaderUDF ()
        {
            ClientId = 0;
            POHeaderUDFId = 0;
            PurchaseOrderId = 0;
        ...
        /// <summary>
        /// Process the current row in the input SqlDataReader into a b_POHeaderUDF object.
        /// This routine should be applied to the usp_POHeaderUDF_RetrieveByPK stored procedure.
        /// This routine should be applied to the usp_POHeaderUDF_RetrieveAll. stored procedure.
        /// </summary>
        /// <param name="reader">SqlDataReader containing the reader to process for the next row</param>
        /// <returns>object cast of the b_POHeaderUDF object</returns>
        ...
        /// <summary>
        /// Load the current row in the input SqlDataReader into a b_POHeaderUDF object.
        /// This routine should be applied to the usp_POHeaderUDF_RetrieveByPK stored procedure.
        /// This routine should be applied to the usp_POHeaderUDF_RetrieveAll. stored procedure.
        /// </summary>
        /// <param name="reader">SqlDataReader containing the reader to process for the next row</param>
     ...
     return i;
        ...
        /// <summary>
        /// Insert this object into the database as a POHeaderUDF table record.
        /// </summary>
        ...
        )
        {
            ...
            try
            {
                ...
                Database.StoredProcedure.usp_POHeaderUDF_Create.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
        ...
        /// <summary>
        /// Update the POHeaderUDF table record represented by this object in the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
        ...
        )
        {
            ...
            try
            {
                ...
                Database.StoredProcedure.usp_POHeaderUDF_UpdateByPK.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
        ...
        /// <summary>
        /// Delete the POHeaderUDF table record represented by this object from the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
      ...
      string callerUserName
        )
        {
            ...
            try
            {
                ...
                Database.StoredProcedure.usp_POHeaderUDF_DeleteByPK.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
        ...
        /// <summary>
        /// Retrieve all POHeaderUDF table records represented by this object in the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
        /// <param name="callerUserName">string that identifies the user calling the database</param>
        /// <param name="data">b_POHeaderUDF[] that contains the results</param>
        public void RetrieveAllFromDatabase (
            SqlConnection connection,
            SqlTransaction transaction,
            long callerUserInfoId,
      string callerUserName,
            ref b_POHeaderUDF[] data
        )
        {
            Database.SqlClient.ProcessRow<b_POHeaderUDF> processRow = null;
            ArrayList results = null;
            SqlCommand command = null;
            string message = String.Empty;

            // Initialize the results
            data = new b_POHeaderUDF[0];
            ...
            try
            {
                ...
                processRow = new Database.SqlClient.ProcessRow<b_POHeaderUDF>(reader => { b_POHeaderUDF obj = new b_POHeaderUDF(); obj.LoadFromDatabase(reader); return obj; });
                results = Database.StoredProcedure.usp_POHeaderUDF_RetrieveAll.CallStoredProcedure(command, processRow, callerUserInfoId, callerUserName, ClientId);

                // Extract the results
                if (null != results)
                {
                    data = (b_POHeaderUDF[])results.ToArray(typeof(b_POHeaderUDF));
                }
                else
                {
                    data = new b_POHeaderUDF[0];
        ...
        /// <summary>
        /// Retrieve POHeaderUDF table records with specified primary key from the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
      ...
      string callerUserName
        )
        {
            ...
            try
            {
                ...
                // Call the stored procedure to retrieve the data
                processRow = new Database.SqlClient.ProcessRow<b_POHeaderUDF>(reader => { this.LoadFromDatabase(reader); return this; });
                Database.StoredProcedure.usp_POHeaderUDF_RetrieveByPK.CallStoredProcedure(command, processRow, callerUserInfoId, callerUserName, this);
        ...
        /// <summary>
        /// Test equality of two b_POHeaderUDF objects.
        /// </summary>
        /// <param name="obj">b_POHeaderUDF object to compare against the current object.</param>
        public bool Equals (b_POHeaderUDF obj)
        {
            if (ClientId != obj.ClientId) return false;
            if (POHeaderUDFId != obj.POHeaderUDFId) return false;
        ...
        /// Test equality of two b_POHeaderUDF objects.
        /// </summary>
        /// <param name="obj1">b_POHeaderUDF object to use in the comparison.</param>
        /// <param name="obj2">b_POHeaderUDF object to use in the comparison.</param>
        public static bool Equals (b_POHeaderUDF obj1, b_POHeaderUDF obj2)
        {
