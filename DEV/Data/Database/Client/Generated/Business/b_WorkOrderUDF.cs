...
{
    /// <summary>
    /// Business object that stores a record from the WorkOrderUDF table.InsertIntoDatabase
    /// </summary>
    [Serializable()]
    public partial class b_WorkOrderUDF : DataBusinessBase
    {
        /// <summary>
        /// Default constructor.
        /// </summary>
        public b_WorkOrderUDF()
        {
            ClientId = 0;
            WorkOrderUDFId = 0;
            Text1 = String.Empty;
        ...
        /// <summary>
        /// Process the current row in the input SqlDataReader into a b_WorkOrderUDF object.
        /// This routine should be applied to the usp_WorkOrderUDF_RetrieveByPK stored procedure.
        /// This routine should be applied to the usp_WorkOrderUDF_RetrieveAll. stored procedure.
        /// </summary>
        /// <param name="reader">SqlDataReader containing the reader to process for the next row</param>
        /// <returns>object cast of the b_WorkOrderUDF object</returns>
        ...
        /// <summary>
        /// Load the current row in the input SqlDataReader into a b_WorkOrderUDF object.
        /// This routine should be applied to the usp_WorkOrderUDF_RetrieveByPK stored procedure.
        /// This routine should be applied to the usp_WorkOrderUDF_RetrieveAll. stored procedure.
        /// </summary>
        /// <param name="reader">SqlDataReader containing the reader to process for the next row</param>
        ...
        /// <summary>
        /// Insert this object into the database as a WorkOrderUDF table record.
        /// </summary>
        ...
        )
        {
            ...
            try
            {
                ...
                Database.StoredProcedure.usp_WorkOrderUDF_Create.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
        ...
        /// <summary>
        /// Update the WorkOrderUDF table record represented by this object in the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
        ...
        )
        {
            ...
            try
            {
                ...
                Database.StoredProcedure.usp_WorkOrderUDF_UpdateByPK.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
        ...
        /// <summary>
        /// Delete the WorkOrderUDF table record represented by this object from the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
      ...
      string callerUserName
        )
        {
            ...
            try
            {
                ...
                Database.StoredProcedure.usp_WorkOrderUDF_DeleteByPK.CallStoredProcedure(command, callerUserInfoId, callerUserName, this);
            }
            finally
            {
                if (null != command)
        ...
        /// <summary>
        /// Retrieve all WorkOrderUDF table records represented by this object in the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
        /// <param name="callerUserName">string that identifies the user calling the database</param>
        /// <param name="data">b_WorkOrderUDF[] that contains the results</param>
      ...
      string callerUserName,
        ...
        {
            Database.SqlClient.ProcessRow<b_WorkOrderUDF> processRow = null;
            ArrayList results = null;
            SqlCommand command = null;
            string message = String.Empty;

            // Initialize the results
            data = new b_WorkOrderUDF[0];
            ...
            try
            {
                ...
                processRow = new Database.SqlClient.ProcessRow<b_WorkOrderUDF>(reader => { b_WorkOrderUDF obj = new b_WorkOrderUDF(); obj.LoadFromDatabase(reader); return obj; });
                results = Database.StoredProcedure.usp_WorkOrderUDF_RetrieveAll.CallStoredProcedure(command, processRow, callerUserInfoId, callerUserName, ClientId);

                // Extract the results
                if (null != results)
                {
                    data = (b_WorkOrderUDF[])results.ToArray(typeof(b_WorkOrderUDF));
                }
                else
                {
                    data = new b_WorkOrderUDF[0];
        ...
        /// <summary>
        /// Retrieve WorkOrderUDF table records with specified primary key from the database.
        /// </summary>
        /// <param name="connection">SqlConnection containing the database connection</param>
        /// <param name="transaction">SqlTransaction containing the database transaction</param>
        /// <param name="callerUserInfoId">long that identifies the user calling the database</param>
      ...
      string callerUserName
        )
        {
            ...
            try
            {
                ...
                // Call the stored procedure to retrieve the data
                processRow = new Database.SqlClient.ProcessRow<b_WorkOrderUDF>(reader => { this.LoadFromDatabase(reader); return this; });
                Database.StoredProcedure.usp_WorkOrderUDF_RetrieveByPK.CallStoredProcedure(command, processRow, callerUserInfoId, callerUserName, this);
        ...
        /// <summary>
        /// Test equality of two b_WorkOrderUDF objects.
        /// </summary>
        /// <param name="obj">b_WorkOrderUDF object to compare against the current object.</param>
        public bool Equals(b_WorkOrderUDF obj)
        {
            if (ClientId != obj.ClientId) return false;
            if (WorkOrderUDFId != obj.WorkOrderUDFId) return false;
        ...
        /// Test equality of two b_WorkOrderUDF objects.
        /// </summary>
        /// <param name="obj1">b_WorkOrderUDF object to use in the comparison.</param>
        /// <param name="obj2">b_WorkOrderUDF object to use in the comparison.</param>
        public static bool Equals(b_WorkOrderUDF obj1, b_WorkOrderUDF obj2)
        {
