...
namespace Admin.BusinessWrapper.UserProfile
{
    public class UserProfileWrapper
    {
        ...
        internal UserProfileModel GetUserProfile()
        {
            ...
            userinfo.RetrieveByPKAdmin(_userData.DatabaseKey);
            logininfo.RetrieveByPKAdmin(_userData.DatabaseKey);
            ...
            //site.Retrieve(this._userData.DatabaseKey); commented as site id 0
        ...
        internal Tuple<bool, List<string>> UpdateUserProfile(UserProfileModel userProfileModel)
        {
            ...
            if (!string.IsNullOrEmpty(updatedPassword))
            {
                ...
                userinfo.UpdateByPKAdmin(_userData.DatabaseKey);
                logininfo.UpdateByPKAdmin(_userData.DatabaseKey);
                ...
                pe.UpdateFromUserInfoAdmin(_userData.DatabaseKey);
                ////update UpdateIndex
