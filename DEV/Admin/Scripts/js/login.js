var SnippetLogin = function () {
    ...
    var displayForgetPasswordForm = function () {
        ...
        $.ajax({
            url: '/Admin/Login/ForgetPasswordPatial',
            type: "GET",
...
//#endregion
//#region Common
$(document).find('#signInFormAdmin').find('input[type="text"],input[type="password"]').blur(function () {
    if ($(this).val()) {
...
function SendMail(thiselement) {
    ...
    $.ajax({
        url: "/Admin/Login/ForgotPasswordSendEMail",
        type: "POST",
